...
//Ray URT 2017.01.19: Change E_UART_PORT0 to E_UART_PORT3 to use pin 95 & 96 as UART pin
/*
typedef enum
{
    E_UART_PORT_INVALID = -1,///< invalid uart port
    E_UART_PORT0=3,           ///< usually muxed with DDCA
    E_UART_PORT1=1,           ///< port 1
    E_UART_PORT2,           ///< port 2
    E_UART_PORT3,           ///< port 3
    E_UART_PORT4,           ///< port 4
} UART_PORT_TYPE;

...
#if (ENABLE_DVB_T2)&&((CHIP_FAMILY_TYPE==CHIP_FAMILY_MILAN)||(CHIP_FAMILY_TYPE==CHIP_FAMILY_MULAN))
...
#include "device_demodulator_msb1400.c"
...
#include "INTERN_DVBT.c"
#endif
#elif ( (FRONTEND_DEMOD_TYPE == MSTAR_MSB124X_DVBT) || ( FRONTEND_S2_DEMOD_TYPE == MSTAR_MSB124X_DVBT) )
#include "msb124x.c"
...
void devCOFDM_SwitchTransportSteamInferface(TS_INTERFACE interface)
{
 ...
 #if USE_UTOPIA
  #if(ENABLE_S2)
    if((IsS2InUse())&&(FRONTEND_S2_DEMOD_TYPE==EMBEDDED_DVBS_DEMOD))

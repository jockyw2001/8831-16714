...
void MApp_MultiTasks_ATSC(void)
{
    ...
    else if (IsATVInUse())              // 2. ATV
    {
        ...
        {
            /*fTVSetModeDone =*/
#if 0//ATSC_READY// use the CK3 flow,do not call here,  add relate NTSC flow into ATV handler if need
            MApp_ATV_Handler(SYS_INPUT_SOURCE_TYPE(MAIN_WINDOW), TRUE);
#endif

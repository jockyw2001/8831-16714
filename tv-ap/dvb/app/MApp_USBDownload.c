...
#define DOWNLOAD_BUFFER_TYPE_USB  MIU_SDRAM2SDRAM
    ...
    //U8      pu8FileName[20] = "TMMYU4020.BIN";
    U8      pu8FileName[25] = "SP4096_E0.00.00.01.BIN";		//Ray FWD 2017.02.23: Change firmware file name to be checked "SP4096_XXXXX.BIN". Please note check is case insensitive
    U32     u32FlashSize = 0;
...
void MApp_UsbDownload_Exit(void)
{
    ...
    //printf("MingYuan MApp_UsbDownload_Exit \n");
    // enable vd

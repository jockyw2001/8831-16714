...
// ------------------------------------------------------------
    ...
    FACTORY_SETTING_CHILD( E_SAVE_DATA_FACTORY_VIDEOWALL_SETTING,
        "FacVideoWallSetting",  stFacVideoWallSetting,  StruFacVideoWallSetting, MApp_DataBase_RestoreDefault_FactoryVideoWallSetting    ),		
		#endif  
		#ifdef sAddFactoryOSDPara
    FACTORY_SETTING_CHILD( E_SAVE_DATA_FACTORY_OTHER_SETTING,
        "FacOtherSetting",  stFacOtherSetting,  StruFacOtherSetting, MApp_DataBase_RestoreDefault_FactoryOtherSetting    ),		
		#endif			
		#if(SENSOR_CHIP!=NOT_SUPPORT_LIGHT_SENSOR)
    FACTORY_SETTING_CHILD( E_SAVE_DATA_FACTORY_LIGHT_SENSOR_SETTING,
        "FacLightSensorSetting",  stFacLightSensorSetting,  StruFacLightSensorSetting, MApp_DataBase_RestoreDefault_FactoryLightSensorSetting    ),		
		#endif		
};
...
void MApp_LoadGenSetting(void)
{
    ...
    MApp_ReadDatabase(RM_GENSET_START_ADR, (BYTE *)&stGenSetting, RM_SIZE_GENSET);
		...
		if(stGenSetting.u8Backlight>=100)

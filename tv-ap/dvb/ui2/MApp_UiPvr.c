...
/***************************************************************************************/
void MApp_UiPvr_RecordStart(void)
{
    ...
    while( retrys < 10)
    {
        ...
        if(MApp_PvrBrowser_IsFileExist(g_pu16TempFileName) == PVR_NULL_FILE_INDEX)
        {
            break;
        }
        else
...
//#endif
       )
    {
       ...
       // u8LiveAudioSelected = g_u8AudLangSelected;
        if (PVRState == E_PVR_STATE_TIMESHIFT)
        {
            //Move To MApp_TimeShift_PlaybackResume()
...
*/
            ...
            (msAPI_Timer_DiffTimeFromNow(_u32PvrUiLastInfoUpdateTime) >= PVR_UI_ALL_UPDATE_PERIOD_ms))
    {
            ...
            && (PVRState == E_PVR_STATE_RECORDnPLAYBACK) && (PlaybackState == E_PLAYBACK_STATE_FASTFORWARD))
        {
            ...
            {
                MApp_PVR_StateMachineInput(E_PVR_INPUT_PLAYBACK_PAUSE,NULL);
                MApp_PVR_StateMachineInput(E_PVR_INPUT_PLAYBACK_RESUME,NULL);
                MApp_UiPvr_UpdateUI();
            }
        }
...
#endif
{
    ...
    switch (u8KeyCode)
    {
        ...
        #endif
        {
                 ...
                 && (TimeShiftState != E_TIMESHIFT_STATE_WAIT))
            {
              ...
              //U32 u32RecordEndTime    = MApp_TimeShift_GetRecordEndTimeSec();
                ...
                if(u32PlaybackTime <= UI_PVR_SAFE_TIMEGAP_TO_BORDER_SEC)
                {
                    PVR_AUTO_ACTION_DBG(printf("[PVR_UI]:AUTO#36 NOT_ALLOW_FAST_BACKWARD \n");)
                    rtnVal = EN_PVR_KEYRTN_PROCESSED;
                    break;
                }
        ...
        case KEY_POWER:
        {
            ...
            PVR_DBG(printf("MApp_UiPvr_KeyProcessor- KEY_STOP\n"));

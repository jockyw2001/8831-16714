...
//
////////////////////////////////////////////////////////////////////////////////
#ifndef _DRVVIFINITIAL_MST_EULER_H_
#define _DRVVIFINITIAL_MST_EULER_H_
/*------------------------------------------------*/
...
#define CHINA_DESCRAMBLER_BOX               7                   // Use descrambler box in China; 0:not use; 1:IMAGE_IIR(0x99); 2:IMAGE_REJ1(0x8A); 3:ACI_REJ(0x89); 4:MIXER_OUT_I(0x86); 5:IMAGE_REJ2(0x8b)
#else
...
#define VIF_PROGRAMMABLE_DELAY              99                   // VIF_PROGRAMMABLE_DELAY //49.6us
#elif((FRONTEND_TUNER_TYPE == MxL_601SI_TUNER) || (FRONTEND_TUNER_TYPE == MxL_661SI_TUNER))
#define VIF_PROGRAMMABLE_DELAY              99                   // VIF_PROGRAMMABLE_DELAY //49.6us
#elif ((FRONTEND_TUNER_TYPE==NXP_TDA18273_TUNER) || (FRONTEND_TUNER_TYPE==NUTUNE_FK1602_TUNER)\
||(FRONTEND_TUNER_TYPE==NXP_TDA18274_TUNER))
#define VIF_PROGRAMMABLE_DELAY              115                   // VIF_PROGRAMMABLE_DELAY//57.5us
#else
#define VIF_PROGRAMMABLE_DELAY              99                   // VIF_PROGRAMMABLE_DELAY //49.6us
#endif
...
#endif //_DRVVIFINITIAL_MST_EULER_H_

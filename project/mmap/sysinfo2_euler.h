...
//------------------------------------------------------------------------------
    ...
    #if(MS_SW_CUS_SEL == SW_CONFIG_TRUNK_EULER_128M_DVBT || MS_SW_CUS_SEL == SW_CONFIG_TRUNK_EULER_128M_DVBT_PLUS_T2)
        #include "MMAP_DTVMM_EULER_128_DVBT_AEON.h"
    #elif(MS_SW_CUS_SEL == SW_CONFIG_TRUNK_EULER_128M_DVBT_TW)
	  #include "MMAP_DTVMM_EULER_128_DVBT_AEON_TW.h"
    #elif(MS_SW_CUS_SEL == SW_CONFIG_TRUNK_EULER_128M_DTMB)
	  #include "MMAP_DTVMM_EULER_128_DTMB_R2.h"
    #elif(MS_SW_CUS_SEL == SW_CONFIG_TRUNK_EULER_128M_DTMB)
	   #include "MMAP_DTVMM_EULER_128_DTMB_R2.h"
    #elif(MS_SW_CUS_SEL == SW_CONFIG_TRUNK_EULER_128M_ATVMM)
        #include "MMAP_ATVMM_EULER_128_AEON.h"
    #elif(MS_SW_CUS_SEL == SW_CONFIG_TRUNK_EULER_128M_ISDBT)
       #include "MMAP_DTVMM_EULER_128_ISDBT_R2.h"
    #else
        #error MMAP
  #endif
    #include "MIUSEL_EULER_MIU.h"

#elif( MEMORY_MAP == MMAP_64MB )
    #if(MS_SW_CUS_SEL == SW_CONFIG_TRUNK_EULER_64M_DVBT)
        #include "MMAP_DTVMM_EULER_64_DVBT_R2.h"
    #elif (MS_SW_CUS_SEL == SW_CONFIG_TRUNK_EULER_64M_ATVMM)
        #include "MMAP_ATVMM_EULER_64_AEON.h"
    #elif (MS_SW_CUS_SEL == SW_CONFIG_TRUNK_EULER_64M_ISDBT)
        #include "MMAP_DTVMM_EULER_64_ISDBT_R2.h"
    #else
        #error MMAP
    #endif
    #include "MIUSEL_EULER_MIU.h"
  ...
  #if(ENABLE_DTV)
    #include "MMAP_DTVMM_EULER_32_AEON.h"
  #else
    #include "MMAP_ATVMM_EULER_32_AEON.h"
  #endif
    #include "MIUSEL_EULER_MIU.h"
#else

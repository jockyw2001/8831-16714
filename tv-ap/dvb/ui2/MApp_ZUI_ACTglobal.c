...
U16 MApp_ZUI_ACT_DecIncValueFactSource_Cycle(BOOLEAN bInc, U16 u16Value)
{
    if (bInc) //action == MIA_INCVALUE)
    {
    	if (u16Value == DATA_INPUT_SOURCE_RGB)
    		u16Value = DATA_INPUT_SOURCE_HDMI;
    	else if (u16Value == DATA_INPUT_SOURCE_HDMI)
    		u16Value = DATA_INPUT_SOURCE_HDMI3;
    	else if (u16Value == DATA_INPUT_SOURCE_HDMI3)
    		u16Value = DATA_INPUT_SOURCE_HDMI2;
    	else if (u16Value == DATA_INPUT_SOURCE_HDMI2)
    		u16Value = DATA_INPUT_SOURCE_RGB;
    	else		    			
    		u16Value = DATA_INPUT_SOURCE_RGB;
    }
...
VIRTUAL_KEY_CODE _MApp_ZUI_ACT_MapToVirtualKeyCode(U8 IR_key_code)
{
    switch(IR_key_code)
    {
        ...
        case KEYPAD_MENU:           
        	//printf("MingYuan VK_KEYPAD_MENU \n");
        	return VK_KEYPAD_MENU;
        case KEYPAD_UP:             
          //printf("MingYuan VK_KEYPAD_UP \n");
        	return VK_KEYPAD_UP;
        case KEYPAD_DOWN:           
        	//printf("MingYuan VK_KEYPAD_DOWN \n");
        	return VK_KEYPAD_DOWN;
        case KEYPAD_LEFT:           
        	//printf("MingYuan VK_KEYPAD_LEFT \n");
        	return VK_KEYPAD_LEFT;
        case KEYPAD_RIGHT:          
        	//printf("MingYuan VK_KEYPAD_RIGHT \n");
        	return VK_KEYPAD_RIGHT;
        case KEYPAD_INPUT_SOURCE:   
        	//printf("MingYuan VK_KEYPAD_INPUT_SOURCE \n");
        	return VK_KEYPAD_INPUT_SOURCE;
        #endif
        case KEY_UP:                return VK_UP;
        case KEY_POWER:
          //printf("\nRay: Key power to VK power");		//Ray DBG 2017.06.05
          return VK_POWER;
        ...
        //Ray OSD 2017.06.01: Add OSD back and OSD next virtual key mapping
        case KEY_OSD_BACK:		return VK_OSD_BACK;
        case KEY_OSD_NEXT:		return VK_OSD_NEXT;
...
BOOLEAN MApp_ZUI_ACT_HandleGlobalKey(VIRTUAL_KEY_CODE key)
{
    ...
    {
        case E_OSD_MAIN_MENU:
	     //printf("\nRay: MApp_ZUI_ACT_HandleGlobalKey key=%d",key);		//Ray DBG 2017.06.05

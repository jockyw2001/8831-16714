...
INC_DIR  += \
        ...
        -I$(ROOT)/core/driver/sys/eden/include                      \
        -I$(ROOT)/core/api/n51fs/include                            \
        -I$(ROOT)/core/bin/eden/audio                               \
...
CHIP_FILES += \
        $(ROOT)/chip/eden/device/gpio/GPIO.c                         \
        $(ROOT)/core/driver/power/eden/drvPower_cus.c                \
        $(ROOT)/core/driver/power/eden/drvPower.c                    \
        $(ROOT)/chip/eden/color/color.c                              \

DEVICES_FILES += \
        $(ROOT)/device/keypad/eden/msKeypad.c                        \
        $(ROOT)/device/ir/eden/msIR.c                                \
...
INC_DIR  += \
        ...
        -I$(ROOT)/project/mmap                                      \
        -I$(ROOT)/chip/eden/color/include                           \
        -I$(ROOT)/chip/eden/device/gpio                             \
        -I$(ROOT)/chip/eden/image                                   \
        -I$(ROOT)/device/panel                                      \
        -I$(ROOT)/device/panel/include                              \
        -I$(ROOT)/device/panel_dft                                  \
        -I$(ROOT)/device/flash                                      \
        -I$(ROOT)/device/keypad/eden                               \
        -I$(ROOT)/device/ir/eden                                   \
...
LINT_INC  += \
        ...
        $(ROOT)/project/mmap                                       \
        $(ROOT)/chip/eden/color/include                            \
        $(ROOT)/chip/eden/device/gpio                              \
        $(ROOT)/chip/eden/image                                    \
        $(ROOT)/device/panel                                       \
        $(ROOT)/device/panel/include                               \
        $(ROOT)/device/panel_dft                                   \
        $(ROOT)/device/flash                                       \
        $(ROOT)/device/keypad/eden                                \
        $(ROOT)/device/ir/eden                                    \
...
LDLIB += -Wl,--whole-archive $(ROOT)/core/lib/eden/libprana_eden_aeonR2.a -Wl,--no-whole-archive
else
LDLIB += -Wl,--whole-archive $(ROOT)/core/lib/eden/libprana_eden_a.a -Wl,--no-whole-archive
endif

DRV_LIB_PATH   = $(ROOT)/core/driver
API_LIB_PATH   = $(ROOT)/core/api
DRV_BSP_PATH   = $(ROOT)/core/drv_bsp/eden_nos_r2m/lib
...
include project/build/FILES_COMMON_EDEN.mk

...
extern BOOL M5Api_MBX_RecvCommandFromQueue_HK(U32 u32CommandClass, MApiMB_Command *pMApiMB_Command);
#endif
...
#if ((OBA2 == 0) || ((OBA2 == 1) && (MHEG5_IN_HK != ENABLE)))
...
//printf("HK %s:%d\n",__FUNCTION__,__LINE__);
    ...
    sleep(10);
        ...
        if(0)//bAUTO_BOOT == TRUE)
            break;
    }
    printf("auto boot got \n");
...
#if ((OBA2 == 1) && (MHEG5_IN_HK == ENABLE))
        MApiMB_Command MApiMB_InCommand;
        U8 u8Msg[13];

        memset(&MApiMB_InCommand, 0, sizeof(MApiMB_Command));

        M5Api_MBX_RecvCommandFromQueue_HK(mbxClassArray[i], &MApiMB_InCommand);

        memcpy(&u8Msg[2],&MApiMB_InCommand.Params[0],10);
        u8Msg[1] = MApiMB_InCommand.CommandIndex;
        u8Msg[0] = MApiMB_InCommand.CommandClass;

        switch (MApiMB_InCommand.CommandClass) //command class
        {
        #if (CIPLUS_MHEG && ENABLE_CI_PLUS)
            case E_MBX_CLASS_CI:
            ...
            case E_MBX_CLASS_VIDEO:
                ...
                if ((MApiMB_InCommand.CommandIndex==MB_VIDEO_CHANNELCHANGE)||(MApiMB_InCommand.CommandIndex==MB_VIDEO_CHANNELCHANGE_LCN)||(MApiMB_InCommand.CommandIndex==MB_VIDEO_CHANNELCHANGE_PLUS_CHKTSID))
                {
                    return MB_RETURN_MHEG5_CHANNELCHANGE;
                }
                else if((MApiMB_InCommand.CommandIndex==MB_VIDEO_CHANNELCHANGE_QUIETLY)||(MApiMB_InCommand.CommandIndex==MB_VIDEO_CHANNELCHANGE_LCN_QUIETLY)||(MApiMB_InCommand.CommandIndex==MB_VIDEO_CHANNELCHANGE_QUIETLY_PLUS_CHKTSID))
                {
            ...
            case E_MBX_CLASS_MHEG5_STATE:
                ...
                if ((MApiMB_InCommand.CommandIndex) == MB_MHEG5_STATE_CMD_EXIT) //command index: MHEG-5 EXIT
                {
                    if(MApiMB_InCommand.Params[0] == MB_MHEG5_EXIT_SELECTED)
                    {
                        switch(MApiMB_InCommand.Params[1])
                        {
                            case KEY_SELECT:
                ...
                else if (MApiMB_InCommand.CommandIndex == MB_MHEG5_STATE_CMD_AUTOBOOT) //command index: MHEG-5 AUTO-BOOT
                {
                    return MB_RETURN_MHEG5_AUTOBOOT;
                }
                else if (MApiMB_InCommand.CommandIndex == MB_MHEG5_STATE_CMD_NO_MHEG5) //command index: no mheg5 data
                {
                    return MB_RETURN_NO_MHEG5_DATA;
                }
                else if (MApiMB_InCommand.CommandIndex == MB_MHEG5_STATE_CMD_CHANNEL_CHANGE) //command index: MHEG-5 CHANNEL_CHANGE
                {
                    u8KeyCode=MApiMB_InCommand.Params[0];
                    return MB_RETURN_51_STATE_CHANNEL_CHANGE;
                }
                else if (MApiMB_InCommand.CommandIndex == MB_MHEG5_STATE_CMD_MHEG5_TO_MENU) //command index: MHEG-5 MHEG5_TO_MENU
                {
                    u8KeyCode=MApiMB_InCommand.Params[0];
                    return MB_RETURN_51_STATE_MHEG5_TO_MENU;
                }
                else if (MApiMB_InCommand.CommandIndex == MB_MHEG5_STATE_CMD_KEY_REGISTER) //command index: MHEG-5 KEY_REGISTER
                {
                    msAPI_MHEG5_SetKeyRegisterGroup(MApiMB_InCommand.Params[0]);
                    break;
                }
                else if (MApiMB_InCommand.CommandIndex == MB_MHEG5_STATE_DRAW_EVENT) //command index: MHEG-5 DRAWING EVENT
                {
                    if(_mheg5EventHandle.DrawingCallback!=NULL)
                        _mheg5EventHandle.DrawingCallback(MApiMB_InCommand.Params[0]);
                    M5API_GFX_SetMHEGDrawFlag(MApiMB_InCommand.Params[0]);
...
//    SHOW_VIDEO_INFO(("MApp_VID_ProcessMailboxMsg"));
    ...
    switch (u8MailBox[1])
    {
        ...
        case MB_VIDEO_SET_STREAM_WITH_PID:
            ...
            MApp_ChannelChange_ChangeSpeciChannel( wService_ID, wOriNetwork_ID, wTsID, TYPE_TUNE_STREAM_SER_ID, bCheckTsID);
        ...
        case MB_VIDEO_CHANNELCHANGE_PLUS_CHKTSID:
            ...
            MApp_ChannelChange_ChangeSpeciChannel(wService_ID, wOriNetwork_ID, wTsID, tuneType, bCheckTsID);
        ...
        case MB_VIDEO_SET_STREAM_LCN:
            ...
            wService_ID = ( (((U16)u8MailBox[2]) & 0x00FF) | ((((U16)u8MailBox[3]) << 8) & 0xFF00) );
            MApp_ChannelChange_ChangeSpeciChannel( wService_ID, wOriNetwork_ID, wTsID, TYPE_TUNE_STREAM_LCN, bCheckTsID);
        ...
        case MB_VIDEO_CHANNELCHANGE_LCN:
            ...
            {
                MApp_ChannelChange_ChangeSpeciChannel( wService_ID, wOriNetwork_ID, wTsID, u8MailBox[1] == MB_VIDEO_CHANNELCHANGE_LCN ? TYPE_CHANNEL_CHANGE_LCN : TYPE_CHANNEL_CHANGE_LCN_QUIETLY, bCheckTsID);
            }
        #if MHEG5_NDT
            else if (u8MailBox[1] == MB_VIDEO_NDT_CHANNELCHANGE_LCN_QUIETLY || u8MailBox[1] == MB_VIDEO_NDT_CHANNELCHANGE_LCN)
            {
                MApp_ChannelChange_ChangeSpeciChannel( wService_ID, wOriNetwork_ID, wTsID, u8MailBox[1] == MB_VIDEO_NDT_CHANNELCHANGE_LCN ? TYPE_CHANNEL_CHANGE_LCN_NDT : TYPE_CHANNEL_CHANGE_LCN_QUIETLY_NDT, bCheckTsID);
            }
        #endif
            break;

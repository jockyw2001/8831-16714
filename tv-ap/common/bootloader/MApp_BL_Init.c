...
static void MApp_BL_BurstInitGOP(U16 u16X, U16 u16Y, U16 u16Pitch, U16 u16Height, U32 u32GopBuffer)
{
    ...
    u32DispX = u16X;
    u32DispY = u16Y;
    u32Width = devPanel_WIDTH();
    u32Height =devPanel_HEIGHT();
...
void MApp_BL_DisplaySystem(U8 u8Percent)
{
	...
	i = (U32)u8Percent;
	{
		...
		BL_DrawProgressBar((devPanel_WIDTH()-98*nStep-10)/2, devPanel_HEIGHT()/2, clrBtn.width, 100, 0xFFFFFFFF, 0xFF123456, 0xFF1234FF, GRADIENT_X_COLOR, i);
	}
}
...
void Initial_BL_DisplaySystem(void)
{
    ...
    InitGOPEnv(0, 0, ALIGN_8(devPanel_WIDTH()), devPanel_HEIGHT(), ALIGN_8(devPanel_WIDTH()), 0, 0, GOP_BUFFER_ADDR);
    ...
    dstbuf.u32Pitch = ALIGN_8(devPanel_WIDTH()*2);

...
#define FMAP_HDCP_KEY_BANK_START        (FMAP_FACTORY_SETTING_BANK_START - FMAP_HDCP_KEY_BANK_COUNT)
...
#define RM_MW_OPCACHE_INFO_SIZE             (sizeof(MW_OPCACHE_INFO)*MAX_OP_CACHE_NUM)
    ...
    #define FMAP_CI_PLUS_BANK_COUNT      (1 + MAX_OP_NIT_DB_COUNT)
...
//-------------------------------------------------------------------------------------
// Total usage
#define FMAP_TOTAL_USE_BANK_END         (FMAP_CI_PLUS_BANK_START)

...
//
////////////////////////////////////////////////////////////////////////////////
#ifndef _DRVVIFINITIAL_MST_A7_H_
#define _DRVVIFINITIAL_MST_A7_H_
/*------------------------------------------------*/
...
#define VIF_CLAMPGAIN_CLAMP_OV_NEGATIVE 0x730               // [10:0], Clamp overwrite value for negative modulation
...
#else
#define VIF_CLAMPGAIN_GAIN_OV_NEGATIVE  0x690               // [10:0], Gain overwrite value for negative modulation
#define VIF_CLAMPGAIN_GAIN_OV_POSITIVE  0x650               // [10:0], Gain overwrite value for positive modulation
#endif
...
#define VIF_CR_RATE_B                   0x00092F68          // [21:0], CR_RATE for 6.82 MHz, HEX((xxx/43.2) * (2^22))
#define VIF_CR_INVERT_B                 0                   // Video carrier position; 0: high side; 1:low side
#define VIF_CR_RATE_GH                  0x0009A12F          // [21:0], CR_RATE for 7.82 MHz, HEX((xxx/43.2) * (2^22))
#define VIF_CR_INVERT_GH                0                   // Video carrier position; 0: high side; 1:low side
#define VIF_CR_RATE_DK                  0x000A5ED0          // [21:0], CR_RATE for 7.82 MHz, HEX((xxx/43.2) * (2^22))
#define VIF_CR_INVERT_DK                0                   // Video carrier position; 0: high side; 1:low side
#define VIF_CR_RATE_I                   0x000A2D82          // [21:0], CR_RATE for 7.82 MHz, HEX((xxx/43.2) * (2^22))
#define VIF_CR_INVERT_I                 0                   // Video carrier position; 0: high side; 1:low side
#define VIF_CR_RATE_L                   0x000A5ED0          // [21:0], CR_RATE for 7.82 MHz, HEX((xxx/43.2) * (2^22))
#define VIF_CR_INVERT_L                 0                   // Video carrier position; 0: high side; 1:low side
#define VIF_CR_RATE_LL                  0x0001F49F          // [21:0], CR_RATE for 7.82 MHz, HEX((xxx/43.2) * (2^22))
#define VIF_CR_INVERT_LL                1                   // Video carrier position; 0: high side; 1:low side
#define VIF_CR_RATE_MN                  0x000078E38          // [21:0], CR_RATE for 5.82 MHz, HEX((xxx/43.2) * (2^22))
...
#endif
#endif
#endif //_DRVVIFINITIAL_MST_A7_H_

...
// DRAM memory map
//------------------------------------------------------------------------------
#if 0//(MEMORY_MAP == MMAP_128MB)
    #include "MMAP_ATVMM_M12_128_AEON.h"
    #include "MIUSEL_EDEN_MIU.h"

#elif( MEMORY_MAP == MMAP_64MB )
    #if( ENABLE_DTV /*&& (DTV_SYSTEM_SEL == DTV_SYSTEM_ATSC)*/ )
        #include "MMAP_ATSCMM_EDEN_64_R2.h"
    #else
        #include "MMAP_ATVMM_EDEN_64_AEON.h"
    #endif

    #include "MIUSEL_EDEN_MIU.h"

#elif( MEMORY_MAP == MMAP_32MB )
    #include "MMAP_ATVMM_EDEN_32_AEON.h"
    #include "MIUSEL_EDEN_MIU.h"

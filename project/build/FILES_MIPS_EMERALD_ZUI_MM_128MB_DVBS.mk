...
##################################################################
BL_SRC_FILE += \
        $(ROOT)/boot/emerald/init_emerald.c

##################################################################
# Driver / API
##################################################################
DRV_FILES += \
        $(ROOT)/core/driver/sys/emerald/drvUartDebug.c                   \
        $(ROOT)/core/driver/sys/emerald/drvI2C.c                         \
        $(ROOT)/core/driver/sys/emerald/SysInit.c                        \
        $(ROOT)/core/driver/sys/emerald/drvISR.c                         \
        $(ROOT)/core/driver/sys/emerald/drvInit.c                        \
        $(ROOT)/core/driver/usb/emerald/drvUsbHostLib.c                  \
        #$(ROOT)/core/driver/sys/emerald/drvMMIO.c                        \
        #$(ROOT)/core/driver/miu/emerald/drvmiu.c

# PIP ENABLE need include these 2 files
DRV_FILES += \
        $(ROOT)/core/driver/pq/hal/emerald/QualityMap_Sub.c              \
        $(ROOT)/core/driver/pq/hal/emerald/QualityMap_SubEx.c           \
        $(ROOT)/core/driver/sys/emerald/drvPadConf.c
...
INC_DIR  += \
        ...
        -I$(ROOT)/core/driver/sys/emerald/include                   \
        -I$(ROOT)/core/driver/sc/emerald/include                    \
        -I$(ROOT)/core/bin/emerald/audio                            \
...
CHIP_FILES += \
        $(ROOT)/chip/emerald/device/gpio/GPIO.c                     \
        $(ROOT)/core/driver/power/emerald/drvPower_cus.c            \
        $(ROOT)/core/driver/power/emerald/drvPower.c                \
        $(ROOT)/chip/emerald/color/color.c                          \

DEVICES_FILES += \
        $(ROOT)/device/keypad/emerald/msKeypad.c                    \
        $(ROOT)/device/ir/emerald/msIR.c                            \
        ...
        $(ROOT)/device/cofdm/device_demodulator_msb131x.c			      \
...
INC_DIR  += \
        ...
        -I$(ROOT)/project/image/bininfo/emerald                    \
        -I$(ROOT)/project/mmap                                     \
        -I$(ROOT)/chip/emerald/color/include                       \
        -I$(ROOT)/chip/emerald/device/gpio                         \
        -I$(ROOT)/chip/emerald/image                               \
        -I$(ROOT)/device/panel                                     \
        -I$(ROOT)/device/panel/include                             \
        -I$(ROOT)/device/panel_dft                                 \
        -I$(ROOT)/device/flash                                     \
        -I$(ROOT)/device/keypad/emerald                            \
        -I$(ROOT)/device/ir/emerald                                \
...
LINT_INC  += \
        ...
        $(ROOT)/project/image/bininfo/emerald                      \
        $(ROOT)/project/mmap                                       \
        $(ROOT)/chip/emerald/device/gpio                           \
        $(ROOT)/chip/emerald/image                                 \
        $(ROOT)/chip/emerald/color/include                         \
        $(ROOT)/device/panel                                       \
        $(ROOT)/device/panel_dft                                   \
        $(ROOT)/device/panel/include                               \
        $(ROOT)/device/flash                                       \
        $(ROOT)/device/keypad/emerald                              \
        $(ROOT)/device/ir/emerald                                  \
...
#LDLIB += -Wl,--whole-archive $(ROOT)/core/lib/emerald/libprana_emerald_a.a -Wl,--no-whole-archive
PRANA_LIB   = $(ROOT)/core/lib/emerald/libprana_emerald.a

DRV_LIB_PATH   = $(ROOT)/core/driver
API_LIB_PATH   = $(ROOT)/core/api
DRV_BSP_PATH   = $(ROOT)/core/drv_bsp/emerald_nos_mips/lib
...
BIN_INFO = $(ROOT)/project/image/bininfo/emerald/BinInfo.h

REBUILD_FILES=$(TVAP)/dvb/ui2/MApp_ZUI_ACTmenufunc.c

include project/build/FILES_COMMON_EMERALD.mk

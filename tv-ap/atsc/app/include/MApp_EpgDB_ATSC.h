...
#define EPG_EVENT_SIZE          ((U16)sizeof(MS_EPG_EVENT))
...
#define EPGSTR_EITTITLE_START_ADR   (EVENTDB_EVENTBUF_START_ADR+EPG_EVENTBUF_LEN)
...
#define EPGSTR_ETT_START_ADR        (EPGSTR_EITTITLE_START_ADR+EPGSTR_EITTITLE_LEN)
...
#if 0//((EPGBUF_START_ADR + EPG_EVENTBUF_LEN + EPGSTR_EITTITLE_LEN+EPGSTR_ETT_LEN) > (EVENTDB_SDRAM_ADR+EVENTDB_SDRAM_LEN))
    #error "EPG buffer size not enough!!!"
#endif
...
INTERFACE U8 u8EITTimeOut;
INTERFACE U8 u8ETTTimeOut;
INTERFACE BOOLEAN bETTStarNextReceive;
...
INTERFACE void MApp_EpgDB_LoadEventTitle(U16 u16VchIdx, U32 u32srcaddr, MS_EPG_EVENT_TITILE* pSrcEventTitle);
INTERFACE void MApp_EpgDB_SaveEventTitle(U16 u16VchIdx, U32 u32dstaddr, MS_EPG_EVENT_TITILE* pSrcEventTitle);
INTERFACE void MApp_EpgDB_LoadEventETT(U16 u16VchIdx, U32 u32srcaddr, MS_EPG_EVENT_ETT* pSrcEventETT);
INTERFACE void MApp_EpgDB_SaveEventETT(U16 u16VchIdx, U32 u32dstaddr, MS_EPG_EVENT_ETT* pSrcEventETT);
INTERFACE BOOLEAN MApp_EpgDB_GetCurEvent(MS_EPG_EVENT *pDstEvent);

...
extern U8 u8Verbosity;
extern U8 u8RateSupport;
extern U8 u8Pitch;
#endif
...
U8 PicAutoColorGainResult = 2;	//Ray VGA 2017.04.18: Variable to store auto color gain result. 1 = pass, 0 = fail, 2 = Not done any color gain process
...
extern U16 MApp_ZUI_GetCurrentInputSourceStringID(E_UI_INPUT_SOURCE src);	//Ray SRC 2017.03.08: use to translate input source into string to display on OSD
extern LPTSTR _MApp_ZUI_GetInputSourceResolution(void);				//Ray SRC 2017.04.19
extern LPTSTR _MApp_ZUI_ACT_GetInputResolutionString(void);	//Ray SRC 2017.05.15
extern LPTSTR _MApp_ZUI_ACT_GetInputHorFreqString(void);	//Ray SRC 2017.05.15
extern LPTSTR _MApp_ZUI_ACT_GetInputVerFreqString(void);	//Ray SRC 2017.05.15
extern void dv_SetImageOrientation(void);					//Ray ORI 2017.05.08

//Ray VER 2017.05.09: This firmware version string doesn't use anymore. We use DigitalViewOSDVersion instead
/*
//Ray OSD 2017.04.19: Array storing firmware version no.
static code U8 SoftwareVersionStr[] =
{
...
void _MApp_ZUI_ACT_DecIncAspectRatio_Cycle(BOOLEAN bInc)
{
    ...
    {
	//Ray ART 2017.05.23: the order in UI is Fill Screen, 4:3, 16:9 and 1:1
	EN_AspectRatio_JustScan,
        EN_AspectRatio_4X3,
        EN_AspectRatio_16X9,
	EN_AspectRatio_Point_to_Point,

	//Ray ART 2017.05.23: Comment original definition
	/*
           ...
           switch(ST_VIDEO.eAspectRatio)
            {
               ...
               case EN_AspectRatio_4X3:
                  ...
                  break;
               case EN_AspectRatio_Point_to_Point:
                  ST_VIDEO.eAspectRatio = EN_AspectRatio_16X9;//EN_AspectRatio_JustScan;
                  break;
               //case EN_AspectRatio_JustScan:
               //   ST_VIDEO.eAspectRatio = EN_AspectRatio_16X9;
               //   break;
        ...
        else
        {
            switch(ST_VIDEO.eAspectRatio)
            {
               ...
               case EN_AspectRatio_4X3:
                  ...
                  break;
               case EN_AspectRatio_16X9:
                  ST_VIDEO.eAspectRatio = EN_AspectRatio_Point_to_Point;//EN_AspectRatio_JustScan;
                  break;
               //case EN_AspectRatio_JustScan:
               //   ST_VIDEO.eAspectRatio = EN_AspectRatio_Point_to_Point;
               //   break;
            ...
            switch(ST_VIDEO.eAspectRatio)
            {
                ...
                case EN_AspectRatio_Panorama:
                    ...
                    else
                    {
                    		...
                    		ST_VIDEO.eAspectRatio = EN_AspectRatio_JustScan;
                    		//#else
                        //ST_VIDEO.eAspectRatio = EN_AspectRatio_Zoom2;//EN_AspectRatio_JustScan;
                        //#endif
                    }
                    break;
                //#if(sSupportJustScan)    
    ...
    switch(act)
    {
      ...
      case EN_EXE_ONOFF_EPOP:
        ...
        case EN_EXE_INC_OSD_EFFECT_MODE:
            ...
            return TRUE;
#endif
            //Ray ORI 2017.05.05: image orientation option setting
        case EN_EXE_GOTO_OPTION_IMG_ORIENT:
          //Increase image orientation selection by 1
          SET_IMG_ORIENTATION((MirrorMode_t)MApp_ZUI_ACT_DecIncValue_Cycle(
                1,
		(U16)GET_IMG_ORIENTATION(), (U16)MIRROR_NORMAL, (U16)MIRROR_HV, 1));

          dv_SetImageOrientation();		//Apply image orientation setting
          MApp_ZUI_API_InvalidateWindow(HWND_MENU_OPTION_IMG_ORIENT_OPTION);	//Update OSD option text
          return TRUE;
#if ENABLE_CEC
        ...
        //    printf("\n  scaler [%s,%d] \n",__FILE__,__LINE__);
            ...
            {
                MApp_ZUI_API_EnableWindow(HWND_MENU_OPTION_HDMI_ARC, ENABLE);
            }
            else
            {
                DB_HDMI_SETTING.g_enHDMIARC = 0;
                MDrv_HDMI_ARC_PINControl(INPUT_PORT_DVI0, FALSE, FALSE);
                MApp_ZUI_API_EnableWindow(HWND_MENU_OPTION_HDMI_ARC, DISABLE);
            }
            MApp_ZUI_API_InvalidateWindow(HWND_MENU_OPTION_HDMI_CEC);
            MApp_ZUI_API_InvalidateWindow(HWND_MENU_OPTION_HDMI_ARC);
        #else
                DB_HDMI_SETTING.g_bHdmiCecMode ^= 1;
                if (DB_HDMI_SETTING.g_bHdmiCecMode)
                {
        ...
        //    printf("\n  scaler [%s,%d] \n",__FILE__,__LINE__);
            DB_HDMI_SETTING.g_enHDMIARC ^= 1;
            MApp_CEC_RequestARCAction(DB_HDMI_SETTING.g_enHDMIARC ? CEC_ARC_REQUEST_INITIATION : CEC_ARC_REQUEST_TERMINATION);
            MApp_ZUI_API_InvalidateWindow(HWND_MENU_HDMI_CEC_HDMI);
            MApp_ZUI_API_InvalidateWindow(HWND_MENU_HDMI_CEC_ARC);
            return TRUE;
#endif
        ...
        case EN_EXE_INC_COMMON_ADJ_ITEM6:
            ...
            {
                stGenSetting.g_Time.cOnTimerVolume =(U8) MApp_ZUI_ACT_DecIncValue_Cycle((act==EN_EXE_INC_COMMON_ADJ_ITEM6), stGenSetting.g_Time.cOnTimerVolume, 0, 100, 1);
            }
        ...
        case EN_EXE_INC_COMMON_ADJ_ITEM3:
            ...
            ////Ray BKL 2017.04.26: Adjust backlight control: PWM/DA
            else if(g_mainpage_common == EN_COMMON_BKL_SETUP_PAGE)
	    {
        	//Toggle backlight control state between D/A and PWM
        	if(GET_BACKLIGHT_CONTROL()==BKL_DA){
        	    SET_BACKLIGHT_CONTROL(BKL_PWM);
        	    dv_AdjustBacklightPWMFreq(GET_BACKLIGHT_PWM_FREQ());				//Update backlight level after changing to PWM
        	    MApp_ZUI_API_EnableWindow(HWND_MENU_COMMON_ADJ_ITEM4, ENABLE);			//Enable backlight frequency item in PWM mode
        	}else{
        	    SET_BACKLIGHT_CONTROL(BKL_DA);
        	    dv_AdjustBacklightPWMFreq(160);			//Update backlight PWM frequency to D/A one (160Hz) and then update backlight level
        	    MApp_ZUI_API_EnableWindow(HWND_MENU_COMMON_ADJ_ITEM4, DISABLE);			//Disable backlight frequency item in D/A mode
        	}
	    }
            ////
        ...
        case EN_EXE_INC_COMMON_ADJ_ITEM5:
            ...
            ////Ray BKL 2017.04.26: Adjust min backlight level
            else if(g_mainpage_common == EN_COMMON_BKL_SETUP_PAGE){
        ...
        case EN_EXE_INC_COMMON_ADJ_ITEM4:
            ...
            ////Ray BKL 2017.04.26: Adjust backlight frequency
            else if(g_mainpage_common == EN_COMMON_BKL_SETUP_PAGE)
	    {
        	//Increase/decrease backlight frequency by step of 20
        	SET_BACKLIGHT_PWM_FREQ(MApp_ZUI_ACT_DecIncValue(
                    act==EN_EXE_INC_COMMON_ADJ_ITEM4,
		    GET_BACKLIGHT_PWM_FREQ(), _BL_FREQ_MIN, _BL_FREQ_MAX, 20));
        	dv_AdjustBacklightPWMFreq(GET_BACKLIGHT_PWM_FREQ());
	    }
            ////
            else if(g_mainpage_common == EN_COMMON_PICTURE_COLOR_PAGE)
            {
            ...
            {
                stGenSetting.g_Time.cOnTimerSourceFlag =(EN_MENU_TIME_OnTimer_Source) MApp_ZUI_ACT_DecIncValue_Cycle((act==EN_EXE_INC_COMMON_ADJ_ITEM4), (U16)stGenSetting.g_Time.cOnTimerSourceFlag,(U16) (EN_Time_OnTimer_Source_Min+1), (U16)(EN_Time_OnTimer_Source_Num-1), 1);
            }
            else if(g_mainpage_common == EN_COMMON_TIME_CLOCK_PAGE)
            {
                ST_TIME _stTime;
            ...
            {
                u8Pitch =MApp_ZUI_ACT_DecIncValue_Cycle((act==EN_EXE_INC_COMMON_ADJ_ITEM4),u8Pitch, 0,   2, 1);
            }
#endif
        ...
        case EN_EXE_INC_COMMON_ADJ_ITEM2:
            ...
            ////Ray BKL 2017.04.26: Adjust backlight invert
	    else if(g_mainpage_common == EN_COMMON_BKL_SETUP_PAGE)
	    {
		//Toggle backlight invert between enable/disable
		if(GET_BACKLIGHT_INVERT()==ENABLE){
		    SET_BACKLIGHT_INVERT(DISABLE);
		}else{
		    SET_BACKLIGHT_INVERT(ENABLE);
		}
		...
		Panel_Backlight_PWM_ADJ(msAPI_Mode_PictureBackLightN100toReallyValue(stGenSetting.u8Backlight));
            ...
            {
                u8Verbosity =MApp_ZUI_ACT_DecIncValue_Cycle((act==EN_EXE_INC_COMMON_ADJ_ITEM2),u8Verbosity, 0,   2, 1);
            }
#endif
        ...
        case EN_EXE_INC_COMMON_ADJ_ITEM1:
            if(g_mainpage_common == EN_COMMON_PICTURE_MODE_PAGE)
            {
                ...
                //MApp_PicSetPicture( (T_MS_PICTURE *) &ST_PICTURE, SYS_INPUT_SOURCE_TYPE);
            ...
            //from case MAPP_UIMENUFUNC_ADJENB2_COLORTEMP:
                ST_VIDEO.eColorTemp = (EN_MS_COLOR_TEMP)MApp_ZUI_ACT_DecIncValue_Cycle(
                    act==EN_EXE_INC_COMMON_ADJ_ITEM1,
                    ST_VIDEO.eColorTemp, MS_COLOR_TEMP_MIN, MS_COLOR_TEMP_MAX, 1);
            ...
            //MApp_ZUI_ACT_MenuPictureCheckPicMode();
        ...
        case EN_EXE_DOWN_CS_MODE:
            if(stGenSetting.g_CaptionSetting.u8CSOptionMode == CAPTIONMENU_OPTIONMODE_DEFAULT)
            {
				...
				#if(SENSOR_CHIP!=NOT_SUPPORT_LIGHT_SENSOR)
    		case EN_EXE_LIGHT_SENSOR_SETTING:
    				if(G_FACTORY_SETTING.stFacLightSensorSetting.u8LS_Enable)
    				{
    					G_FACTORY_SETTING.stFacLightSensorSetting.u8LS_Enable = 0;
    					MApp_ZUI_API_EnableWindow(HWND_MENU_PICTURE_BACKLIGHT, ENABLE);
    					Panel_Backlight_PWM_ADJ(msAPI_Mode_PictureBackLightN100toReallyValue(stGenSetting.u8Backlight));
    				}
    				else
    				{
    					G_FACTORY_SETTING.stFacLightSensorSetting.u8LS_Enable = 1;    
    					MApp_ZUI_API_EnableWindow(HWND_MENU_PICTURE_BACKLIGHT, DISABLE);
							Panel_Backlight_PWM_ADJ(msAPI_Mode_PictureBackLightN100toReallyValue(stGenSetting.u8Backlight));
							u16CurrentBlPwm = stGenSetting.u8Backlight;
    				}
    				MApp_ZUI_API_InvalidateAllSuccessors(HWND_MENU_PICTURE_LS);						
    				break;
				#endif
		
        case EN_EXE_COLOR_RANGE_SETTING:
        #if ENABLE_COLOR_RANGE_AUTO_SETTING
            if(GEN_SYS_COLOR_RANGE == EN_COLOR_RANGE_0_255)
            {
                GEN_SYS_COLOR_RANGE = EN_COLOR_RANGE_16_235;
                MDrv_PQ_SetColorRange(PQ_MAIN_WINDOW, FALSE);
            }
            else if(GEN_SYS_COLOR_RANGE == EN_COLOR_RANGE_AUTO)
            {
                GEN_SYS_COLOR_RANGE = EN_COLOR_RANGE_0_255;
                MDrv_PQ_SetColorRange(PQ_MAIN_WINDOW, TRUE);
            }
            else
            {
                GEN_SYS_COLOR_RANGE = EN_COLOR_RANGE_AUTO;
                if(stGenSetting.g_SysSetting.enAUTOCOLORRANGE != GEN_SYS_COLOR_RANGE)
                {
            ...
            else if(GEN_SYS_COLOR_RANGE == EN_COLOR_RANGE_16_235)
            {
                GEN_SYS_COLOR_RANGE = EN_COLOR_RANGE_0_255;
                MDrv_PQ_SetColorRange(PQ_MAIN_WINDOW, FALSE);
            }
        ...
        //Ray ASS 2017.02.15: Action of changing Auto Source Seek on/off
        case EN_EXE_ONOFF_AUTO_SEEK:
          //Toggle the auto source seek state
          if(stGenSetting.g_SysSetting.fAutoSourceSeek){
              stGenSetting.g_SysSetting.fAutoSourceSeek = 0;
          }
          else{
              stGenSetting.g_SysSetting.fAutoSourceSeek = 1;
           }
          MApp_ZUI_API_InvalidateAllSuccessors(HWND_MENU_OPTION_AUTO_SEEK);
          return TRUE;


          //Ray DMP 2017.04.12: Action of changing Failover on/off
          case EN_EXE_ONOFF_FAILOVER:
            //Toggle the failover state
            if(GET_FAIL_OVER()){
        	SET_FAIL_OVER(0);
            }
            else{
            ...
            MApp_ZUI_API_InvalidateAllSuccessors(HWND_MENU_OPTION_FAILOVER);
            return TRUE;


	  //Ray DPW 2017.05.29: Action of changing default power on/off
	  case EN_EXE_ONOFF_DEFAULT_POWER:
	    //Toggle the default power state
	    if(GET_DEFAULT_POWER()){
		SET_DEFAULT_POWER(0);
	    }
	    else{
		SET_DEFAULT_POWER(1);
	     }
	    MApp_ZUI_API_InvalidateAllSuccessors(HWND_MENU_OPTION_DEFAULT_POWER);
	    return TRUE;
        ...
        case EN_EXE_INC_SOUND_TVSPEAKERS:
        {
            ...
            stGenSetting.g_SoundSetting.TVspeakerMode,TVspeaker_Mode_IntSpeaker, TVspecker_Mode_NUM-1, 1);
     ...
     /*   case EN_EXE_GOTO_AUTOSLEEP_TIMER_PAGE:
        ...
        //Ray VGA 2017.04.13: Do VGA auto color gain
         case EN_EXE_PCMODE_AUTO_GAIN:
           if(IsVgaInUse() && MApp_IsSrcHasSignal(MAIN_WINDOW))
           {
               //Ray VGA 2017.04.18: Joint down auto color gain result
              if(MApp_RGB_Setting_Auto(E_XC_EXTERNAL_CALIBRATION,MAIN_WINDOW)){
        	  PicAutoColorGainResult = PASS;
              }else{
        	  PicAutoColorGainResult = FAIL;
              }
           }
           //Ray VGA 2017.04.18: Display the auto color gain result
           MApp_ZUI_API_InvalidateAllSuccessors(HWND_MENU_PCMODE_AUTO_GAIN);
           return TRUE;
...
//===
         ...
         case EN_EXE_HDMI_CEC_FUNCTION:
            ...
            for (j=E_LA_TV; j<E_LA_MAX; j++)
                ...
                msAPI_CEC_ForceImmediatelyPolling();
         ...
         case EN_EXE_HDMI_CEC_SELECT:
            {
                if(MApp_ZUI_API_GetFocus() == HWND_MENU_HDMI_CEC_HDMI)
                {
                    ...
                    {
                        DB_HDMI_SETTING.g_bHdmiCecMode = EN_E4_HDMICEC_Off;
                        DB_HDMI_SETTING.g_enHDMIARC = 0;
                        DB_HDMI_SETTING.g_bHdmiCecAutoTvOn = 0;
                        DB_HDMI_SETTING.g_bHdmiCecDeviceAutoStandby = 0;
                        DB_HDMI_SETTING.g_bHdmiCecDeviceControl = 0;
#if(CEC_VERSION_USING == CEC_NEW_VERSION)
                    ...
                    else
                    {
                        ...
                        DB_HDMI_SETTING.g_bHdmiCecMode = EN_E4_HDMICEC_On;
                    }
                }
                ...
                else if(MApp_ZUI_API_GetFocus() == HWND_MENU_HDMI_CEC_ARC)
                {
                    ...
                    {
                        DB_HDMI_SETTING.g_enHDMIARC = FALSE;
                        MApp_CEC_RequestARCAction( CEC_ARC_REQUEST_TERMINATION);
                    ...
                    else
                    {
                        ...
                        MApp_CEC_RequestARCAction( CEC_ARC_REQUEST_INITIATION);
#if 0 //for mantis: 905461
                ...
                {
                    if (DB_HDMI_SETTING.g_bHdmiCecAutoTvOn == TRUE)
                        DB_HDMI_SETTING.g_bHdmiCecAutoTvOn = FALSE;
                    else
...
U16 _MApp_ZUI_ACT_GetAspectRatioStringID(void)
{
    ...
    switch(ST_VIDEO.eAspectRatio) //MApp_UiMenuFunc_GetenB5_AspectRatioValue())
    {
        ...
        case EN_AspectRatio_Zoom2:
            ...
            break;
        case EN_AspectRatio_JustScan:
	    u16TempID=en_str_Fill_Screen;		//Ray ART 2017.05.23: Change string to Fill Screen
       ...
       case EN_AspectRatio_Panorama:
            ...
            break;
        case EN_AspectRatio_Point_to_Point:
	    u16TempID=en_str_1colon1;  			//Ray ART 2017.05.23: Change string to 1:1
...
U16 _MApp_ZUI_ACT_GetPictureModeStringID(void)
{
    ...
    switch(ST_VIDEO.ePicture)
    {
        ...
        case PICTURE_DYNAMIC:
            u16TempID=en_str_Dynamic;
            break;
        case PICTURE_NORMAL:
            u16TempID=en_str_Standard;
            break;
        case PICTURE_MILD:
            u16TempID=en_str_Mild;
            break;
        case PICTURE_USER:
    #if PICTURE_USER_2
...
LPTSTR _MApp_ZUI_ACT_CombineTextAndOption(HWND hwnd)
{
    ...
    switch (hwnd)
    {
        ...
        case HWND_MENU_PICTURE_ADJUST_BACKLIGHT_SUB_OPTION:	
            u16OptionID = MApp_UiMenuFunc_GetPictureBacklightValue();
            break;          	
        case HWND_MENU_SOUND_VOLUME_OPTION:			//Ray VOL 2017.03.09 read and show volume level
	    u16OptionID = stGenSetting.g_SoundSetting.Volume;
	    break;
    #if ENABLE_ATSC_MENU_UI
        ...
        case HWND_MENU_COMMON_ADJ_ITEM2_OPTION:
            ...
            //Ray BKL 2017.04.25: Backlight setup page item 2: Backlight invert
            else if(g_mainpage_common == EN_COMMON_BKL_SETUP_PAGE)
            {
                MApp_ZUI_API_LoadString(en_str_BL_Invert, u16str);		//Load "Backlight invert :" string
                u16len = MApp_ZUI_API_Strlen(u16str);
                u16str[u16len++] = CHAR_SPACE;
                u16str[u16len++] = 0;
                if(GET_BACKLIGHT_INVERT()==DISABLE){				//Check current backlight invert setting
                    MApp_ZUI_API_LoadString(en_str_Off, u16con_buffer);		//Load "Off" string
                }else{
                    MApp_ZUI_API_LoadString(en_strOnText, u16con_buffer);	//Load "On" string
                }
            ...
            {
                u16TextID = en_str_Verbosity;

                if(u8Verbosity == 0)
                    u16OptionID = en_str_Low;
                else if(u8Verbosity == 1)
                    u16OptionID = en_str_Middle;
                else
                    u16OptionID = en_str_High;
        ...
        case HWND_MENU_COMMON_ADJ_ITEM3_OPTION:
            ...
            //Ray BKL 2017.04.25: Backlight setup page item 3: Backlight control D/A or PWM
            else if(g_mainpage_common == EN_COMMON_BKL_SETUP_PAGE)
            {
                MApp_ZUI_API_LoadString(en_str_BL_Control, u16str);		//Load "Backlight control :" string
                u16len = MApp_ZUI_API_Strlen(u16str);
                u16str[u16len++] = CHAR_SPACE;
                u16str[u16len++] = 0;
                if(GET_BACKLIGHT_CONTROL()==BKL_DA){				//Check current backlight control setting
                    MApp_ZUI_API_LoadString(en_str_BL_DA, u16con_buffer);	//Load "D/A" string
                }else{
                    MApp_ZUI_API_LoadString(en_str_BL_PWM, u16con_buffer);	//Load "PWM" string
                }
                MApp_ZUI_API_Strcat(u16str,(U16*)u16con_buffer);		//Put together two string
                return u16str;
            }
        ...
        case HWND_MENU_COMMON_ADJ_ITEM4_OPTION:
            ...
            //Ray BKL 2017.04.25: Backlight setup page item 4: Backlight frequency
            else if(g_mainpage_common == EN_COMMON_BKL_SETUP_PAGE)
	    {
        	u16TextID = en_str_BL_Freq;
        	u16OptionID = GET_BACKLIGHT_PWM_FREQ();
...
// Thomas to
        ...
        case HWND_MENU_COMMON_ADJ_ITEM5_OPTION:
          //Ray 2017.04.25: Add picture mode if statement
          if(g_mainpage_common == EN_COMMON_PICTURE_MODE_PAGE)
          {
          ...
          //Ray BKL 2017.04.25: Backlight setup page item 5: Min. Backlight level
          else if(g_mainpage_common == EN_COMMON_BKL_SETUP_PAGE)
	    {
	      u16TextID = en_str_BL_Min_Level;
	      u16OptionID = GET_BACKLIGHT_MIN_LEVEL();
...
LPTSTR MApp_ZUI_ACT_GetMenuItemDynamicText(HWND hwnd)
{
    ...
    tempcheck2 = hwnd;
    U16 u16Value;
    char ucVersion[12];		//Ray VER 2017.05.09
#if ENABLE_ATSC
    U8 *pu8String;
    //LPTSTR Au8String;
#endif
    switch(hwnd)
    {
      //Ray OSD 2017.04.19: Display firmware version
      case HWND_MENU_MAIN_VERSION_NO_TEXT:
	//Ray VER 2017.05.09: add different part of version string together
	...
	strcat(ucVersion,DigitalViewRevisionNumber);	//Add digital view revision no.
	return MApp_ZUI_API_StringBuffU8toU16(CHAR_BUFFER, (U8*)ucVersion, 11);
	//return MApp_ZUI_API_StringBuffU8toU16(CHAR_BUFFER, SoftwareVersionStr, sizeof(SoftwareVersionStr) + 1);
	break;
      //Ray SRC 2017.04.19: Display input source
      case HWND_MENU_MAIN_INPUTSOURCE_TEXT:
	u16TempID = MApp_ZUI_GetCurrentInputSourceStringID(UI_INPUT_SOURCE_TYPE);
	break;
	//Ray SRC 2017.05.15: Display input source resolution
      case HWND_MENU_MAIN_SOURCE_RES_TEXT:
	 return _MApp_ZUI_ACT_GetInputResolutionString();
	 //return _MApp_ZUI_GetInputSourceResolution();
	 break;
	//Ray SRC 2017.05.15: Display input source horizontal freq
      case HWND_MENU_MAIN_HOR_FREQ_TEXT:
	 return _MApp_ZUI_ACT_GetInputHorFreqString();
	 break;
	//Ray SRC 2017.05.15: Display input source vertical freq
      case HWND_MENU_MAIN_VER_FREQ_TEXT:
	 return _MApp_ZUI_ACT_GetInputVerFreqString();
	 break;
	case HWND_MENU_PICTURE_BACKLIGHT_OPTION:
        case HWND_MENU_PICTURE_ADJUST_BACKLIGHT_SUB_OPTION:
...
//        case HWND_MENU_PICTURE_ADJUST_BACKLIGHT_SUB_OPTION: //MingYuan Mark
//            #if ATSC_READY
...
case HWND_MENU_SOUND_VIDEO_DESCRIPTION_TEXT_OPTION:
            ...
            if ( IsAtscInUse())
            {
                if ( stGenSetting.g_SoundSetting.enDAPAudioLanguage == DAP_SOUND_LANGUAGE_ENGLISH)
                    u16TempID = en_str_English;
                else if(stGenSetting.g_SoundSetting.enDAPAudioLanguage == DAP_SOUND_LANGUAGE_SPANISH)
                    u16TempID = en_str_Spanish;
                else
        ...
        case HWND_MENU_PIP_POSITION_OPTION:
            ...
            break;
#endif
        case HWND_MENU_PICTURE_INPUTSOURCE_OPTION:			//Ray SRC 2017.03.08: input source option text displayed according to current input source
            u16TempID = MApp_ZUI_GetCurrentInputSourceStringID(UI_INPUT_SOURCE_TYPE);
            break;
        //Ray OSD 2017.05.17: Disable Picture mode option.  We fix with user mode only
        /*
        case HWND_MENU_PICTURE_PICMODE_OPTION:
        ...
        */
        case HWND_MENU_COMMON_ADJ_ITEM1_TEXT:
            if(g_mainpage_common ==EN_COMMON_PICTURE_MODE_PAGE)
                u16TempID = en_str_Picture_Setting;			//Ray OSD 2017.05.17: Display "Picture Setting" title instead of "Picture mode:"
		//u16TempID = en_str_Picture_Mode_Colon;
            else if (g_mainpage_common ==EN_COMMON_PICTURE_COLOR_PAGE)
	    ...
	    //Ray OSD 2017.05.17: Remove displaying Picture mode option string like user mode
	    /*
            if(g_mainpage_common == EN_COMMON_PICTURE_MODE_PAGE)
                u16TempID = _MApp_ZUI_ACT_GetPictureModeStringID();
            ...
            */
            if(g_mainpage_common == EN_COMMON_PICTURE_COLOR_PAGE)
            {
                switch( ST_VIDEO.eColorTemp )
                {
                  //Ray CTP 2017.05.17: Color temperature string display according to selected color temp
                  case MS_COLOR_TEMP_9300K:
                    u16TempID=en_str_Color_Temp_9300K;
                    break;
                  case MS_COLOR_TEMP_7500K:
                    u16TempID=en_str_Color_Temp_7500K;
                    break;
                  case MS_COLOR_TEMP_5000K:
                    u16TempID=en_str_Color_Temp_5000K;
                    break;
                  case MS_COLOR_TEMP_USER:
                    u16TempID=en_str_User;
                    break;
                  case MS_COLOR_TEMP_6500K:
                  default:
                    u16TempID=en_str_Color_Temp_6500K;
                    break;

                  //Ray CTP 2017.05.17: Comment original code
                  /*
                    default:
        ...
        case HWND_MENU_PICTURE_NOISE_REDUCTION_OPTION:
            ...
            #endif
            break;
        //Ray OSD 2017.05.17: Disable color temp option.  We fix with user mode only
         /*
        ...
        case HWND_MENU_SOUND_TV_SPEAKER_OPTION:// anvi22
            //printf("\n HWND_MENU_SOUND_TV_SPEAKER_OPTION  fTvSpeaker:%d  [%s,%s,%d] \n",stGenSetting.g_SysSetting.fTvSpeaker,__FUNCTION__,__FILE__,__LINE__);
        ...
        //Ray ORI 2017.05.05: Image orientation option text update
	  case HWND_MENU_OPTION_IMG_ORIENT_OPTION:
	    switch(GET_IMG_ORIENTATION())
	    {
	      case MIRROR_H_ONLY:
		u16TempID = en_str_Img_H_Flip;
		break;
	      case MIRROR_V_ONLY:
		u16TempID = en_str_Img_V_Flip;
		break;
	      case MIRROR_HV:
		u16TempID = en_str_Img_HV_Flip;
		break;
	      case MIRROR_NORMAL:
	      default:
		u16TempID = en_str_Img_Normal;
		break;
	    }
	    break;
#if ENABLE_ATSC
        ...
        //Ray ASS 2017.02.15: Add Auto source seek menu option
	case HWND_MENU_OPTION_AUTO_SEEK_OPTION:
            if(!stGenSetting.g_SysSetting.fAutoSourceSeek)
                u16TempID=en_str_Off;
            else
                u16TempID=en_str_On;
        ...
        //Ray DMP 2017.04.12: Add failover menu option
    	case HWND_MENU_OPTION_FAILOVER_OPTION:
                if(GET_FAIL_OVER())
                    u16TempID=en_str_On;
                else
                    u16TempID=en_str_Off;
	...
	//Ray DPW 2017.05.29: Add default power menu option
	case HWND_MENU_OPTION_DEFAULT_POWER_OPTION:
		if(GET_DEFAULT_POWER())
		    u16TempID=en_str_On;
		else
		    u16TempID=en_str_Off;
       ...
       //Ray VGA 2017.04.18: Auto color gain menu result display as fail/pass according to result joint down in PicAutoColorGainResult
    	case HWND_MENU_PCMODE_AUTO_GAIN_OPTION:
    	  if(PicAutoColorGainResult==FAIL){
    	      u16TempID=en_str_Fail;
    	  }else if (PicAutoColorGainResult==PASS){
    	      u16TempID=en_str_Pass;
    	  }else{
    	      u16TempID=en_str_3Dot;		//If not done any auto color gain calibration, display 3 dot symbol
    	  }
    	  break;

				#if(SENSOR_CHIP!=NOT_SUPPORT_LIGHT_SENSOR)
        	case HWND_MENU_PICTURE_LS_OPTION:
        		if(G_FACTORY_SETTING.stFacLightSensorSetting.u8LS_Enable)
          		u16TempID=en_str_On;	
          	else
          		u16TempID=en_str_Off;	          		
    ...
    case HWND_MENU_OPTION_EPOP_OPTION:
        ...
        case HWND_MENU_OPTION_EDID_SWITCH_OPTION:
            if(stGenSetting.g_SysSetting.u8EDID_select)
        ...
        case HWND_MENU_LOCK_SYSTEM_OPTION:
            //from case F1_OPTION_LOCK_SYSTEM_SELECTTEXT:
/*      //Don't used Invalidate in Dynamic text, recursive
            if(!MApp_MenuFunc_Setup_BlockSysEnterLockPage_Get())
            {
            ...
            #if ENABLE_ATSC_MENU_UI
                //MApp_ZUI_API_EnableWindow(HWND_MENU_LOCK_MAINSUBPAGE_ITEM_SYSTEMLOCK, DISABLE);
                MApp_ZUI_API_EnableWindow(HWND_MENU_LOCK_MAINSUBPAGE_ITEM_INPUTBLOCK, DISABLE);
                MApp_ZUI_API_EnableWindow(HWND_MENU_LOCK_MAINSUBPAGE_ITEM_US, DISABLE);
                MApp_ZUI_API_EnableWindow(HWND_MENU_LOCK_MAINSUBPAGE_ITEM_CANADA, DISABLE);
                MApp_ZUI_API_EnableWindow(HWND_MENU_LOCK_MAINSUBPAGE_ITEM_RRTSETTING, DISABLE);
                MApp_ZUI_API_EnableWindow(HWND_MENU_LOCK_MAINSUBPAGE_ITEM_RESETRRT, DISABLE);
                MApp_ZUI_API_EnableWindow(HWND_MENU_LOCK_MAINSUBPAGE_ITEM_UNRATED, DISABLE);
            #endif
...
*/
        ...
        case HWND_MENU_LOCK_PARENTAL_GUIDANCE_OPTION:
            //from case F4_OPTION_PARENTAL_CONTROL_SELECTTEXT:
            #if ENABLE_AUTOTEST
            if(g_bAutobuildDebug)
            {
...
#if 0//ENABLE_CEC anvi cec
        case HWND_MENU_OPTION_HDMI_CEC_OPTION:
            if(DB_HDMI_SETTING.g_bHdmiCecMode)
                u16TempID=en_str_On;
            else
                u16TempID=en_str_Off;
            break;
        case HWND_MENU_OPTION_HDMI_ARC_OPTION:
            if(DB_HDMI_SETTING.g_enHDMIARC)
                u16TempID=en_str_On;
            else
                u16TempID=en_str_Off;
            break;
        ...
        case HWND_MENU_DLG_SIGNAL_INFORMAT_NETWORK_NAME:
        {
            ...
            /*
                printf("u8NetWorkNameLen=%u\n", u8NetWorkNameLen);
                printf("au8NetWorkName[]={ ");
                for(i=0;i<u8NetWorkNameLen;i++)
                {
                    if( au8NetWorkName[i] < 0x80 )
                    {
                        printf(" %c ", au8NetWorkName[i] );
                    }
                    else
                    {
                        printf(" 0x%X ", au8NetWorkName[i] );
                    }
                }
                printf(" } \n");
                */
           ...
           /*
               printf("u16CharBuffer[]={ ");
               for(i=0;i<u8NetWorkNameLen;i++)
               {
                   if( u16CharBuffer[i] < 0x80 )
                   {
                       printf(" %c ", u16CharBuffer[i] );
                   }
                   else
                   {
                       printf(" 0x%X ", u16CharBuffer[i] );
                   }
               }
               printf(" } \n");
            */

               /* for(i=0; i<len; i++) //anvi id81
                {
        ...
        /*
            for( i=0; i<100; i++)
            {
                if( u16NetStr[i] == 0 )
                    break;
                else if( u16NetStr[i] < 0x80 )
                {
                    printf(" %c ", u16NetStr[i] );
                }
                else
                {
                    printf(" 0x%X ", u16NetStr[i] );
                }
            }
            */
...
//============================
    ...
    || (ENABLE_ATSC)\
        ...
        case HWND_MENU_OPTION_SETUPWIZARD:
        	#ifdef sCloseOptionSetupWizardItem
        		return EN_DL_STATE_HIDDEN;
        	#else
    				#if ENABLE_ATSC
            if(IsDVBInUse())
        ...
        case HWND_MENU_SOUND_AUDIO_LANGUAGE:
        		#ifdef sCloseSoundAudioLanguageItem
        		return EN_DL_STATE_HIDDEN;
        		#else
    				#if ENABLE_ATSC
            if(IsAtscInUse())
        ...
        case HWND_MENU_SOUND_AUDIO_ONLY:
        	#ifdef sCloseSoundAudioOnlyItem
        		return EN_DL_STATE_HIDDEN;
        	#else
    				#if ENABLE_ATSC
	    ...
	    return EN_DL_STATE_HIDDEN;			//Ray HDM 2017.03.07: Disable color range menu item. Fix color range as auto color range such that the color range is set according to HMDI AVI packet value
	    //Ray HDM 2017.03.07: Comment the original code
    	  /*
    #if ENABLE_ATSC
            if (IsDVBInUse())
                return EN_DL_STATE_HIDDEN;
	...
	//Ray VGA 2017.04.12: Set VGA adjust in picture menu either show or hidden according to whether VGA source is input
	case HWND_MENU_PICTURE_VGA_SETUP:
        ...
        case HWND_MENU_OPTION_CLOSED_CAPTION:
        	#ifdef sCloseOptionCloseCaptionItem
        	return EN_DL_STATE_HIDDEN;
        	#else
    			#if ENABLE_ATSC
            if(IsDVBInUse())
...
////==================================================================
        ...
        //Ray OSD 2017.05.05: Hidden sound mode menu
        case HWND_MENU_SOUND_SNDMODE:
        //Ray OSD 2017.05.05: Hidden sound auto volume menu
        case HWND_MENU_SOUND_AUTO_VOLUME:
        //Ray OSD 2017.05.05: Hidden sound surround sound menu
...
////==================================================================
        ...
        case HWND_MENU_COMMON_ADJ_ITEM6:
            if(g_mainpage_common ==EN_COMMON_PICTURE_MODE_PAGE)
            {
                ...
                #endif
                {
                	#ifdef sOpenPictureModeColorTintSharpItem
                	//VGA­nÂêSharpness                	
                	...
                	#else
                    if((hwnd ==HWND_MENU_COMMON_ADJ_ITEM4)||(hwnd ==HWND_MENU_COMMON_ADJ_ITEM5))
                    {
                        if(MApp_Scaler_Check_PointToPoint_Mode(PQ_MAIN_WINDOW))
                        {
                            return EN_DL_STATE_DISABLED;
                    ...
                    if(hwnd ==HWND_MENU_COMMON_ADJ_ITEM6)
                    {
            ...
            else if (g_mainpage_common == EN_COMMON_BKL_SETUP_PAGE)			//Ray BKL 2017.04.25: Define backlight setup page menu available display items
            {
        	if(hwnd >= HWND_MENU_COMMON_ADJ_ITEM6)				//There are only 5 items (including title) to be displayed
                    return EN_DL_STATE_HIDDEN;
                else{
                    //Ray BKL 2017.04.26: if backlight control mode is D/A, PWM frequency item is disabled
                  if((GET_BACKLIGHT_CONTROL()==BKL_DA)&&(hwnd == HWND_MENU_COMMON_ADJ_ITEM4)){
                      return EN_DL_STATE_DISABLED;
                  }else{
                      return EN_DL_STATE_NORMAL;
                  }
        ...
        //Ray OSD 2017.05.05: Hidden OSD language option:
		...
		#ifdef sCloseSoundBalanceItem
		case HWND_MENU_SOUND_BALANCE:
			return EN_DL_STATE_HIDDEN;
			break;
		#endif
    case HWND_MENU_SOUND_SPDIF_MODE:
    		#ifdef sCloseSoundSpdifModeItem
    		return EN_DL_STATE_HIDDEN;
    		#else
        if(IsDTVInUse() || IsHDMIInUse())
        {
            return EN_DL_STATE_NORMAL;
        }
        else
        ...
        #endif
        break;
    #ifdef sCloseSoundSpdifAudioDelayItem    
    case HWND_MENU_SOUND_AUDIO_DELAY:
    		return EN_DL_STATE_HIDDEN;
    		break;
    #endif
    case HWND_MENU_SOUND_TV_SPEAKER:
    		#ifdef sCloseSoundTVSpeakerItem
    		return EN_DL_STATE_HIDDEN;
    		#else
     ...
     case HWND_MENU_SOUND_DBX_TOTAL_SONICS:
         ...
         if(stGenSetting.g_SoundSetting.SurroundSoundMode == SURROUND_SYSTEM_DBX)
             ...
             {
             return EN_DL_STATE_HIDDEN;			//Ray OSD 2017.03.06: hidden DBX surround option
             //return EN_DL_STATE_DISABLED;
             }
         #else
            return EN_DL_STATE_HIDDEN;
    ...
    case HWND_MENU_HDMI_CEC_ARC:
        ...
        case HWND_MENU_SINGLELIST_ITEM1:
            switch(MApp_ZUI_ACT_GetSingleListMode())
            {
                case EN_COMMON_SINGLELIST_ASPECT_RATIO:// en_str_AspectRatio_orignal
                {
                    ...
                    if( !MApp_Scaler_Is_AspectRatioSupported_ByUI(EN_AspectRatio_JustScan)  )		//Ray ART 2017.05.23: First item is changed as Fill Screen
                        return EN_DL_STATE_HIDDEN;
                    else
                        return EN_DL_STATE_NORMAL;
                #else
        ...
        case HWND_MENU_SINGLELIST_ITEM4:
            switch(MApp_ZUI_ACT_GetSingleListMode())
            {
                ...
                case EN_COMMON_SINGLELIST_ASPECT_RATIO: //en_str_14colon9
                    ...
                    if( !MApp_Scaler_Is_AspectRatioSupported_ByUI(EN_AspectRatio_Point_to_Point)  )	//Ray ART 2017.05.23: 4th item is changed as 1:1
                        return EN_DL_STATE_HIDDEN;
                    else
                        return EN_DL_STATE_NORMAL;
        ...
        case HWND_MENU_SINGLELIST_ITEM7:
             switch(MApp_ZUI_ACT_GetSingleListMode())
            {
                ...
                {
                #if 1
		    //Ray ART 2017.05.23: No item 7 in aspect ratio
		    return EN_DL_STATE_HIDDEN;
		    /*
		    ...
		    */
                ...
                #else
                    #if(CHIP_FAMILY_TYPE == CHIP_FAMILY_MAYA)
                        return EN_DL_STATE_DISABLED; // Disable 2D to 3D
                    #endif
        ...
        case HWND_MENU_SINGLELIST_ITEM8:
            switch(MApp_ZUI_ACT_GetSingleListMode())
            {
                ...
                {
                #if 1
                  //Ray ART 2017.05.23: No item 8 in aspect ratio
		    return EN_DL_STATE_HIDDEN;
		    /*
        ...
        case HWND_MENU_SINGLELIST_ITEM9:
            switch(MApp_ZUI_ACT_GetSingleListMode())
            {
                ...
                {
                #if 1
                  //Ray ART 2017.05.23: No item 9 in aspect ratio
                  return EN_DL_STATE_HIDDEN;
                  /*
        ...
        case HWND_MENU_PICTURE_NOISE_REDUCTION:
        		#ifdef sClosePictureNoiseReductionItem
        			return EN_DL_STATE_HIDDEN;
        		#else
            ...
            case HWND_MENU_PICTURE_MPEG_NOISE_REDUCTION:
        		#ifdef sClosePictureMpegNoiseReductionItem
        			return EN_DL_STATE_HIDDEN;
        		#else            
            {
            //from case MI_NOT_RGB_MODE:
        ...
        case HWND_MENU_PICTURE_PC_ADJUST:
	      return EN_DL_STATE_HIDDEN;				//Ray VGA 2017.03.08: Hidden VGA adjust in picture menu since VGA adjust is moved to Setup menu
	      //Ray VGA 2017.03.08: comment the original code
	      /*
        ...
        case HWND_MENU_CHANNEL_SW_USB_UPGRADE:
            return EN_DL_STATE_NORMAL;//EN_DL_STATE_HIDDEN;  //EN_DL_STATE_NORMAL          
				#else
        case HWND_MENU_CHANNEL_SW_USB_UPGRADE:
            return EN_DL_STATE_NORMAL;
        #endif
        ...
        {
        	#ifdef sCloseOptionAudioLanguageItem
        	return EN_DL_STATE_HIDDEN;
        	#else
        		#if ENABLE_ATSC
            if(IsDVBInUse())
        ...
        {
        	#ifdef sCloseOptionSubtitleAudioLanguageItem
        	return EN_DL_STATE_HIDDEN;
        	#else
        		#if ENABLE_ATSC
            if(IsDVBInUse())
        ...
        {
        	#ifdef sCloseOptionHearingImpairedItem
        	return EN_DL_STATE_HIDDEN;
        	#else
        		#if ENABLE_ATSC
            if(IsDVBInUse())
    ...
    case HWND_MENU_OPTION_6M30_VERSION:
        ...
        case HWND_MENU_OPTION_COLOR_RANGE:
            ...
            if (IsHDMIInUse())
                ...
                return EN_DL_STATE_DISABLED;
        #endif
        #ifdef sCloseOptionMFCItem
        case HWND_MENU_OPTION_MFC:
        	return EN_DL_STATE_HIDDEN;
        #endif
        case HWND_MENU_OPTION_EPOP:
        	#ifdef sCloseOptionEPopItem
        	return EN_DL_STATE_HIDDEN;
        	#else
        		#if ENABLE_ATSC
            if (!IsDVBInUse())
...
#if (ENABLE_MFC_6M30 || ENABLE_MFC_6M30)

    ...
    else
    {
            ...
            ||(_enPreDirection == E_PLAYBACK_PATH_DIRECTION_FASTFORWARD)))
      {
        ...
        msAPI_Player_AudioPlay(E_PLAY_SOURCE_FILE);
            ...
            //[Milan 073B][PVR] Play recording file -> FF or FB -> Play, 畫面會閃一下
            ...
            &&(_enPlaybackInput == E_PLAYBACK_INPUT_PLAYBACK_RESUME))
        {
            ...
            //for mantis 0796613:[Milan 073B][PVR] Play recording file -> FF or FB -> Play, 畫面會閃一下
        }
        else
        {
            fEnableMvdTimingMonitor = TRUE;
...
#ifdef PVR_UTOPIA
	//msAPI_Tuner_Serial_Control(TS_PARALLEL_TYPE ? TRUE : FALSE,FALSE);

...
{
    EN_COMMON_INVALID,
    EN_COMMON_PICTURE_MODE_PAGE,
    EN_COMMON_PICTURE_COLOR_PAGE,
    EN_COMMON_SOUND_BALANCE_PAGE,
    EN_COMMON_SOUND_SWITCH_PAGE,
    EN_COMMON_SOUND_AUDIO_DELAY_PAGE,
    EN_COMMON_OFFTIMER_PAGE,
    EN_COMMON_ONTIMER_PAGE,
...
INTERFACE void MApp_ZUI_ACT_AppUpdateLanguageSelMenu(void);
#endif
...
INTERFACE void MApp_ZUI_ACT_ShowMainMenuBackgroundNoFocusIcon(void);		//Ray OSD 2017.03.07
#if ENABLE_DVBC

...
BOOL msUS_ParseLine(char* LineString,U8 LineLength)
{
    //-----------------------event token @---------------------------//
    char* token=NULL;
    U8 u8CharCount=0;
...
BOOL msUS_ReadScript(void)
{
    ...
    static U32 u32FileLength = FILE_BUFFER_SIZE;  //upper bond cahr per line about script CMD
    ...
    ret_val = msAPI_FCtrl_FileRead(_s_ES_u8FileHandle, (U32)&FileBuffer, u32FileLength);
...
{
    U16 u16EventCommandCurrent;
    U16 u16EventCommandEnd;

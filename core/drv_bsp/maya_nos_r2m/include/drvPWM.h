...
//--------------------------------------------------
//Ray BKL 2017.02.21: Definitions of backlight frequency range
//--------------------------------------------------
#define _BL_FREQ_MAX                                440
#define _BL_FREQ_MIN                                100
#define _BL_FREQ_CENTER                             (((_BL_FREQ_MAX - _BL_FREQ_MIN) / 2) + _BL_FREQ_MIN)
#define _BL_FREQ_STEP				    20			//20Hz per step

...
#define ENABLE_WIZARD_MODE                  DISABLE//ENABLE	//MSD8220_ReferCodeBase
...
#define TS_THROUGH_LVDS                             DISABLE
#define ENABLE_ADD_FAKECHANNEL_WITH_NO_SERVICES     DISABLE
#define ENABLE_EE_DB                                DISABLE
#define NEW_VIRTUAL_CHANNEL_STRUCTURE               ENABLE

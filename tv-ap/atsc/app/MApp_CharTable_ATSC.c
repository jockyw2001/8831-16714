...
static code U16 TABLE_ISO6937[] =
{
    ...
    0x0000, // 0xD8 :   XXDVBS_STUFFING
    0x0000, // 0xD9 :   XXDVBS_STUFFING
    0x0000, // 0xDA :   XXDVBS_STUFFING
    0x0000, // 0xDB :   XXDVBS_STUFFING
...
static U16 TABLE_WINDOWS_CP1250[] =
{
    ...
    0x0000, //  0x83: UNDEFINED
    0x201E, //  0x84: DOUBLE LOW-9 QUOTATION MARK
    0x2026, //  0x85:  HORIZONTAL ELLIPSIS
    0x2020, //  0x86:  DAGGER
    0x2021, //  0x87:  DOUBLE DAGGER
    0x0000, //  0x88:  UNDEFINED
...
static U16 TABLE_WINDOWS_CP1251[] =
{
    ...
    0x2030, //0x89   [¡ë] [¡ë]  PER MILLE SIGN
    ...
    0x201D, //0x94   [¡±] [¡±]  RIGHT DOUBLE QUOTATION MARK
    0x2022, //0x95   [?] [?]  BULLET
    0x2013, //0x96   [¨C] [¨C]  EN DASH
    0x2014, //0x97   [¡ª] [¡ª]  EM DASH
    ...
    0x00A4, //0xA4   [¡è] [¡è]  CURRENCY SIGN
    0x0490, //0xA5   [?] [?]  CYRILLIC CAPITAL LETTER GHE WITH UPTURN
    0x00A6, //0xA6   [|] [|]  BROKEN BAR
    0x00A7, //0xA7   [¡ì] [¡ì]  SECTION SIGN
    ...
    0x00B0, //0xB0   [¡ã] [¡ã]  DEGREE SIGN
    0x00B1, //0xB1   [¡À] [¡À]  PLUS-MINUS SIGN
    ...
    0x00B5, //0xB5   [¦Ì] [¦Ì]  MICRO SIGN
    0x00B6, //0xB6   [?] [?]  PILCROW SIGN
    0x00B7, //0xB7   [¡¤] [¡¤]  MIDDLE DOT
    0x0451, //0xB8   [§×] [§×]  CYRILLIC SMALL LETTER IO
    0x2116, //0xB9   [¡í] [¡í]  NUMERO SIGN
    ...
    0x0418, //0xC8   [§ª] [§ª]  CYRILLIC CAPITAL LETTER I
    ...
    0x0423, //0xD3   [§µ] [§µ]  CYRILLIC CAPITAL LETTER U
    ...
    0x0428, //0xD8   [§º] [§º]  CYRILLIC CAPITAL LETTER SHA
    ...
    0x042E, //0xDE   [§À] [§À]  CYRILLIC CAPITAL LETTER YU
    0x042F, //0xDF   [§Á] [§Á]  CYRILLIC CAPITAL LETTER YA
    0x0430, //0xE0   [§Ñ] [§Ñ]  CYRILLIC SMALL LETTER A
    0x0431, //0xE1   [§Ò] [§Ò]  CYRILLIC SMALL LETTER BE
    0x0432, //0xE2   [§Ó] [§Ó]  CYRILLIC SMALL LETTER VE
    0x0433, //0xE3   [§Ô] [§Ô]  CYRILLIC SMALL LETTER GHE
    0x0434, //0xE4   [§Õ] [§Õ]  CYRILLIC SMALL LETTER DE
    0x0435, //0xE5   [§Ö] [§Ö]  CYRILLIC SMALL LETTER IE
    0x0436, //0xE6   [§Ø] [§Ø]  CYRILLIC SMALL LETTER ZHE
    0x0437, //0xE7   [§Ù] [§Ù]  CYRILLIC SMALL LETTER ZE
    0x0438, //0xE8   [§Ú] [§Ú]  CYRILLIC SMALL LETTER I
    0x0439, //0xE9   [§Û] [§Û]  CYRILLIC SMALL LETTER SHORT I
    0x043A, //0xEA   [§Ü] [§Ü]  CYRILLIC SMALL LETTER KA
    0x043B, //0xEB   [§Ý] [§Ý]  CYRILLIC SMALL LETTER EL
    0x043C, //0xEC   [§Þ] [§Þ]  CYRILLIC SMALL LETTER EM
    0x043D, //0xED   [§ß] [§ß]  CYRILLIC SMALL LETTER EN
    0x043E, //0xEE   [§à] [§à]  CYRILLIC SMALL LETTER O
    0x043F, //0xEF   [§á] [§á]  CYRILLIC SMALL LETTER PE
    0x0440, //0xF0   [§â] [§â]  CYRILLIC SMALL LETTER ER
    0x0441, //0xF1   [§ã] [§ã]  CYRILLIC SMALL LETTER ES
    0x0442, //0xF2   [§ä] [§ä]  CYRILLIC SMALL LETTER TE
    0x0443, //0xF3   [§å] [§å]  CYRILLIC SMALL LETTER U
    0x0444, //0xF4   [§æ] [§æ]  CYRILLIC SMALL LETTER EF
    0x0445, //0xF5   [§ç] [§ç]  CYRILLIC SMALL LETTER HA
    0x0446, //0xF6   [§è] [§è]  CYRILLIC SMALL LETTER TSE
    0x0447, //0xF7   [§é] [§é]  CYRILLIC SMALL LETTER CHE
    0x0448, //0xF8   [§ê] [§ê]  CYRILLIC SMALL LETTER SHA
    0x0449, //0xF9   [§ë] [§ë]  CYRILLIC SMALL LETTER SHCHA
    0x044A, //0xFA   [§ì] [§ì]  CYRILLIC SMALL LETTER HARD SIGN
    0x044B, //0xFB   [§í] [§í]  CYRILLIC SMALL LETTER YERU
    0x044C, //0xFC   [§î] [§î]  CYRILLIC SMALL LETTER SOFT SIGN
    0x044D, //0xFD   [§ï] [§ï]  CYRILLIC SMALL LETTER E
    0x044E, //0xFE   [§ð] [§ð]  CYRILLIC SMALL LETTER YU
    0x044F, //0xFF   [§ñ] [§ñ]  CYRILLIC SMALL LETTER YA
};
...
static U16 MApp_CharTable_MappingIso6937ToUCS2(U8 *pu8Str, U16 *pu16Str, U16 srcByteLen, U16 dstWideCharLen)
{
    ...
    for (i=0, j=0; i<srcByteLen && j<dstWideCharLen-1; i++, j++)
    {
        ...
        else if ((u8Value>=0xC1) && (u8Value<=0xCF) && (i+1)<srcByteLen)
        {
			...
			if((sizeof(TABLE_ISO6937_MUL)/sizeof(TABLE_ISO6937_MUL[0]))== 0)
				s16Index = MApp_CharTable_BinarySearch(TABLE_ISO6937_MUL, 0, 0, u16Key);
			else
...
#elif (ENABLE_DVB_TAIWAN_APP || ENABLE_SBTVD_BRAZIL_APP)
...
//Description:
//*************************************************************************
#if (ENABLE_DTMB_CHINA_APP || ENABLE_ATV_CHINA_APP || ENABLE_DVB_TAIWAN_APP)
...
U16 MApp_CharTable_MappingCharToUCS2(EN_CHARACTER_CODE_TABLE enTable, U8 u8Str)
{
    ...
    else if(enTable < (ISO_8859_TABLE_MAX))  // ISO table
    {
        u8Value = u8Str;
        if (u8Value == 0x00)
        {
...
#if 0 /// temp mark out for pass compile

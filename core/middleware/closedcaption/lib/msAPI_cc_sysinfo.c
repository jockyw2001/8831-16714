...
void msAPI_CC_SetOsdSetting(stCaptionSetting_Type * pCaptionOSDSetting)
{
    ...
    CC_SYSINFO_DBG(printf("\r\n[OSD] SerMode: %bd ; DTV: %bd ; ATV: %bd ; CCMode: %bd ; CSOpMode: %bd",
    ...
    CC_SYSINFO_DBG(printf("\r\n[OSD] FSize: %bd ; FStyle: %bd ; EColor: %bd ; EStyle: %bd",
    ...
    g_fCCAttrFlag.fCCAttrEnableAutoSTAbyVideoFmt = TRUE;
    ...
    g_fCCAttrFlag.fCCAttr_Parity_Error_Solid_Block_Flag = FALSE;     // 1: CC608 Parity Check error, create sold block
    g_fCCAttrFlag.fCCAttr_Support_WordWrap_Flag = TRUE;
    g_fCCAttrFlag.fCCAttr_EnableRrvBlK = TRUE;
    ...
    g_fCCAttrFlag.fCCAttrEnable24Fonts = FALSE; // jany edit for milan project
    #endif

    g_fCCAttrFlag.fCCAttr_EnableSemiTransparentOnTextMode_Flag = FALSE;

    g_fCCAttrFlag.fCCAttr_Packet_Dump_Flag = FALSE;                    //For Dump CC Data.
    g_fCCAttrFlag.fCCAttrEnableGopZoom = FALSE;
    g_fCCAttrFlag.fCCAttr_GOP_Use_FBPool2 = FALSE;

    g_fCCAttrFlag.fCCAttr_Support_Border_Opacity = FALSE;
    g_fCCAttrFlag.fCCAttr_DLW_Call_GEngine = TRUE;
    g_fCCAttrFlag.fCCAttr_Font_Indention_Flag = FALSE;
    g_fCCAttrFlag.fCCAttr_Show_Window_Has_Text = FALSE;
    g_fCCAttrFlag.fCCAttr_EnableWindowOptionSetting = FALSE;
    g_fCCAttrFlag.fCCAttr_Support_Deep_Color = FALSE;       //TRUE: 64 color palette; FALSE: 8 color palette
...
//    {
        g_fCCAttrFlag.fCCAttr_Wait_GFX_Flush_Queue = TRUE;
//    }
//    else
//    {
...
void msAPI_CC_SetMisInfo(U8 u8Mode)
{
    ...
    */
      ...
      #if KOREAN_CC_ENABLE
        U8 u8KoreanMaxCol, u8KoreanMaxRow;
        u8KoreanMaxCol = u8KoreanMaxRow = 0;

        CC_DecoderFuns.GetDecodeInfo(KOREAN_CC_ROW_NUMBER, u8KoreanMaxRow);
        CC_DecoderFuns.GetDecodeInfo(KOREAN_CC_COL_NUMBER, u8KoreanMaxCol);

        u16SysInfoTemp1 = ((g_u8CCRowWidth * u8KoreanMaxCol));
        u16SysInfoTemp2 = ((g_u8CCRowHeight * u8KoreanMaxRow));
      #else

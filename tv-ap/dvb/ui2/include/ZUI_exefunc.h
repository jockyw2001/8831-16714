...
typedef enum
{
    ...
    EN_EXE_GOTO_INPUTSOURCE_PAGE,		///Ray SRC 2017.03.08
...
//    EN_EXE_RETURN_PICTURE_MODE_PAGE,            ///< return to picture mode page
    ...
    EN_EXE_GOTO_VOLUME_PAGE,			//Ray VOL 2017.03.08
...
//#endif
    ...
    EN_EXE_GOTO_OPTION_IMG_ORIENT,		 //Ray ORI 2017.05.05: image orientation option selection
    EN_EXE_HDMI_CEC_ADJ,
    // anvi cec start
    ...
    EN_EXE_ONOFF_EDID_SWITCH,                  ///< On Off switch Epop
    ...
    EN_EXE_ONOFF_AUTO_SEEK,			///Ray ASS 2017.02.15: On off auto source seek
    EN_EXE_ONOFF_FAILOVER,			///Ray DMP 2017.04.12: On off failover
    EN_EXE_ONOFF_DEFAULT_POWER,			///Ray DPW 2017.05.29: On off default power
		#if(SENSOR_CHIP!=NOT_SUPPORT_LIGHT_SENSOR)
    EN_EXE_LIGHT_SENSOR_SETTING,			
		#endif
    ...
    EN_EXE_SHOW_VOLUME_INFO,			///Ray VOL 2017.03.09
...
//    EN_EXE_MUTE_AUDIO_VOLUME,                   ///< mute audio volume
    ...
    EN_EXE_GOTO_VGA_SETUP,			///Ray VGA 2017.03.10, go to VGA setup menu
    ...
    EN_EXE_PCMODE_AUTO_GAIN,			///Ray VGA 2017.04.13: VGA auto color gain
...
//    #if (DMP_UI_VERSION2)
    ...
    EN_EXE_DMP_PLAYBACK_BG_INFO_1,		//Ray DMP 2017.04.11

    ...
    switch(enDisplaType)
    {
        ...
        if (_bCustomerMainPQEn)
        {
            if ( devPanel_FullHD() )
            {
                ...
                PQTableInfoColor.pGRule_Level[E_GRULE_NR] = (void*)MST_GRule_1920_NR_Main_Color;
                ...
                PQTableInfoColor.u8PQ_GRule_Num[E_GRULE_NR] = PQ_GRULE_NR_NUM_Main_Color;
                PQTableInfoColor.u8PQ_GRule_IPNum[E_GRULE_NR] = PQ_GRULE_NR_IP_NUM_Main_Color;
                PQTableInfoColor.pGRule_IP_Index[E_GRULE_NR] = (void*)MST_GRule_NR_IP_Index_Main_Color;
                PQTableInfoColor.pGRule_Array[E_GRULE_NR] = (void*)MST_GRule_NR_Main_Color;
                                           ...
                                           MS_U16 *pu16TabIdx_UCCTL)
{
    ...
    if(eWindow == PQ_MAIN_WINDOW)
    {
    ...
    #else //DDR select disable
        {
            ...
            u16PQ_OSDBWIdx = MDrv_PQ_GetGRule_LevelIndex(eWindow, PQ_GRule_OSD_BW_Main, PQ_GRule_OSD_BW_On_DDR2_Mirror_1920_Main);
        #else

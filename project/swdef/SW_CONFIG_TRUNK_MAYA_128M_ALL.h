...
#define UI_SKIN_SEL                     UI_SKIN_1920X1080X565//UI_SKIN_1920X1080X565	//MingYuan OSD Skin Select
...
#define HDCP_KEY_TYPE                   HDCP_KEY_IN_CODE																						//MingYuan HDCP
#define HDCP22_KEY_TYPE                 HDCP22_KEY_IN_CODE            // 1044 bytes(encrypted keys)	//MingYuan HDCP
#define HDCP22_AES_KEY_TYPE             HDCP22_AES_KEY_IN_CODE        // 16 byte(128-bit)						//MingYuan HDCP

#define ENABLE_HDMI_4K_2K               ENABLE
...
#define ENABLE_USB_2                    ENABLE  //Ray 2017.04.03 FWD: Enable USB port 2 DISABLE//ENABLE	//MingYuan Fix
...
#define ENABLE_POWERON_MUSIC                DISABLE//ENABLE // after T3 checking ok, turn on it again //enable it to play music when system boot up							//MingYuan Power On Music
#define POWERON_MUSIC_MIN_HOLD_ON_TIME      3000   //When ENABLE_POWERON_MUSIC==1, music should play at least xx ms until cancelled
#define DISPLAY_LOGO                        DISABLE//ENABLE  // after T3 checking ok, turn on it again //enable it to display LOGO when system boot up	//MingYuan boot Logo
...
#define ENABLE_DLC                      DISABLE//ENABLE	//MingYuan
...
#else
#define EEPROM_DB_STORAGE               EEPROM_SAVE_WITHOUT_CH_DB//EEPROM_SAVE_NONE//EEPROM_SAVE_WITHOUT_CH_DB		//Ray SEE 2017.07.17: Enable system data save to system EEPROM
#endif
...
#define CHINESE_SIMP_FONT_ENABLE        ENABLE//DISABLE		//MingYuan Font

#define CHINESE_BIG5_FONT_ENABLE        DISABLE//ENABLE//DISABLE	//MingYuan Font
...
#define ENABLE_SOUND_NONLINEAR_CURVE        1//0	//MingYuan
#define ENABLE_PICTURE_NONLINEAR_CURVE      1
#define ENABLE_NONLINEAR_CURVE              1

#define ENABLE_SZ_FACTORY_OVER_SCAN_FUNCTION            DISABLE//ENABLE//factory overscan adjust enable usefull  //enable for DTG AFD test	//MSD8220_ReferCodeBase OverScan
...
#define SW_LOAD_BMP_ON_DEMAND           ENABLE//DISABLE
    ...
    #define ENABLE_BL_OAD_SCAN          ENABLE
		...
		#define ENABLE_3D_PROCESS           DISABLE//ENABLE		//#ifdef sCloseOption3dItem
...
#define ENABLE_KEY_LOGGER               DISABLE//ENABLE	//MingYuan Keypad

...
#if SUPPORT_LONG_ETT
extern LPTSTR MApp_EpgZUI_GetExtendText(MS_EPG_EVENT *pEvent);
#endif
...
static void MApp_ZUI_ACT_ChInfo_String_Processing(HWND hwnd, U8* SrcStr, U16* DstStr)
{
    U16 i,length;
...
LPTSTR MApp_ZUI_ACT_GetChannelInfoDynamicText_ATSC(HWND hwnd)
{
    ...
    {
        MApp_ZUI_ACT_ChInfo_String_Processing(hwnd, u8TempString, CHAR_BUFFER);
        return CHAR_BUFFER;
    }
}

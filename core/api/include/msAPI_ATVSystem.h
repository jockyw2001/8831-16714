...
#elif (ENABLE_SBTVD_BRAZIL_APP||ENABLE_DVB_TAIWAN_APP)
...
typedef enum
{
    E_CHRESET_AIR       = BIT0,
    E_CHRESET_CATV      = BIT1,
    E_CHRESET_ALL       = (BIT0|BIT1),
}EN_CHANNEL_RESET_SELECTION;
...
#endif // #if ( ENABLE_DVB_TAIWAN_APP || ENABLE_SBTVD_BRAZIL_APP || (TV_SYSTEM == TV_NTSC) )

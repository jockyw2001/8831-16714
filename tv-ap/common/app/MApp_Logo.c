...
void MApp_Logo_Display(BOOLEAN bDisplayLogo)
{
...
#if 0   // Move Source change process to the init flow end in MApp_PreInit_Display_Init().
        if(IsHDMIInUse() && msAPI_Power_IswakeupsourceCEC())
        {
    ...
    else
    {
        ...
        //printf("MingYuan Presource MApp_Logo_Display\n");
        MApp_InputSource_SwitchSource(UI_INPUT_SOURCE_TYPE, MAIN_WINDOW);
...
{
    //U32 u32StartSector= 0, u32EndSector = 0, u32CurSector, u32FlashEndAddr;

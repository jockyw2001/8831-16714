...
#if(VIF_SAW_ARCH == 1 || VIF_SAW_ARCH==2)
#define VIF_CLAMPGAIN_GAIN_OV_NEGATIVE  0x630               // [10:0], Gain overwrite value for negative modulation
...
#define VIF_CHANEL_SCAN_AGC_REF              0x20
...
#define VIF_CR_INVERT_MN                0                   // Video carrier position; 0: high side; 1:low side
#elif(FRONTEND_TUNER_TYPE == SONY_SUT_RE231_TUNER || FRONTEND_TUNER_TYPE == SONY_SUT_PEx41_TUNER)
#define VIF_CR_RATE_B                   0x000AD098          // [21:0], CR_RATE for 7.3 MHz, HEX((xxx/43.2) * (2^22))
#define VIF_CR_INVERT_B                 0                   // Video carrier position; 0: high side; 1:low side
#define VIF_CR_RATE_GH                  0x000AD098          // [21:0], CR_RATE for 7.3 MHz, HEX((xxx/43.2) * (2^22))
#define VIF_CR_INVERT_GH                0                   // Video carrier position; 0: high side; 1:low side
#define VIF_CR_RATE_DK                  0x000BA12F          // [21:0], CR_RATE for 7.85 MHz, HEX((xxx/43.2) * (2^22))
#define VIF_CR_INVERT_DK                0                   // Video carrier position; 0: high side; 1:low side
#define VIF_CR_RATE_I                   0x000BA12F          // [21:0], CR_RATE for 7.85 MHz, HEX((xxx/43.2) * (2^22))
#define VIF_CR_INVERT_I                 0                   // Video carrier position; 0: high side; 1:low side
#define VIF_CR_RATE_L                   0x000BA12F          // [21:0], CR_RATE for 7.85 MHz, HEX((xxx/43.2) * (2^22))
#define VIF_CR_INVERT_L                 0                   // Video carrier position; 0: high side; 1:low side
#define VIF_CR_RATE_LL                  0x0003425F          // [21:0], CR_RATE for 2.2 MHz, HEX((xxx/43.2) * (2^22))
#define VIF_CR_INVERT_LL                1                   // Video carrier position; 0: high side; 1:low side
#define VIF_CR_RATE_MN                  0x000884BE          // [21:0], CR_RATE for 5.75 MHz, HEX((xxx/43.2) * (2^22))
#define VIF_CR_INVERT_MN                0                   // Video carrier position; 0: high side; 1:low side
#else

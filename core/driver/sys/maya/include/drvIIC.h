...
typedef enum {
    ...
    E_I2C_BUS_DDCD1,
    E_I2C_BUS_DDCD2,
    E_I2C_BUS_DDCD3,			//Ray EDD 2017.02.27: Define for DDCDD (DVI)
    E_I2C_BUS_DEMOD_FAST,		//Ray EDD 2017.02.27: Move Bus Demod to last as it is no use in SP-4096 project
    //E_I2C_BUS_USR0,
    //E_I2C_BUS_USR1,
    //E_I2C_BUS_USR2,
    //E_I2C_BUS_USR3,

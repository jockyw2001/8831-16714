...
//-------------------------------------------------------------------------------
//unit: ms
#ifdef sTriviewSleepTimer
  #define NO_SIGNAL_NORWAY_SLEEP_TIMER    (30000) // current no siganl time is 10 min
  #define NO_SIGNAL_AUTO_SLEEP_TIME_ATSC  (30000) // 10 min for ATSC
  #define NO_SIGNAL_AUTO_SLEEP_TIME_DTV   (30000) // 10 min for DVB
  #if ENABLE_POWER_SAVING_DPMS_DVI
    #define NO_SIGNAL_AUTO_SLEEP_TIME_HDMI  (30000) // 10 min for HDMI power saving secs unit:ms
  #endif
  #if ENABLE_POWER_SAVING_DPMS
    #define NO_SIGNAL_AUTO_SLEEP_TIME_VGA   (30000) // 5 min: VGA power saving secs
  #endif
  #define NO_SIGNAL_AUTO_SLEEP_NOTIFY_UI_TIME (30000) // 1 min
#else

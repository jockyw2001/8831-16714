...
static U32 u32ChSettingStartAddr = 0;
...
void MApp_DB_ATSC_SaveRfChannel(U16 u16SrvIdx, MS_RF_CHANNEL_new *pstRfCh_func)
{
    ...
    if( ANT_TYPE == ANT_AIR )
    {
        ...
        {
            printf("\r\nAir RF Channel Idx over max num!Plz check\n");
        }
    }
    else//ANT_VABLE
    {
...
void MApp_DB_ATSC_InitBaseAddr(EN_ANT_TYPE enAntennaType)
{
    ...
    if( enAntennaType == ANT_AIR )
    {
        ...
        u32ChSettingStartAddr = RM_AIR_CH_SETTING_START_ADR;
        //u16ChSettingLength = RM_AIR_CH_SETTING_LEN;
    ...
    else //ANT_CATV
    {
        ...
        u32ChSettingStartAddr = RM_CATV_CH_SETTING_START_ADR;
        //u16ChSettingLength = RM_CATV_CH_SETTING_LEN;
...
void MApp_DB_ATSC_SaveChSetting(MS_CHANNEL_SETTING* pstAtscChSetting)
{
    ...
    // Add magic code
    pstAtscChSetting->u32MagicCode = DB_ATSC_CH_SETTING_MAGCI_CODE_1;

    MApp_WriteDatabase(u32ChSettingStartAddr, (U8*)pstAtscChSetting, sizeof(MS_CHANNEL_SETTING));
}
...
void MApp_DB_ATSC_LoadChSetting(MS_CHANNEL_SETTING* pstAtscChSetting)
{
    ...
    MApp_ReadDatabase(u32ChSettingStartAddr, (U8*)pstAtscChSetting, sizeof(MS_CHANNEL_SETTING));
}
...
void MApp_DB_ATSC_ResetAllChData(void)
{
    ...
    stChSetting.U32DatabaseMagicCodeEnd = DB_MAGIC_CODE;
    stChSetting.u32MagicCode = DB_ATSC_CH_SETTING_MAGCI_CODE_1;
...
void MApp_DB_ATSC_LoadAllChData(void)
{
    ...
    if( stChSetting.u32MagicCode != DB_ATSC_CH_SETTING_MAGCI_CODE_1 )
    {

...
U8 MApp_MenuFunc_Setup_TimezoneIndex_GetMin(void)
{
#if  ENABLE_SBTVD_BRAZIL_APP
    return TIMEZONE_GMT_Minus5_START;
#else
    return TIMEZONE_GMT_0_START;
#endif

}

U8 MApp_MenuFunc_Setup_TimezoneIndex_GetMax(void)
{
#if  ENABLE_SBTVD_BRAZIL_APP
        return TIMEZONE_GMT_Minus2_END;
#else
        return TIMEZONE_NUM-1;
#endif

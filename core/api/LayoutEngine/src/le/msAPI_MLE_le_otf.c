...
{
    {LE_SCRIPT_TAG_DEVA, LE_OTF_SCRIPT_DEVA},
    {LE_SCRIPT_TAG_BENG, LE_OTF_SCRIPT_BENG},
    {LE_SCRIPT_TAG_GUJR, LE_OTF_SCRIPT_GUJR},
    {LE_SCRIPT_TAG_ORYA, LE_OTF_SCRIPT_ORYA},
    {LE_SCRIPT_TAG_TAML, LE_OTF_SCRIPT_TAML},
    {LE_SCRIPT_TAG_TELU, LE_OTF_SCRIPT_TELU},
    {LE_SCRIPT_TAG_KNDA, LE_OTF_SCRIPT_KNDA},
    {LE_SCRIPT_TAG_MLYM, LE_OTF_SCRIPT_MLYM},
    {LE_SCRIPT_TAG_GURU, LE_OTF_SCRIPT_GURU},
    {LE_SCRIPT_TAG_SINH, LE_OTF_SCRIPT_SINH}
};
...
static LE_ScriptTag_e _msAPI_MLE_LeMapScriptTag(LE_OTF_ScriptTag_e eScript)
{
    ...
    if ( eScript > LE_OTF_MAX_FEATURE_NUM )
    {
...
{
    if ( eFeature == LE_OTF_FEATURE_DIST || eFeature == LE_OTF_FEATURE_BLWM || eFeature == LE_OTF_FEATURE_ABVM
         || eFeature == LE_OTF_FEATURE_KERN )
    {
        return TRUE;
    }

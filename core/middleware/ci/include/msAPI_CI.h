...
#define MSIF_CI_CLASS       {'1', '3'}                               //info Class code a 00:driver, 02:app, 03:mw
...
#define MSIF_CI_LIB_CODE    {'C', 'I', '+', '_'}                     //Lib code
#define MSIF_CI_LIBVER      {'1', '2'}                               //LIB version
#define MSIF_CI_BUILDNUM    {'0', '1'}                               //Build Number
#define MSIF_CI_CHANGELIST  {'0' + ENABLE_CI_CHANGELIST1, '0' + ENABLE_CI_CHANGELIST2, '0' + ENABLE_CI_CHANGELIST3, '0' + ENABLE_CI_CHANGELIST4, '0' + ENABLE_CI_CHANGELIST5, '0' + ENABLE_CI_CHANGELIST6, '0' + ENABLE_CI_CHANGELIST7, '0' + ENABLE_CI_CHANGELIST8} //P4 ChangeList Number
...
#define CC_AUTH_PROGRAM_NUMBER_SIZE                     (16)
...
typedef enum
{
    EN_CIPLUS_APPMMI_VERSION_INVALID                    = 0x00,
    EN_CIPLUS_APPMMI_VERSION_V1                         = 0x01,
    EN_CIPLUS_APPMMI_VERSION_V2                         = 0x02
} EN_CIPLUS_APPMMI_VERSION;
...
//*****************************************************************************
///Query CICAM Version
/// @return EN_CI_VERSION:      CI Version
//*****************************************************************************
EN_CI_VERSION msAPI_CI_Query_CAM_Version( void );
...
//*****************************************************************************
///Get APPMMI Veresion
/// @return EN_CIPLUS_APPMMI_VERSION    APPMMI Version
//*****************************************************************************
EN_CIPLUS_APPMMI_VERSION msAPI_CI_AppMmi_GetVersion( void );
...
/// @param  u32RecordStartTime                  \b IN: PVR Record Start Time
...
//-------------------------------------------------------------------------------------------------
BOOL msAPI_CI_CC_GetRetentionLimitTime( U8 u8URI_EMI, U8 u8URI_RL, U32 u32RecordStartTime, U32 *pu32RententionLimitTime );
...
/// - FALSE: fail
//*****************************************************************************
BOOL msAPI_CI_CC__SendPinPlayback( const CI_CC_PIN_EVENT* stpPinEvent );

//*****************************************************************************
///msAPI_CI_CC_SendPinPlayback
/// Description
///   Send CC cc_PIN_playback APDU to CICAM.
/// @param u8Rating                         \b IN: This 8-bit field is coded as DVB rating (3+years).
/// @param u8pPrivateData                   \b IN: Pointor to Private Data of Recorded File.
/// @return BOOL:
/// - TRUE: success
/// - FALSE: fail
//*****************************************************************************
BOOL msAPI_CI_CC_SendPinPlayback( U8 u8Rating, U8 *u8pPrivateData );

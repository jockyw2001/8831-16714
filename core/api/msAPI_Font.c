...
#define MVF_MAX_COMMAND_WORDS (2048 / 4)
...
#if (BLOADER && ((CHIP_FAMILY_TYPE == CHIP_FAMILY_MILAN)||(CHIP_FAMILY_TYPE == CHIP_FAMILY_MULAN)))
...
#if ( (ENABLE_ARABIC_OSD) || (ENABLE_THAI_OSD) || (BLOADER)|| (ATSC_CC == DTV_CC) )
/******************************************************************************/
/// MIU Load Font

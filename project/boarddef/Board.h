...
#define EM_32SK08D            0     /*ft SK08D_QualityMap.xlsm*/
#define EM_42SK08D            0     /*ft SK08D_QualityMap.xlsm*/
#define EM_32VK08D            0     /*ft SK08D_QualityMap.xlsm*/
#define EM_42VK08D            0     /*ft SK08D_QualityMap.xlsm*/





#if (EM_32SK08D || EM_42SK08D || EM_32VK08D || EM_42VK08D)
// lin 120204 m <
#define HOTEL_MODE              1
#else
#define HOTEL_MODE              0
...
#define BD_SEC_XL3_MEGA_NASA            0x08D7
...
#define BD_MST097B_10ARB_15384			0x0B23 //156 pin - sz
#define BD_MST096B_10ARU_15384			0x0B24 //128 pin -sz
...
/******************************************************************************/
    ...
    #define FRONTEND_DEMOD_S2_TYPE              FRONTEND_S2_DEMOD_TYPE
...
//------------------------------ Board Default -----------------------------------
#ifdef sSP4096Board
#define I2C_IO_EXPANDER_TYPE        I2C_IO_EXPANDER_PCF8575  //Ray IOE 2017.02.02: add for I2C_IO_EXPANDER PCF8575
#endif
...
#define CONFIG_3D_HWLVDSLRFLAG       0
    ...
    #define HW_AUTO_NO_SIGNAL             ENABLE	
#endif

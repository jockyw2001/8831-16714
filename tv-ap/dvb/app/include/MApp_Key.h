...
typedef enum
{
    ...
    KEYPAD_UP               = 0x7F,	//MingYuan Keypad Split MSD8220_ReferCodeBase         
    KEYPAD_MENU             = 0x80,	//MingYuan Keypad Split MSD8220_ReferCodeBase             
    KEYPAD_DOWN             = 0x81,	//MingYuan Keypad Split MSD8220_ReferCodeBase
    KEYPAD_LEFT             = 0x82,	//MingYuan Keypad Split MSD8220_ReferCodeBase
    KEYPAD_RIGHT            = 0x83,	//MingYuan Keypad Split MSD8220_ReferCodeBase
    KEYPAD_INPUT_SOURCE     = 0x84,	//MingYuan Keypad Split MSD8220_ReferCodeBase
    KEY_DIR_FACTORY         = 0x85,	//MingYuan Keypad
    KEY_USB     						= 0x86,	//MingYuan IR
#if ENABLE_S2
	KEY_DVBS2               ,
	KEY_TEST_DVBS2         ,
#endif
    KEY_USB_DOWNLOAD        = 0x86,	//Ray FWD IRC 2017.01.24: USB firmware download IR key
    KEY_OSD_BACK	    = 0x87,	//Ray OSD 2017.06.01: IR OSD back key
    KEY_OSD_NEXT	    = 0x88,	//Ray OSD 2017.06.01: IR OSD next key

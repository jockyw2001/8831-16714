...
#define IR_HEADER_CODE0         0x40    // Custom 0     //0x04
...
{
    IRKEY_TV_ANTENNA        = 0x13,
    IRKEY_CHANNEL_LIST      = 0x18,
    IRKEY_CHANNEL_FAV_LIST  = 0x0D,
    IRKEY_CHANNEL_RETURN    = 0x40,
  ...
  //IRKEY_SUBCODE           = 0x53,      
    ...
    IRKEY_TV_RADIO          = IRKEY_DUMY-1,
		#endif    
    IRKEY_FREEZE            = IRKEY_DUMY-2,
		#if ENABLE_DMP
    IRKEY_PAGE_UP           = IRKEY_DUMY-3,
		#endif
    IRKEY_PAGE_DOWN         = IRKEY_DUMY-4,
    IRKEY_CLOCK             = IRKEY_DUMY-5,
    IRKEY_RED               = IRKEY_DUMY-6,
    IRKEY_GREEN             = IRKEY_DUMY-7,
    IRKEY_YELLOW            = IRKEY_DUMY-8,
    IRKEY_BLUE              = IRKEY_DUMY-9,
    IRKEY_NINE_LATTICE      = IRKEY_DUMY-10,
    IRKEY_TTX               = IRKEY_DUMY-11,
    IRKEY_CRADRD            = IRKEY_DUMY-12,
    IRKEY_DASH              = IRKEY_DUMY-13, 
    IRKEY_PAUSE             = IRKEY_DUMY-14, 
    IRKEY_MEMORY_RECALL     = IRKEY_DUMY-15, 
    IRKEY_AV                = IRKEY_DUMY-16,
    IRKEY_HDMI              = IRKEY_DUMY-17,
    IRKEY_SCART             = IRKEY_DUMY-18,
    IRKEY_PC                = IRKEY_DUMY-19,
    IRKEY_DTV               = IRKEY_DUMY-20,
    IRKEY_TV                = IRKEY_DUMY-21,
    IRKEY_COMPONENT  				= IRKEY_DUMY-22,        
    IRKEY_SV                = IRKEY_DUMY-23,
    IRKEY_P_CHECK           = IRKEY_DUMY-24, 
    IRKEY_S_CHECK           = IRKEY_DUMY-25, 
    IRKEY_MIX               = IRKEY_DUMY-26, 
    IRKEY_INDEX             = IRKEY_DUMY-27, 
    IRKEY_HOLD              = IRKEY_DUMY-28, 
    ...
    IRKEY_SIZE              = IRKEY_DUMY-36, 
    IRKEY_REVEAL            = IRKEY_DUMY-37, 
    IRKEY_RETURN            = IRKEY_DUMY-38, 
    IRKEY_ADJUST            = IRKEY_DUMY-39, 
    IRKEY_TV_INPUT          = IRKEY_DUMY-40, 
    IRKEY_KEY_DISABLE_KEYPAD = IRKEY_DUMY-41, 
    IRKEY_BACK              = IRKEY_DUMY-42, 
    IRKEY_SUBPAGE   				= IRKEY_DUMY-43, 
    IRKEY_SUBCODE       		= IRKEY_DUMY-44, 
    IRKEY_PHOTO           	= IRKEY_DUMY-45, 
    IRKEY_MINU             	= IRKEY_DUMY-46, 
    IRKEY_GUIDE            	= IRKEY_DUMY-47, 
    IRKEY_HOME              = IRKEY_DUMY-48,
    IRKEY_SLEEP             = IRKEY_DUMY-49,
}IrCommandType;
//*************************************************************************

...
typedef enum
{
    ...
    EN_PRE_INIT_STAGE_FLASHVAR_INIT,
    EN_PRE_INIT_STAGE_CHIP_INIT,
    EN_PRE_INIT_STAGE_AUDIO_INIT,
    EN_PRE_INIT_STAGE_CUSTOMER_INFO_INIT,
    EN_PRE_INIT_STAGE_PANEL_SETINVERTER_INIT,
    EN_PRE_INIT_STAGE_READ_DDRPHASE_INIT,
    EN_PRE_INIT_STAGE_DRIVER_STEP1_INIT,
    EN_PRE_INIT_STAGE_INTERRUPT_INIT,
    EN_PRE_INIT_STAGE_DATABASE_INIT,
    EN_PRE_INIT_STAGE_ATVPROC_AUDIO_INIT,
    EN_PRE_INIT_STAGE_FONT_INIT,
    EN_PRE_INIT_STAGE_DRIVER_STEP2_INIT,
    EN_PRE_INIT_STAGE_ENABLESKIP3D_LRFLAG_SETHWLVDS_LRFLAG_INIT,
    EN_PRE_INIT_STAGE_DNR_MEMORY_INIT,
    EN_PRE_INIT_STAGE_SYSTEM_INIT,
    EN_PRE_INIT_STAGE_PANEL_ENABLE_INIT,
    ...
    EN_PRE_INIT_STAGE_FLAG_INIT,
    EN_PRE_INIT_STAGE_CI_INIT,
    EN_PRE_INIT_STAGE_HDMISWITCH_PS321_INIT,
    EN_PRE_INIT_STAGE_TUNER_DEMOD_INIT,
    EN_PRE_INIT_STAGE_TIME_SETTING_INIT,
    EN_PRE_INIT_STAGE_EPGTIMER_DATA_INIT,
    EN_PRE_INIT_STAGE_CHECKONTIMER_INIT,
    EN_PRE_INIT_STAGE_LOGO_INIT,
    EN_PRE_INIT_STAGE_ATVPROC_OTHERS_INIT,
    EN_PRE_INIT_STAGE_OCP_INIT,
    EN_PRE_INIT_STAGE_ENVIRONMENT_INIT,
    EN_PRE_INIT_STAGE_DISPLAY_STEP1_INIT,

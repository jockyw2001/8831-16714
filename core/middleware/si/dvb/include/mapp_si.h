...
#define MSIF_SI_LIBVER            {'0','1'}                            //LIB version
#define MSIF_SI_BUILDNUM          {'1','1'}                            //Build Number
#define MSIF_SI_CHANGELIST        {'0','1','4','3','0','7','4','7'}    //P4 ChangeList Number
...
#define MW_SI_VER                  /* Character String for DRV/API version             */  \
    ...
    MSIF_SI_BUILDNUM,              /* 00 ~ 99                                          */  \
    MSIF_SI_CHANGELIST,            /* CL#                                              */  \
    MSIF_OS
...
typedef struct
{
    ...
    U32 reserved :1;
} MS_SAT_PARAMETER; // Cable delivery system descript
...
#define MAPI_SI_MAX_SERVICE_NAME     50//48 //for HD Simulcast Logical Channel number
 ...
 typedef struct
{
    ...
    U8 u8ServiceID_Count;
    /// Version Number
    U8 u8Version;
     /// services info
   MS_SI_SGT_SERVICE_INFO stServiceInfo[SI_MAX_VC_PER_PHYSICAL];
...
typedef struct
{
    ...
    U8 u8_EwsAuthor;
    U8 u8_EwsDisasterLoctionStatus;
    U8 u8_EwsLocationDisaster[50];
    U8 u8_EwsDisasterType[50];
    U8 u8_EwsDisasterDate[50];
    U8 u8_EwsDisasterLongitude[50];
    U8 u8_EwsDisasterCharacter[50];
    U8 u8_EwsDisasterRemark[100];
    bool bisValid;
} MS_EWSSETTING;
...
#if 1//ENABLE_DVBC
/*DVB-S*/
INTERFACE BOOLEAN  MApp_SI_GetNextSatParameter(MS_SAT_PARAMETER *desc,U16 *RemainFreq );
#endif
/*DVB-C*/
#if 1//ENABLE_DVBC
...
#endif
INTERFACE void MApp_SI_ResetTdtTot(void);
#if 1//def DVB_T2_ENABLE
...
INTERFACE BOOLEAN MApp_SI_SetChannelTuningMode(BOOLEAN bChTunMode);
...
//Get SI Version
INTERFACE void MApp_Get_SI_VersionNumber(void);

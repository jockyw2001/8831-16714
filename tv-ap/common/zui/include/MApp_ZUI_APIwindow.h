...
INTERFACE BOOLEAN MApp_ZUI_API_ShowFocusTitleIcon(HWND hWnd,U32 iCmdShow);	//Ray OSD 2017.03.07
INTERFACE BOOLEAN MApp_ZUI_API_CheckShowFocusTitleIcon(HWND hWnd);		//Ray OSD 2017.03.07

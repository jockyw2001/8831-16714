...
#define SI_MAX_AUD_LANG_NUM                   16 //NZ default 16
...
#if(ASTRA_HD_ENABLE)
    E_SI_DATA_VERSION_SGT = 16,  //SGT Replace SDT Table
#endif // #if(ASTRA_HD_ENABLE)
...
typedef enum
{
    ...
    SI_COUNTRY_NETHERLANDS,
    SI_COUNTRY_NORWAY,  //15
    SI_COUNTRY_POLAND,
    SI_COUNTRY_PORTUGAL,
    SI_COUNTRY_RUMANIA,
    SI_COUNTRY_RUSSIA,
    SI_COUNTRY_SERBIA,   //20
    SI_COUNTRY_SLOVENIA,
    SI_COUNTRY_SPAIN,
    SI_COUNTRY_SWEDEN,
    SI_COUNTRY_SWITZERLAND,
    SI_COUNTRY_UK,           //25
    SI_COUNTRY_NEWZEALAND,
    SI_COUNTRY_CHINA,
    SI_COUNTRY_ESTONIA,
    SI_COUNTRY_TURKEY,
    SI_COUNTRY_MOROCCO, //30
    SI_COUNTRY_TUNIS,
    SI_COUNTRY_ALGERIA,
    SI_COUNTRY_EGYPT,
    SI_COUNTRY_SOUTH_AFRICA,
    SI_COUNTRY_ISRAEL,   //35
    SI_COUNTRY_IRAN,
    SI_COUNTRY_UNITED_ARAB_EMIRATES,
    SI_COUNTRY_SLOVAKIA,
    SI_COUNTRY_TAIWAN,
    SI_COUNTRY_BRAZIL,   //40
    SI_COUNTRY_SINGAPORE,
    SI_COUNTRY_THAILAND,
    SI_COUNTRY_VIETNAM,
    SI_COUNTRY_MALAYSIA,
    SI_COUNTRY_INDONESIA,    //45
    SI_COUNTRY_KUWAIT,
    SI_COUNTRY_OMAN,
    SI_COUNTRY_QATAR,
    SI_COUNTRY_SAUDI_ARABIA,
    SI_COUNTRY_NUMS,
...
typedef enum
{
    ...
    SI_GERMANY_SPECIFIC_COUNTRY=27,
...
typedef enum _EN_SI_TIMEZONE
{
    ...
    SI_TIMEZONE_GMT_3_END=SI_TIMEZONE_MOSCOW,
    ...
    SI_TIMEZONE_GMT_4_END=SI_TIMEZONE_ABU_DHABI,
    ...
    SI_TIMEZONE_GMT_12_END =SI_TIMEZONE_NZST,
...
//    WORD bIsMHEGIncluded        : 1;
    ...
    WORD bValidLCNv2            : 1;
    WORD reserved1              : 2;   //add service type 2 bit to 4 bit // for information from PMT for empty Video_PID
...
#if 1//def ENABLE_DVB_S2
INTERFACE BOOLEAN msAPI_SI_AddProgramIDTable(SI_DTVPROGRAMID *pstDtvIDTable, WORD *u8IDIdex);
#else
INTERFACE BOOLEAN msAPI_SI_AddProgramIDTable(SI_DTVPROGRAMID *pstDtvIDTable, BYTE *u8IDIdex);
#endif
...
#if(ASTRA_HD_ENABLE)
INTERFACE BOOLEAN msAPI_SI_SaveServiceListInfo(const U8 *u8ServiceListName, U16 u16ServiceListID, BOOLEAN bListInFlag);

...
LDLIB += -Wl,--whole-archive $(ROOT)/core/lib/$(chip_name)/libprana_melody_aeonR2.a -Wl,--no-whole-archive
else
LDLIB += -Wl,--whole-archive $(ROOT)/core/lib/$(chip_name)/libprana_melody_a.a -Wl,--no-whole-archive
endif
...
include project/build/FILES_COMMON_MELODY.mk

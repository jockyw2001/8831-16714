...
////////////////////////////////////////////////////////////////////////////////
#define MIU_DRAM_LEN                0x0003000000
#define MIU_DRAM_LEN0               0x0002000000
#define MIU_DRAM_LEN1               0x0001000000
...
#define FONT_START_LEN                                         0x00000D9800
#define FONT_START_MEMORY_TYPE                                 (MIU0 | SW | CO_BUF_L0 | WRITE_BACK)

/* FILE_SYSTEM_POOL   */
//co_buffer L0
#define FILE_SYSTEM_POOL_AVAILABLE                             0x00000D9800
#define FILE_SYSTEM_POOL_ADR                                   0x00000DA000  //Alignment 0x01000
#define FILE_SYSTEM_POOL_GAP_CHK                               0x0000000800
#define FILE_SYSTEM_POOL_LEN                                   0x0000060800
#define FILE_SYSTEM_POOL_MEMORY_TYPE                           (MIU0 | SW | CO_BUF_L0 | WRITE_BACK)

/* BMP_START   */
//co_buffer L0
#define BMP_START_AVAILABLE                                    0x000013A800
#define BMP_START_ADR                                          0x000013A800  //Alignment 0x00020
...
//co_buffer L0
#define EVENTDB_SDRAM_AVAILABLE                                0x00001BA800
#define EVENTDB_SDRAM_ADR                                      0x00001BA800  //Alignment 0
...
/* BEON_MEM   */
//co_buffer L0
#define BEON_MEM_AVAILABLE                                     0x000020A800
#define BEON_MEM_ADR                                           0x0000210000  //Alignment 0x10000
#define BEON_MEM_GAP_CHK                                       0x0000005800
#define BEON_MEM_LEN                                           0x0000340000
#define BEON_MEM_MEMORY_TYPE                                   (MIU0 | SW | CO_BUF_L0 | WRITE_BACK)

/* SECBUF_START   */
//co_buffer L0
#define SECBUF_START_AVAILABLE                                 0x0000550000
...
//co_buffer L0
#define MENULOAD_BUFFER_AVAILABLE                              0x00009ED000
#define MENULOAD_BUFFER_ADR                                    0x00009ED000  //Alignment 0x00008
...
//co_buffer L0
#define PQ_MAIN_AVAILABLE                                      0x00009F1000
#define PQ_MAIN_ADR                                            0x00009F1000  //Alignment 0x00008
...
//co_buffer L0
#define PQ_MAIN_EX_AVAILABLE                                   0x00009F1000
#define PQ_MAIN_EX_ADR                                         0x00009F1000  //Alignment 0x00008
...
//co_buffer L0
#define PQ_TEXT_MAIN_AVAILABLE                                 0x00009F1000
#define PQ_TEXT_MAIN_ADR                                       0x00009F1000  //Alignment 0x00008
...
//co_buffer L0
#define SECURITY_R2_AVAILABLE                                  0x00009F1000
#define SECURITY_R2_ADR                                        0x0000A00000  //Alignment 0x10000
#define SECURITY_R2_GAP_CHK                                    0x000000F000
...
/* NONE41   */
//co_buffer L4
#define NONE41_AVAILABLE                                       0x0000AA0000
#define NONE41_ADR                                             0x0000AA0000  //Alignment 0x00200
#define NONE41_GAP_CHK                                         0x0000000000
#define NONE41_LEN                                             0x0000300000
...
//co_buffer L4
#define DECOMPRESS_DATA_BUFFER_AVAILABLE                       0x0001FB0000
#define DECOMPRESS_DATA_BUFFER_ADR                             0x0001FB0000  //Alignment 0x00020
#define DECOMPRESS_DATA_BUFFER_GAP_CHK                         0x0000000000
#define DECOMPRESS_DATA_BUFFER_LEN                             0x0000000000
#define DECOMPRESS_DATA_BUFFER_MEMORY_TYPE                     (MIU0 | SW | CO_BUF_L4 | WRITE_BACK)

/* DECOMPRESS_READ_BUFFER   */
//co_buffer L4
#define DECOMPRESS_READ_BUFFER_AVAILABLE                       0x0001FB0000
#define DECOMPRESS_READ_BUFFER_ADR                             0x0001FB0000  //Alignment 0x00020
#define DECOMPRESS_READ_BUFFER_GAP_CHK                         0x0000000000
#define DECOMPRESS_READ_BUFFER_LEN                             0x0000000000
#define DECOMPRESS_READ_BUFFER_MEMORY_TYPE                     (MIU0 | SW | CO_BUF_L4 | WRITE_BACK)

/* MPO_DISPLAY_BUFFER   */
//co_buffer L4
#define MPO_DISPLAY_BUFFER_AVAILABLE                           0x0001FB0000
#define MPO_DISPLAY_BUFFER_ADR                                 0x0001FB0000  //Alignment 0
...
//co_buffer L4
#define SCALER_2DTO3D_DD_BUF_AVAILABLE                         0x0001FB0000
#define SCALER_2DTO3D_DD_BUF_ADR                               0x0001FB0000  //Alignment 0x00008
#define SCALER_2DTO3D_DD_BUF_GAP_CHK                           0x0000000000
#define SCALER_2DTO3D_DD_BUF_LEN                               0x0000000000
#define SCALER_2DTO3D_DD_BUF_MEMORY_TYPE                       (MIU0 | SW | CO_BUF_L4 | WRITE_BACK)

/* SCALER_2DTO3D_DR_BUF   */
//co_buffer L4
#define SCALER_2DTO3D_DR_BUF_AVAILABLE                         0x0001FB0000
#define SCALER_2DTO3D_DR_BUF_ADR                               0x0001FB0000  //Alignment 0x00008
#define SCALER_2DTO3D_DR_BUF_GAP_CHK                           0x0000000000
#define SCALER_2DTO3D_DR_BUF_LEN                               0x0000000000
#define SCALER_2DTO3D_DR_BUF_MEMORY_TYPE                       (MIU0 | SW | CO_BUF_L4 | WRITE_BACK)
...
/* SCALER_DNR_UC_BUF   */
//co_buffer L6
#define SCALER_DNR_UC_BUF_AVAILABLE                            0x0000A90000
#define SCALER_DNR_UC_BUF_ADR                                  0x0000A90000  //Alignment 0x00020
...
/* M4A_BUFFER   */
//co_buffer L2
#define M4A_BUFFER_AVAILABLE                                   0x0001CE0800
#define M4A_BUFFER_ADR                                         0x0001CE0800  //Alignment 0
...
/* M4A_STCO   */
//co_buffer L2
#define M4A_STCO_AVAILABLE                                     0x0001CE4800
#define M4A_STCO_ADR                                           0x0001CE4800  //Alignment 0
...
/* TEXT_FILE   */
//co_buffer L2
#define TEXT_FILE_AVAILABLE                                    0x0001CFC800
#define TEXT_FILE_ADR                                          0x0001CFC800  //Alignment 0
...
//co_buffer L2
#define FILE_OPERATION_INFO_BUFFER_AVAILABLE                   0x0001CFE800
#define FILE_OPERATION_INFO_BUFFER_ADR                         0x0001CFE800  //Alignment 0
...
/* PHOTO_SHARE_MEM   */
//co_buffer L2
#define PHOTO_SHARE_MEM_AVAILABLE                              0x0001CFF400
#define PHOTO_SHARE_MEM_ADR                                    0x0001CFF400  //Alignment 0
...
/* PATH_INFO_BUFFER   */
//co_buffer L2
#define PATH_INFO_BUFFER_AVAILABLE                             0x0001CFF800
#define PATH_INFO_BUFFER_ADR                                   0x0001CFF800  //Alignment 0x00020
...
//co_buffer L2
#define VDPLAYER_SUBTITLE_BITSTREAM_BUFF_AVAILABLE             0x0001D00000
#define VDPLAYER_SUBTITLE_BITSTREAM_BUFF_ADR                   0x0001D00000  //Alignment 0x01000
...
/* MP4_SUBTITLE_BUFFER   */
//co_buffer L2
#define MP4_SUBTITLE_BUFFER_AVAILABLE                          0x0001D00000
#define MP4_SUBTITLE_BUFFER_ADR                                0x0001D00000  //Alignment 0x01000
...
/* MP4_SUBTITLE_TAG   */
//co_buffer L2
#define MP4_SUBTITLE_TAG_AVAILABLE                             0x0001D0A000
#define MP4_SUBTITLE_TAG_ADR                                   0x0001D0A000  //Alignment 0x01000
...
/* VDPLAYER_DATA   */
//co_buffer L3
#define VDPLAYER_DATA_AVAILABLE                                0x0001120000
#define VDPLAYER_DATA_ADR                                      0x0001120000  //Alignment 0x10000
...
//co_buffer L3
#define VDPLAYER_BITSTREAM_BUFF_AVAILABLE                      0x00014A0000
#define VDPLAYER_BITSTREAM_BUFF_ADR                            0x00014A0000  //Alignment 0x00010
...
//co_buffer L3
#define VDPLAYER_BITSTREAM_BUFF_EXT_AVAILABLE                  0x00018A0000
#define VDPLAYER_BITSTREAM_BUFF_EXT_ADR                        0x00018A0000  //Alignment 0x00010
...
/* SCALER_DNR_BUF_PREV   */
//co_buffer L3
#define SCALER_DNR_BUF_PREV_AVAILABLE                          0x00018A0000
#define SCALER_DNR_BUF_PREV_ADR                                0x00018A0000  //Alignment 0x10000
...
/* NONE30   */
//co_buffer L3
#define NONE30_AVAILABLE                                       0x0001A62000
#define NONE30_ADR                                             0x0001A62000  //Alignment 0x00200

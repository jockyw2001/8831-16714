...
//Ray PNL 2017.03.13: Define panel index
typedef enum
{
    PANEL_RES_MIN               			= 0,

    PNL_INX_M280DGJ_L30_Vx1_4K2K_60HZ_1Division        = PANEL_RES_MIN,		//Panel index 0: Innolux M280DGJ-L30 panel
    Panel_AUO_P550QVN01_0_Vx1_4K2K_60HZ_2Division,				//Ray DBG 2017.03.13: Panel index 1: for testing

    PNL_RES_MAX_NUM,

    //Ray PNL 2017.03.13: put unused panel timings here to avoid compile error.
    PNL_RES_INVALID = 17,						//Ray PNL 2017.03.13: panel index only range from 0~15. 17 is a invalid no. and also the panels below it
    PNL_FULLHD_SEC_LE32A,

     // FOR NORMAL LVDS PANEL
     PNL_SXGA_AU17_EN05,        // 1280*1024, PNL_SXGA_AU17_EN05
     PNL_WXGA_AU20_T200XW02,        // 1366*768, PNL_WXGA_AU20_T200XW02,
     PNL_WXGA_PLUS_CMO190_M190A1,        // 1440*900, PNL_WXGA_PLUS_CMO190_M190A1
     PNL_WSXGA_AU22_M201EW01,        // 1680*1050, PNL_WSXGA_AU22_M201EW01,
     PNL_FULLHD_CMO216_H1L01,        // 1920*1080, PNL_FULLHD_CMO216_H1L01

     PNL_WUXGA_CMO260_J2,        // 1920*1200, PNL_WUXGA_CMO260_J2
    ...
    PNL_AUO_P550QVN01_0_Vx1_4K2K_60HZ_2Division,     				//DFT_STD_AUO_P550QVN01_0_SETTING
...
//Ray PNL 2017.03.13: Disable original PANEL_RESOLUTION_TYPE definition
/*
typedef enum
{
    PANEL_RES_MIN               = 0,
...
#if ( ENABLE_TCON_2014 )
    #define PANEL_CURRENT_TYPE_SEL  TCON_PNL_WXGA_IPS32_Panasonic_For_CUS144
...
#elif ENABLE_TCON
    #define PANEL_CURRENT_TYPE_SEL      TCON_PNL_CSOT_TRIGATE_32
#else
    #define PANEL_CURRENT_TYPE_SEL      PANEL_RES_FULL_HD
    #define PANEL_SMALL_PQ_SELECT       5     // according to PANEL_CURRENT_TYPE_SEL is PANEL_RES_FULL_HD.
#endif

#if (SUPPORT_VX1_OUTPUT)
    #define PANEL_DEFAULT_TYPE_SEL      PNL_INX_M280DGJ_L30_Vx1_4K2K_60HZ_1Division   //DigitalView Panel Select
#else
    #define PANEL_DEFAULT_TYPE_SEL      PANEL_CURRENT_TYPE_SEL
#endif
...
INTERFACE void dv_AdjustBacklightPWMDuty(BYTE ucLightVal);		//Ray BKL 2017.02.21
INTERFACE void dv_AdjustBacklightPWMFreq(WORD sFreq);			//Ray BKL 2017.02.21
INTERFACE void dv_MultiPanelsInit(void);					//Ray PNL 2017.03.13

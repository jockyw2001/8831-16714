...
static BOOLEAN _msAPI_MLE_LeProcessContextPositionTable( LE_GPOSProcess_t *psProcess, const U8 *pu8Subtable, U16 u16Position )
{
    ...
    u16RecordCount = msAPI_MLE_LeContextTableGetLookupRecord(pu8Subtable, psProcess->sHeader.pau32InGlyph, psProcess->sHeader.u16InLen, u16Position, &pasLookupRecord);
    if ( u16RecordCount > 0 )
    {
...
static BOOLEAN _msAPI_MLE_LeProcessChainingContextPositionTable( LE_GPOSProcess_t *psProcess, const U8 *pu8Subtable, U16 u16Position )
{
    const U8 *pasLookupRecord = NULL;
    U16 u16RecordCount = 0;
    BOOLEAN bResult = FALSE;
    ...
    u16RecordCount = msAPI_MLE_LeChainingContextTableGetLookupRecord(pu8Subtable, psProcess->sHeader.pau32InGlyph, psProcess->sHeader.u16InLen, u16Position, &pasLookupRecord);
    if ( u16RecordCount > 0 )
    {
        bResult = _msAPI_MLE_LeProcessPositionLookups(psProcess, pasLookupRecord, u16RecordCount, u16Position);
    }
...
static BOOLEAN _msAPI_MLE_LeProcessPositionLookupSubtable( LE_GPOSProcess_t *psProcess, LE_PositionLookupType_e eLookupType, const U8 *pu8Subtable, U16 u16Position )
{
    BOOLEAN bResult = FALSE;
    ...
    switch( eLookupType )
    {
        ...
        {
            bResult = _msAPI_MLE_LeProcessContextPositionTable(psProcess, pu8Subtable, u16Position);
            break;
        }

        case LE_POS_LOOKUP_CHAINED_CONTEXT:
        {
            bResult = _msAPI_MLE_LeProcessChainingContextPositionTable(psProcess, pu8Subtable, u16Position);
            break;
        }
...
static BOOLEAN _msAPI_MLE_LeProcessPositionLookupTable( LE_GPOSProcess_t *psProcess, const U8 *pu8Table, U16 u16Position )
{
    ...
    {   
        ...
        bResult = _msAPI_MLE_LeProcessPositionLookupSubtable(psProcess, eLookupType, pLookupSubtable, u16Position);
...
BOOLEAN msAPI_MLE_LeProcessPosLookupTable( LE_GPOSProcess_t *psProcess, const U8 *pLookupTable, U16 u16SubtableIndex, U16 u16Position )
{
    ...
    pTempLookupTable = pTempLookupTable + sizeof(U16) + sizeof(U16);
    ...
    if ( u16SubtableIndex < u16SubtableCount )
    {
        ...
        bResult = _msAPI_MLE_LeProcessPositionLookupSubtable(psProcess, eLookupType, pSubtable, u16Position);
    }

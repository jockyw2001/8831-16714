...
#define SHAREMEM_VERSION_NUM 200179
...
typedef enum
{
    ...
    E_SHAREMEM_VIDEO_HDR_TYPE,                      // HK -> Co-processor (High Dynamic Range Imaging Type)
    E_SHAREMEM_VIDEO_HDR_ADR,                       // HK -> Co-processor (physical address)
    ...
    E_SHAREMEM_MAX = E_SHAREMEM_AUDIO_TRACK_ID_NEW + E_SHAREMEM_AUDIO_TRACK_SIZE,   // Co-processor -> HK   0x3f3

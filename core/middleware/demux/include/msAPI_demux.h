...
#define MSAPI_DMX_MATCH_PATTERN_LENGTH      16
        ...
        #define MSAPI_DMX_SEC4K_EIT_FILTER_NUMBER 0 //for eit schedule
        ...
        #define MSAPI_DMX_SEC4K_FILTER_NUMBER       6
        #define MSAPI_DMX_SEC4K_EIT_FILTER_NUMBER 2 //for eit schedule

...
typedef enum _DESIGN_MENU_PAGE
{
    ...
    EN_DESIGN_PAGE_OVERSCAN,
     ...
     EN_DESIGN_PAGE_CI,
      ...
      EN_DESIGN_PAGE_BRIGHTNESS_CURVE,
      EN_DESIGN_PAGE_CONTRAST_CURVE,
      EN_DESIGN_PAGE_SATURATION_CURVE,
      EN_DESIGN_PAGE_HUE_CURVE,
      EN_DESIGN_PAGE_SHARPNESS_CURVE,
      EN_DESIGN_PAGE_VOLUME_CURVE,
 #endif
...
/*
     ...
     "BD_MST087E_D01A"
#elif (MS_BOARD_TYPE_SEL == BD_MST087E_D01A_T9)
     "BD_MST087E_D01A_T9"
     ...
     "BD_MST556A_T2_10A_HX"
#elif (MS_BOARD_TYPE_SEL == BD_MST087E_D01A_HX)
     "BD_MST087E_D01A_HX"
     ...
     "BD_MST091B_D01A_S"
#elif (MS_BOARD_TYPE_SEL == BD_MST091C_D01A_S)
     "BD_MST091C_D01A_S"
     ...
     "BD_MST092B_D02A"
#elif (MS_BOARD_TYPE_SEL == BD_MST093A_D01A_S)
     "BD_MST093A_D01A_S"
     ...
     "BD_MST105C_D01A_S"
#elif (MS_BOARD_TYPE_SEL == BD_MST105C_D01A_S_T12)
     "BD_MST105C_D01A_S_T12"
#elif (MS_BOARD_TYPE_SEL == BD_MST105B_D01A_S_T12)
     "BD_MST105B_D01A_S_T12"
#elif (MS_BOARD_TYPE_SEL == BD_MST216A_JNS_10A_9463)
     "BD_MST216A_JNS_10A_9463"
#elif (MS_BOARD_TYPE_SEL == BD_LGD_V02)   // LGD@
     "BD_LGD_V02"
#elif (MS_BOARD_TYPE_SEL == BD_LGD_TOUCH_KEY_206_207)   // LGD@
     "BD_LGD_TOUCH_KEY_206_207"
#elif (MS_BOARD_TYPE_SEL == BD_MST536P_T3_10A)
     "BD_MST536P_T3_10A"
#elif (MS_BOARD_TYPE_SEL == BD_MST087F_D01A_T)
     "BD_MST087F_D01A_T"
#elif (MS_BOARD_TYPE_SEL == BD_MST6I78_Konka)
     "BD_MST6I78_Konka"
#elif (MS_BOARD_TYPE_SEL == BD_MSD380B_D01A)
     "BD_MSD380B_D01A"
#elif (MS_BOARD_TYPE_SEL == BD_MST090D_D01A_S)
     "BD_MST090D_D01A_S"
#elif (MS_BOARD_TYPE_SEL == BD_MST090E_D01A_S)
     "BD_MST090E_D01A_S"
#elif (MS_BOARD_TYPE_SEL == BD_MST090F_C01A)  //20100402EL
     "BD_MST090F_C01A"
#elif (MS_BOARD_TYPE_SEL == BD_MST106A_D01A_S)
     "BD_MST106A_D01A_S"
#elif (MS_BOARD_TYPE_SEL == BD_MST106B_D01A_S)
     "BD_MST106B_D01A_S"
#elif (MS_BOARD_TYPE_SEL == BD_MST110A_D01A_S)
     "BD_MST110A_D01A_S"
     ...
     "BD_MST109F_D01A_S"
#elif (MS_BOARD_TYPE_SEL == BD_MST105A_D01A_S_T9)
     "BD_MST105A_D01A_S_T9"
#elif (MS_BOARD_TYPE_SEL == BD_MSD523B_D01A)
     "BD_MSD523B_D01A"
#elif (MS_BOARD_TYPE_SEL == BD_MSD441C_T7_10A)
     "BD_MSD441C_T7_10A"
#elif (MS_BOARD_TYPE_SEL == BD_MSD523B_T4_20A)
     "BD_MSD523B_T4_20A"
#elif (MS_BOARD_TYPE_SEL == BD_MSD523I_T4_10A)
     "BD_MSD523I_T4_10A"
#elif (MS_BOARD_TYPE_SEL == BD_MSD309PX_HIS)
     "BD_MSD309PX_HIS"
#elif (MS_BOARD_TYPE_SEL == BD_MSD306PT_HIS)
     "BD_MSD306PT_HIS"
#elif (MS_BOARD_TYPE_SEL == BD_MST6I78_MALATA)
     "BD_MST6I78_MALATA"
#elif (MS_BOARD_TYPE_SEL == BD_TCL_JNS_10A_9463)
     "BD_TCL_JNS_10A_9463"
#elif (MS_BOARD_TYPE_SEL == BD_MSD308PX_TCL)
     "BD_MSD308PX_TCL"
#elif (MS_BOARD_TYPE_SEL == BD_MST132A_D01A_S_A7)
     "BD_MST132A_D01A_S_A7"
#elif (MS_BOARD_TYPE_SEL == BD_MST132B_D01A_S)
     "BD_MST132B_D01A_S"
#elif (MS_BOARD_TYPE_SEL == BD_MST132C_D01A_S)
     "BD_MST132C_D01A_S"
#elif (MS_BOARD_TYPE_SEL == BD_MST015B_10ABX_NONOS)
     "BD_MST015B_10ABX_NONOS"
#elif (MS_BOARD_TYPE_SEL == BD_MST024B_D01A_S)
     "BD_MST024B_D01A_S"
     ...
     "BD_MST157E_C02A_EMERALD"
#elif (MS_BOARD_TYPE_SEL == BD_MST157E_C02A_EMERALD_CUS21SH)
     "BD_MST157E_C02A_EMERALD_CUS21SH"
#elif (MS_BOARD_TYPE_SEL == BD_MST157E_C02A_EMERALD_CUS21SH_DTMB)
     "BD_MST157E_C02A_EMERALD_CUS21SH_DTMB"

#elif (MS_BOARD_TYPE_SEL == BD_MST157A_D01A_S_EMERALD)    //Emerald
     "BD_MST157A_D01A_S_EMERALD"
#elif (MS_BOARD_TYPE_SEL == BD_MST157B_D01A_S_EMERALD)    //Emerald
     "BD_MST157B_D01A_S_EMERALD"
#elif (MS_BOARD_TYPE_SEL == BD_MST157C_D01A_S_EMERALD)    //Emerald
     "BD_MST157C_D01A_S_EMERALD"
#elif (MS_BOARD_TYPE_SEL == BD_MST157I_D01A_S_EMERALD)
     "BD_MST157I_D01A_S_EMERALD"
#elif (MS_BOARD_TYPE_SEL == BD_MST043B_10ALB_12351)       // Eden
     "BD_MST043B_10ALB_12351"
#elif (MS_BOARD_TYPE_SEL == BD_MST043B_10BLB_12413)       // Eden
     "BD_MST043B_10BLB_12413"
#elif (MS_BOARD_TYPE_SEL == BD_MST042B_10BLU_12423)        // Eden
     "BD_MST042B_10BLU_12423"
#elif (MS_BOARD_TYPE_SEL == BD_MST044B_10BLA_12423)        // Eden
     "BD_MST044B_10BLA_12423"
#elif (MS_BOARD_TYPE_SEL == BD_MST044B_10BLA_12423_32)     // Eden
     "BD_MST044B_10BLA_12423_32"
#elif (MS_BOARD_TYPE_SEL == BD_MST165A_D01A_S_EDEN)     // Eden
     "BD_MST165A_D01A_S_EDEN"

#elif (MS_BOARD_TYPE_SEL == BD_MST180A_D01A_S_NUGGET)    //Nugget
     "BD_MST180A_D01A_S_NUGGET"
#elif (MS_BOARD_TYPE_SEL == BD_MST180B_D01A_S_NUGGET)    //Nugget
     "BD_MST180B_D01A_S_NUGGET"
#elif (MS_BOARD_TYPE_SEL == BD_MST180C_D01A_S_NUGGET)    //Nugget
     "BD_MST180C_D01A_S_NUGGET"

#elif (MS_BOARD_TYPE_SEL == BD_MST186A_D01A_S_NIKON)     //Nikon
     "BD_MST186A_D01A_S_NIKON"
#elif (MS_BOARD_TYPE_SEL == BD_MST186B_D01A_S_NIKON)     //Nikon
     "BD_MST186B_D01A_S_NIKON"
#elif (MS_BOARD_TYPE_SEL == BD_MST186C_D01A_S_NIKON)     //Nikon
     "BD_MST186C_D01A_S_NIKON"
#elif (MS_BOARD_TYPE_SEL == BD_MST186D_D01A_S_NIKON)     //Nikon
     "BD_MST186D_D01A_S_NIKON"

#elif (MS_BOARD_TYPE_SEL == BD_MST195A_D01A_S_NASA)      //Nasa
     "BD_MST195A_D01A_S_NASA"
#elif (MS_BOARD_TYPE_SEL == BD_MST195B_D01A_S_NASA)      //Nasa
     "BD_MST195B_D01A_S_NASA"
#elif (MS_BOARD_TYPE_SEL == BD_MST186A_D01A_S_NASA)      //Nasa
     "BD_MST186A_D01A_S_NASA"

#elif (MS_BOARD_TYPE_SEL == BD_MST048B_10APB_13101)
     "BD_MST048B_10APB_13101"
#elif (MS_BOARD_TYPE_SEL == BD_MST060B_10AZBT_13502)     //Nasa
     "BD_MST060B_10AZBT_13502"
#else
    "Unknow board type"
#endif
*/
...
*/
  ...
  #if ENABLE_DESIGN_POWER_ON_MODE
    {
        EN_DESIGN_PAGE_PICTURE_MODE,
        EN_DESIGN_PAGE_ROOT, EN_DESIGN_PAGE_PICTURE_MODE,
        7, en_str_Backlight, FALSE
    },
  #endif
    {
        EN_DESIGN_PAGE_PICTURE_MODE,
        EN_DESIGN_PAGE_ROOT, EN_DESIGN_PAGE_PICTURE_MODE,
        8, en_str_COPY_ALL, FALSE
    },
    ...
    */
    ...
    },
    {
        EN_DESIGN_PAGE_SSC,
        EN_DESIGN_PAGE_ROOT, EN_DESIGN_PAGE_SSC,
        1, en_str_MIU_Span, FALSE
    },
    {
        EN_DESIGN_PAGE_SSC,
        EN_DESIGN_PAGE_ROOT, EN_DESIGN_PAGE_SSC,
        2, en_str_MIU_Step, FALSE
    },
    {
        EN_DESIGN_PAGE_SSC,
        EN_DESIGN_PAGE_ROOT, EN_DESIGN_PAGE_SSC,
    ...
    },
    {
        EN_DESIGN_PAGE_SSC,
        EN_DESIGN_PAGE_ROOT, EN_DESIGN_PAGE_SSC,
        5, en_str_LVDS_Span, FALSE
    },
    {
        EN_DESIGN_PAGE_SSC,
        EN_DESIGN_PAGE_ROOT, EN_DESIGN_PAGE_SSC,
        6, en_str_LVDS_Step, FALSE
    },
    {
        EN_DESIGN_PAGE_SSC,
        EN_DESIGN_PAGE_ROOT, EN_DESIGN_PAGE_SSC,
        7, en_str_LVDS_Swing, FALSE
    },
    //==SPECIAL SET=============================================
    {
        EN_DESIGN_PAGE_SPECIAL_SET,
    ...
    {
        EN_DESIGN_PAGE_VIF,
        EN_DESIGN_PAGE_NON_STANDARD, EN_DESIGN_PAGE_VIF1,
        0, en_str_VIF1, FALSE
    },
    {
        EN_DESIGN_PAGE_VIF,
        EN_DESIGN_PAGE_NON_STANDARD, EN_DESIGN_PAGE_VIF2,
        1, en_str_VIF2, FALSE
    },
    {
        EN_DESIGN_PAGE_VIF,
        EN_DESIGN_PAGE_NON_STANDARD, EN_DESIGN_PAGE_VIF3,
        2, en_str_VIF3, FALSE
    },
    /*
    {
    ...
    */
    ...
    {
        EN_DESIGN_PAGE_VIF1,
        EN_DESIGN_PAGE_VIF, EN_DESIGN_PAGE_VIF1,
    ...
    // {
    //       EN_DESIGN_PAGE_VIF1,
    //       EN_DESIGN_PAGE_ROOT, EN_DESIGN_PAGE_VIF1,
    ...
    {
        EN_DESIGN_PAGE_VIF2,
        EN_DESIGN_PAGE_VIF, EN_DESIGN_PAGE_VIF2,
        0, en_str_VIF_CR_KP, FALSE
    },
    {
        EN_DESIGN_PAGE_VIF2,
        EN_DESIGN_PAGE_VIF, EN_DESIGN_PAGE_VIF2,
        1, en_str_VIF_CR_KI, FALSE
    },
#if 0
    {
        EN_DESIGN_PAGE_VIF2,
        EN_DESIGN_PAGE_VIF, EN_DESIGN_PAGE_VIF2,
        2, en_str_VIF_CR_KP1, FALSE
    },
    {
        EN_DESIGN_PAGE_VIF2,
        EN_DESIGN_PAGE_VIF, EN_DESIGN_PAGE_VIF2,
        3, en_str_VIF_CR_KI1, FALSE
    },
    {
        EN_DESIGN_PAGE_VIF2,
        EN_DESIGN_PAGE_VIF, EN_DESIGN_PAGE_VIF2,
        4, en_str_VIF_CR_KP2, FALSE
    },
    {
        EN_DESIGN_PAGE_VIF2,
        EN_DESIGN_PAGE_VIF, EN_DESIGN_PAGE_VIF2,
        5, en_str_VIF_CR_KI2, FALSE
    },
#endif
    {
        EN_DESIGN_PAGE_VIF2,
    ...
    {
        EN_DESIGN_PAGE_VIF3,
        EN_DESIGN_PAGE_VIF, EN_DESIGN_PAGE_VIF3,
   ...
   // },
    ...
    },
    {
        EN_DESIGN_PAGE_VIF2,
        EN_DESIGN_PAGE_VIF, EN_DESIGN_PAGE_VIF2,
        11, en_str_VIF_ASIA_SIGNAL_OPTION, FALSE
    },
    {
        EN_DESIGN_PAGE_VIF2,
        EN_DESIGN_PAGE_VIF, EN_DESIGN_PAGE_VIF2,
        12, en_str_VIF_AGC_REF, FALSE
    },
    {
        EN_DESIGN_PAGE_VIF2,
        EN_DESIGN_PAGE_VIF, EN_DESIGN_PAGE_VIF2,
        13, en_str_VERSION, FALSE
    },
    //==VIF3=============================================
    {
        EN_DESIGN_PAGE_VIF3,
    ...
    //{
    //    EN_DESIGN_PAGE_VIF3,
    //    EN_DESIGN_PAGE_ROOT, EN_DESIGN_PAGE_VIF3,
 ...
 //==NONLINEAR CURVE======================================
    ...
    {
        EN_DESIGN_PAGE_NONLINEAR_CURVE,
        EN_DESIGN_PAGE_ROOT, EN_DESIGN_PAGE_BRIGHTNESS_CURVE,
        2, en_str_Brightness_Curve, FALSE
    },
    {
        EN_DESIGN_PAGE_NONLINEAR_CURVE,
        EN_DESIGN_PAGE_ROOT, EN_DESIGN_PAGE_CONTRAST_CURVE,
        3, en_str_Contrast_Curve, FALSE
    },
    {
        EN_DESIGN_PAGE_NONLINEAR_CURVE,
        EN_DESIGN_PAGE_ROOT, EN_DESIGN_PAGE_SATURATION_CURVE,
        4, en_str_Saturation_Curve, FALSE
    },
    {
        EN_DESIGN_PAGE_NONLINEAR_CURVE,
        EN_DESIGN_PAGE_ROOT, EN_DESIGN_PAGE_HUE_CURVE,
        5, en_str_Hue_Curve, FALSE
    },
    {
        EN_DESIGN_PAGE_NONLINEAR_CURVE,
        EN_DESIGN_PAGE_ROOT, EN_DESIGN_PAGE_SHARPNESS_CURVE,
        6, en_str_Sharpness_Curve, FALSE
    },
    {
        EN_DESIGN_PAGE_NONLINEAR_CURVE,
        EN_DESIGN_PAGE_ROOT, EN_DESIGN_PAGE_VOLUME_CURVE,
        7, en_str_Volume_Curve, FALSE
    },
    //==BRIGHTNESS CURVE =====================================
    {
        EN_DESIGN_PAGE_BRIGHTNESS_CURVE,
        EN_DESIGN_PAGE_NONLINEAR_CURVE, EN_DESIGN_PAGE_BRIGHTNESS_CURVE,
    ...
    {
        EN_DESIGN_PAGE_CONTRAST_CURVE,
        EN_DESIGN_PAGE_NONLINEAR_CURVE, EN_DESIGN_PAGE_CONTRAST_CURVE,
        0, en_str_OSD_0, FALSE
    },
    {
        EN_DESIGN_PAGE_CONTRAST_CURVE,
    ...
    {
        EN_DESIGN_PAGE_SATURATION_CURVE,
        EN_DESIGN_PAGE_NONLINEAR_CURVE, EN_DESIGN_PAGE_SATURATION_CURVE,
        0, en_str_OSD_0, FALSE
    },
    {
        EN_DESIGN_PAGE_SATURATION_CURVE,
    ...
    {
        EN_DESIGN_PAGE_HUE_CURVE,
        EN_DESIGN_PAGE_NONLINEAR_CURVE, EN_DESIGN_PAGE_HUE_CURVE,
        0, en_str_OSD_0, FALSE
    },
    {
        EN_DESIGN_PAGE_HUE_CURVE,
    ...
    {
        EN_DESIGN_PAGE_SHARPNESS_CURVE,
        EN_DESIGN_PAGE_NONLINEAR_CURVE, EN_DESIGN_PAGE_SHARPNESS_CURVE,
        0, en_str_OSD_0, FALSE
    },
    {
        EN_DESIGN_PAGE_SHARPNESS_CURVE,
    ...
    {
        EN_DESIGN_PAGE_VOLUME_CURVE,
        EN_DESIGN_PAGE_NONLINEAR_CURVE, EN_DESIGN_PAGE_VOLUME_CURVE,
        0, en_str_OSD_0, FALSE
    },
    {
        EN_DESIGN_PAGE_VOLUME_CURVE,
        ...
        case EN_DESIGN_PAGE_ADC_ADJUST:
            ...
            switch(u8Item)
            {
                case 0: //from case MAPP_UIMENUFUNC_ADJUSTADC_MODE:
                    stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE =
                        (EN_DESIGN_ADC_ADJUST_MODE)MApp_ZUI_ACT_DecIncValue_Cycle(bInc, (U16)stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE, 0, (U16)EN_FacAdj_AdcMode_Ypbpr_Num-1, 1);

                    if(stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE == EN_FacAdj_AdcMode_RGB)
                    {
                        DATA_INPUT_SOURCE_TYPE(MAIN_WINDOW) = DATA_INPUT_SOURCE_RGB;
                        _MApp_ZUI_ACT_DesignMenu_ChangeDataInputSource(DATA_INPUT_SOURCE_TYPE(MAIN_WINDOW));
                    }
                    #if (INPUT_YPBPR_VIDEO_COUNT >= 1)
                    else if((stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE == EN_FacAdj_AdcMode_Ypbpr_SD)
                        || (stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE == EN_FacAdj_AdcMode_Ypbpr_HD))
                    {
                ...
                case 2: //from case MAPP_UIMENUFUNC_ADJUSTADC_REDGAIN:
                    stGenSettingExt.g_AdcSetting[stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE].stAdcGainOffsetSetting.u16RedGain =
                       (EN_DESIGN_ADC_ADJUST_MODE) MApp_ZUI_ACT_DecIncValue_Cycle(bInc, (U16)stGenSettingExt.g_AdcSetting[stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE].stAdcGainOffsetSetting.u16RedGain, 0, MApi_XC_ADC_GetMaximalGainValue(), 4);
                    MApp_SaveADCSetting((E_ADC_SET_INDEX)stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE);
                    //if(DATA_INPUT_SOURCE_TYPE == stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE)
                    if( ( UI_INPUT_SOURCE_TYPE == UI_INPUT_SOURCE_RGB && stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE == EN_FacAdj_AdcMode_RGB )
                    #if (INPUT_YPBPR_VIDEO_COUNT >= 1)
                            ||( UI_INPUT_SOURCE_TYPE == UI_INPUT_SOURCE_COMPONENT && stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE == EN_FacAdj_AdcMode_Ypbpr_SD )
                            ||( UI_INPUT_SOURCE_TYPE == UI_INPUT_SOURCE_COMPONENT && stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE == EN_FacAdj_AdcMode_Ypbpr_HD )
                    #endif
                        )
                    {
                        MApi_XC_ADC_AdjustGainOffset(&stGenSettingExt.g_AdcSetting[stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE].stAdcGainOffsetSetting);
                    }
                    return EN_REDRAW_ITEM;

                case 3: //from case MAPP_UIMENUFUNC_ADJUSTADC_GREENGAIN:
                    stGenSettingExt.g_AdcSetting[stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE].stAdcGainOffsetSetting.u16GreenGain =
                       (EN_DESIGN_ADC_ADJUST_MODE) MApp_ZUI_ACT_DecIncValue_Cycle(bInc, (U16)stGenSettingExt.g_AdcSetting[stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE].stAdcGainOffsetSetting.u16GreenGain, 0, MApi_XC_ADC_GetMaximalGainValue(), 4);
                    MApp_SaveADCSetting((E_ADC_SET_INDEX)stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE);
                    //if(DATA_INPUT_SOURCE_TYPE == stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE)
                    if( ( UI_INPUT_SOURCE_TYPE == UI_INPUT_SOURCE_RGB && stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE == EN_FacAdj_AdcMode_RGB )
                    #if (INPUT_YPBPR_VIDEO_COUNT >= 1)
                ...
                case 4: //from case MAPP_UIMENUFUNC_ADJUSTADC_BLUEGAIN:
                    stGenSettingExt.g_AdcSetting[stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE].stAdcGainOffsetSetting.u16BlueGain =
                        (EN_DESIGN_ADC_ADJUST_MODE)MApp_ZUI_ACT_DecIncValue_Cycle(bInc, (U16)stGenSettingExt.g_AdcSetting[stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE].stAdcGainOffsetSetting.u16BlueGain, 0, MApi_XC_ADC_GetMaximalGainValue(), 4);
                    MApp_SaveADCSetting((E_ADC_SET_INDEX)stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE);
                    //if(DATA_INPUT_SOURCE_TYPE == stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE)
                    if( ( UI_INPUT_SOURCE_TYPE == UI_INPUT_SOURCE_RGB && stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE == EN_FacAdj_AdcMode_RGB )
                    #if (INPUT_YPBPR_VIDEO_COUNT >= 1)
                ...
                case 6: //from case MAPP_UIMENUFUNC_ADJUSTADC_REDOFFSET:
                    stGenSettingExt.g_AdcSetting[stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE].stAdcGainOffsetSetting.u16RedOffset =
                        (EN_DESIGN_ADC_ADJUST_MODE)MApp_ZUI_ACT_DecIncValue_Cycle(bInc, (U16)stGenSettingExt.g_AdcSetting[stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE].stAdcGainOffsetSetting.u16RedOffset, 0, MApi_XC_ADC_GetMaximalOffsetValue(), 2);
                    MApp_SaveADCSetting((E_ADC_SET_INDEX)stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE);
                    //if(DATA_INPUT_SOURCE_TYPE == stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE)
                    if( ( UI_INPUT_SOURCE_TYPE == UI_INPUT_SOURCE_RGB && stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE == EN_FacAdj_AdcMode_RGB )
                    #if (INPUT_YPBPR_VIDEO_COUNT >= 1)
                ...
                case 7: //from case MAPP_UIMENUFUNC_ADJUSTADC_GREENOFFSET:
                    stGenSettingExt.g_AdcSetting[stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE].stAdcGainOffsetSetting.u16GreenOffset =
                        (EN_DESIGN_ADC_ADJUST_MODE)MApp_ZUI_ACT_DecIncValue_Cycle(bInc,(U16) stGenSettingExt.g_AdcSetting[stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE].stAdcGainOffsetSetting.u16GreenOffset, 0, MApi_XC_ADC_GetMaximalOffsetValue(), 2);
                    MApp_SaveADCSetting((E_ADC_SET_INDEX)stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE);
                    //if(DATA_INPUT_SOURCE_TYPE == stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE)
                    if( ( UI_INPUT_SOURCE_TYPE == UI_INPUT_SOURCE_RGB && stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE == EN_FacAdj_AdcMode_RGB )
                    #if (INPUT_YPBPR_VIDEO_COUNT >= 1)
                ...
                case 8: //from case MAPP_UIMENUFUNC_ADJUSTADC_BLUEOFFSET:
                    ...
                    stGenSettingExt.g_AdcSetting[stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE].stAdcGainOffsetSetting.u16BlueOffset =
                        (EN_DESIGN_ADC_ADJUST_MODE)MApp_ZUI_ACT_DecIncValue_Cycle(bInc, (U16)stGenSettingExt.g_AdcSetting[stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE].stAdcGainOffsetSetting.u16BlueOffset, 0, MApi_XC_ADC_GetMaximalOffsetValue(), 2);
                ...
                case 10: // from case MAPP_UIMENUFUNC_ADJUSTADC_CALIBRATION:
                    if(IsVgaInUse() && MApp_IsSrcHasSignal(MAIN_WINDOW) && (stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE == EN_FacAdj_AdcMode_RGB))
                    {
                        ...
                        && ((stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE == EN_FacAdj_AdcMode_Ypbpr_SD) || (stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE == EN_FacAdj_AdcMode_Ypbpr_HD)))
                    {
                ...
                case 11: // Phase
                {
                    ...
                    if(IsVgaInUse() && MApp_IsSrcHasSignal(MAIN_WINDOW) && (stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE == EN_FacAdj_AdcMode_RGB))
                    {
                        ADC_ADJUST_Phase[stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE] = MApi_XC_ADC_GetPhase();
                        ADC_ADJUST_Phase[stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE]
                            = (MS_U8)MApp_ZUI_ACT_DecIncValue_Cycle(bInc, ADC_ADJUST_Phase[stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE], 0, 255, 1);
                        MApi_XC_ADC_SetPhase(ADC_ADJUST_Phase[stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE]);
        ...
        case EN_DESIGN_PAGE_PICTURE_MODE:
            switch(u8Item)
            {
                ...
                case 7:
                    ...
                    stGenSetting.u8Backlight = MApp_ZUI_ACT_DecIncValue(
                        bInc,stGenSetting.u8Backlight, 0, 100, 1);										
										#else	
                    ...
                    return EN_REDRAW_ITEM;
                case 8: //from case MAPP_UIMENUFUNC_SUB_BC_ADJUST_COPY_ALL:
        ...
        case EN_DESIGN_PAGE_WHITE_BALANCE:
            switch(u8Item)
            {
                ...
                case 2: //from case MAPP_UIMENUFUNC_WB_ADJUST_TEMPERATURE:
                    ST_VIDEO.eColorTemp =
                       (EN_MS_COLOR_TEMP)MApp_ZUI_ACT_DecIncValue_Cycle(bInc,(U16) ST_VIDEO.eColorTemp, MS_COLOR_TEMP_MIN, MS_COLOR_TEMP_MAX, 1);
...
*/
           ...
           case 6:
            ...
            case EN_DESIGN_PAGE_VIF1:
            #if ENABLE_VD_PACH_IN_CHINA
                switch(u8Item)
                {
                #if(CHIP_FAMILY_TYPE == CHIP_FAMILY_EULER)
                    case 0:
                        G_DESIGN_SETTING.stVDSetting.u8AFEC_43= (U8)MApp_ZUI_ACT_DecIncValue_Cycle(bInc,
                                (U16)G_DESIGN_SETTING.stVDSetting.u8AFEC_43, 0, 0xFF, 1);
                    ...
                    case 4:
                        ...
                        return EN_REDRAW_ITEM;
                    case 5:
                        G_DESIGN_SETTING.stVDSetting.u8AFEC_A0 = (U8)MApp_ZUI_ACT_DecIncValue_Cycle(bInc,
                            (U16)G_DESIGN_SETTING.stVDSetting.u8AFEC_A0, 0, 0xFF, 0x10);
                        MDrv_WriteByte(BK_AFEC_A0_ADDRESS, G_DESIGN_SETTING.stVDSetting.u8AFEC_A0);
                        MApp_SaveDesignSetting();
                        return EN_REDRAW_ITEM;
                    case 6:
                        G_DESIGN_SETTING.stVDSetting.u8AFEC_A1 = (U8)MApp_ZUI_ACT_DecIncValue_Cycle(bInc,
                            (U16)G_DESIGN_SETTING.stVDSetting.u8AFEC_A1, 0, 0xFF, 1);
                    ...
                    case 12:
                        ...
                        MDrv_WriteByteMask(BK_AFEC_D8_ADDRESS, G_DESIGN_SETTING.stVDSetting.u8AFEC_D8_Bit3210, 0x0F);
                        MApp_SaveDesignSetting();
                        return EN_REDRAW_ITEM;
                    case 13:
                        ...
                        return EN_REDRAW_ITEM;
                    case 14:
                        G_DESIGN_SETTING.stVDSetting.Vif_VGA_MAXIMUM = ((U16)MApp_ZUI_ACT_DecIncValue_Cycle(bInc,
                            (U16)G_DESIGN_SETTING.stVDSetting.Vif_VGA_MAXIMUM/0x10, 0, 0xFFF, 0x80)*0x10);
                        MApp_SaveDesignSetting();
                        return EN_REDRAW_ITEM;
                    case 15:
                        G_DESIGN_SETTING.stVDSetting.Gain_DISTRIBUTION_THR = ((U16)MApp_ZUI_ACT_DecIncValue_Cycle(bInc,
                            (U16)G_DESIGN_SETTING.stVDSetting.Gain_DISTRIBUTION_THR/0x10, 0, 0xFFF, 0x80)*0x10);
                        MApp_SaveDesignSetting();
                        return EN_REDRAW_ITEM;
                    case 16:
                        {
                            U16 i;
                            G_DESIGN_SETTING.stVDSetting.China_DESCRAMBLER_BOX = (U8)MApp_ZUI_ACT_DecIncValue_Cycle(bInc,
                                (U16)G_DESIGN_SETTING.stVDSetting.China_DESCRAMBLER_BOX, 0, 7, 1);
                            MApp_SaveDesignSetting();
                            for (i = 0; i < COUNTOF(_DesignMenuItem); i++)
                            {
                                if(_DesignMenuItem[i].u16StringID == en_str_VIF_PROGRAMMABLE_DELAY)
                        ...
                        return EN_REDRAW_ITEM;
                    case 17:
                        G_DESIGN_SETTING.stVDSetting.Vif_PROGRAMMABLE_DELAY = (U8)MApp_ZUI_ACT_DecIncValue_Cycle(bInc,
                            (U16)G_DESIGN_SETTING.stVDSetting.Vif_PROGRAMMABLE_DELAY, 0, 132, 1);
                        MApp_SaveDesignSetting();
                        return EN_REDRAW_ITEM;
                #else
                    case 0:
                    ...
                    case 9:
                        G_DESIGN_SETTING.stVDSetting.VifTop = (U8)MApp_ZUI_ACT_DecIncValue_Cycle(bInc,
                        (U16)G_DESIGN_SETTING.stVDSetting.VifTop, 0, 0x0F, 1);
                        MApp_SaveDesignSetting();
                        return EN_REDRAW_ITEM;
                    ...
                    case 12:
                        ...
                        return EN_REDRAW_ITEM;
                    // case 12:
                    //    G_DESIGN_SETTING.stVDSetting.Vif_AGC_VGA_BASE = (U8)MApp_ZUI_ACT_DecIncValue_Cycle(bInc,
                    //                (U16)G_DESIGN_SETTING.stVDSetting.Vif_AGC_VGA_BASE, 0, 0xFF, 1);
                    //       MApp_SaveDesignSetting();
                    //       return EN_REDRAW_ITEM;
                    case 13:
                        {
                        ...
                        (CHIP_FAMILY_TYPE == CHIP_FAMILY_NASA))
                        G_DESIGN_SETTING.stVDSetting.China_DESCRAMBLER_BOX = (U8)MApp_ZUI_ACT_DecIncValue_Cycle(bInc,
                        (U16)G_DESIGN_SETTING.stVDSetting.China_DESCRAMBLER_BOX, 0, 5, 1);
                    #else
                        G_DESIGN_SETTING.stVDSetting.China_DESCRAMBLER_BOX = (U8)MApp_ZUI_ACT_DecIncValue_Cycle(bInc,
                        (U16)G_DESIGN_SETTING.stVDSetting.China_DESCRAMBLER_BOX, 0, 2, 1);
                    #endif
                        MApp_SaveDesignSetting();
                        return EN_REDRAW_ITEM;
                        */
            ...
            case EN_DESIGN_PAGE_VIF2:
                ...
                switch(u8Item)
                {
                    ...
                    case 1:
                        ...
                        return EN_REDRAW_ITEM;
                    case 2:
                        G_DESIGN_SETTING.stVDSetting.Vif_CR_KP1 = (U8)MApp_ZUI_ACT_DecIncValue_Cycle(bInc,
                            (U16)G_DESIGN_SETTING.stVDSetting.Vif_CR_KP1, 0, 0x0F, 1);
                        MApp_SaveDesignSetting();
                        return EN_REDRAW_ITEM;

                    case 3:
                        G_DESIGN_SETTING.stVDSetting.Vif_CR_KI1 = (U8)MApp_ZUI_ACT_DecIncValue_Cycle(bInc,
                            (U16)G_DESIGN_SETTING.stVDSetting.Vif_CR_KI1, 0, 0x0F, 1);
                        MApp_SaveDesignSetting();
                        return EN_REDRAW_ITEM;
                    case 4:
                        G_DESIGN_SETTING.stVDSetting.Vif_CR_KP2 = (U8)MApp_ZUI_ACT_DecIncValue_Cycle(bInc,
                            (U16)G_DESIGN_SETTING.stVDSetting.Vif_CR_KP2, 0, 0x0F, 1);
                        MApp_SaveDesignSetting();
                        return EN_REDRAW_ITEM;
                    case 5:
                        G_DESIGN_SETTING.stVDSetting.Vif_CR_KI2 = (U8)MApp_ZUI_ACT_DecIncValue_Cycle(bInc,
                            (U16)G_DESIGN_SETTING.stVDSetting.Vif_CR_KI2, 0, 0x0F, 1);
                        MApp_SaveDesignSetting();
                        return EN_REDRAW_ITEM;
                    case 6:
                        G_DESIGN_SETTING.stVDSetting.Vif_CR_LOCK_THR = (U16)MApp_ZUI_ACT_DecIncValue_Cycle(bInc,
                            (U16)G_DESIGN_SETTING.stVDSetting.Vif_CR_LOCK_THR, 0, 0x3FF, 0x10);
                        MApp_SaveDesignSetting();
                        return EN_REDRAW_ITEM;
                    case 7:
                        G_DESIGN_SETTING.stVDSetting.Vif_CR_THR = ((U16)MApp_ZUI_ACT_DecIncValue_Cycle(bInc,
                            (U16)G_DESIGN_SETTING.stVDSetting.Vif_CR_THR/0x10, 0, 0x3FF, 0x10)*0x10);
                        MApp_SaveDesignSetting();
                        return EN_REDRAW_ITEM;
                    case 8:
                        G_DESIGN_SETTING.stVDSetting.Vif_CR_KP_KI_ADJUST = (U8)MApp_ZUI_ACT_DecIncValue_Cycle(bInc,
                            (U16)G_DESIGN_SETTING.stVDSetting.Vif_CR_KP_KI_ADJUST, 0, 1, 1);
                        MApp_SaveDesignSetting();
                        return EN_REDRAW_ITEM;
                    case 9:
                        G_DESIGN_SETTING.stVDSetting.Vif_OVER_MODULATION = (U8)MApp_ZUI_ACT_DecIncValue_Cycle(bInc,
                            (U16)G_DESIGN_SETTING.stVDSetting.Vif_OVER_MODULATION, 0, 1, 1);
                        MApp_SaveDesignSetting();
                        return EN_REDRAW_ITEM;
                    case 10: //VERSION
                    ...
                    case 8:
                        ...
                        return EN_REDRAW_ITEM;
                    case 9:
                        G_DESIGN_SETTING.stVDSetting.Vif_DELAY_REDUCE = (U8)MApp_ZUI_ACT_DecIncValue_Cycle(bInc,
                        (U16)G_DESIGN_SETTING.stVDSetting.Vif_DELAY_REDUCE, 0, 0xFF, 1);
                        MApp_SaveDesignSetting();
                        return EN_REDRAW_ITEM;
                    case 10:
                        G_DESIGN_SETTING.stVDSetting.Vif_OVER_MODULATION = (U8)MApp_ZUI_ACT_DecIncValue_Cycle(bInc,
                    ...
                    case 11: // VIF_AGC_REF
                        ...
                        MApp_SaveDesignSetting();
                        return EN_REDRAW_ITEM;
                    case 12: // VIF_ASIA_SIGNAL_OPTION
                        G_DESIGN_SETTING.stVDSetting.Vif_AGCREFNEGATIVE = (U8)MApp_ZUI_ACT_DecIncValue_Cycle(bInc,
                                (U8)G_DESIGN_SETTING.stVDSetting.Vif_AGCREFNEGATIVE, 0, 0xFF, 1);
                        MApp_SaveDesignSetting();
                        return EN_REDRAW_ITEM;
                    case 13: // VERSION
                        return EN_REDRAW_NONE;
            ...
            case EN_DESIGN_PAGE_VIF3:
                ...
                switch(u8Item)
                {
                    ...
                    case 0:
                        ...
                        G_DESIGN_SETTING.stVDSetting.Vif_CLAMPGAIN_GAIN_OV_NEGATIVE, 0, 0xFFFF, 1);
                        MApp_SaveDesignSetting();
                        return EN_REDRAW_ITEM;
                    ...
                    case 3:
                        ...
                        (U16)G_DESIGN_SETTING.stVDSetting.AUDIO_NR, 0, 0xFF, 1);
                    ...
                    case 3:
                        ...
                        return EN_REDRAW_ITEM;
                    //  case 4:
                    //   G_DESIGN_SETTING.stVDSetting.u8AFEC_258D= (U8)MApp_ZUI_ACT_DecIncValue_Cycle(bInc,
                    //            (U16)G_DESIGN_SETTING.stVDSetting.u8AFEC_258D, 0, 0xFF, 0x10);
                    //   MDrv_WriteByte(0x102580, G_DESIGN_SETTING.stVDSetting.u8AFEC_258D);
                    //  MApp_SaveDesignSetting();
                    //  return EN_REDRAW_ITEM;
                    case 4:
                        G_DESIGN_SETTING.stVDSetting.Vif_CLAMPGAIN_GAIN_OV_NEGATIVE= MApp_ZUI_ACT_DecIncValue_Cycle(bInc,
                        ...
                        return EN_REDRAW_ITEM;
                    case 5:
                        G_DESIGN_SETTING.stVDSetting.Vif_CLAMPGAIN_CLAMP_OV_NEGATIVE= MApp_ZUI_ACT_DecIncValue_Cycle(bInc,
                        G_DESIGN_SETTING.stVDSetting.Vif_CLAMPGAIN_CLAMP_OV_NEGATIVE, 0, 0xFFFF, 1);
                        MApp_SaveDesignSetting();
                        return EN_REDRAW_ITEM;
                    case 6:
                        G_DESIGN_SETTING.stVDSetting.AUDIO_HIDEV= (U8)MApp_ZUI_ACT_DecIncValue_Cycle(bInc,
            ...
            case EN_DESIGN_PAGE_BRIGHTNESS_CURVE:
            case EN_DESIGN_PAGE_CONTRAST_CURVE:
            case EN_DESIGN_PAGE_SATURATION_CURVE:
            case EN_DESIGN_PAGE_HUE_CURVE:
            case EN_DESIGN_PAGE_SHARPNESS_CURVE:
            case EN_DESIGN_PAGE_VOLUME_CURVE:

            {
...
#if(ENABLE_PICTURE_NONLINEAR_CURVE)
                if(EN_DESIGN_PAGE_BRIGHTNESS_CURVE == _eDesignMenuPage)
                {
                    pNonLinearCurve = MApp_GetNonLinearCurve(NONLINEAR_CURVE_BRIGHTNESS);
                }
                else if(EN_DESIGN_PAGE_CONTRAST_CURVE == _eDesignMenuPage)
                {
                    pNonLinearCurve = MApp_GetNonLinearCurve(NONLINEAR_CURVE_CONTRAST);
                }
                else if(EN_DESIGN_PAGE_SATURATION_CURVE == _eDesignMenuPage)
                {
                    pNonLinearCurve = MApp_GetNonLinearCurve(NONLINEAR_CURVE_SATURATION);
                }
                else if(EN_DESIGN_PAGE_SHARPNESS_CURVE == _eDesignMenuPage)
                {
                    pNonLinearCurve = MApp_GetNonLinearCurve(NONLINEAR_CURVE_SHARPNESS);
                    u16MaxValue = 0x3F;
                }
                else if(EN_DESIGN_PAGE_HUE_CURVE == _eDesignMenuPage)
                {
                ...
                if(EN_DESIGN_PAGE_VOLUME_CURVE == _eDesignMenuPage)
                {
                ...
                else if(EN_DESIGN_PAGE_VOLUME_CURVE == _eDesignMenuPage)
                {
...
/*
        case EN_DESIGN_PAGE_ADC_ADJUST:
            switch(u8Item)
            {
                case 0: //from case DESIGN_ADC_ADJUST_MODE_TEXT:
                {
                    if (stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE == EN_FacAdj_AdcMode_RGB)
                        u16TempID=en_str_RGB;
                    else if (stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE == EN_FacAdj_AdcMode_Ypbpr_SD)
                        u16TempID=en_str_YPbPrbracketsSD;
                    else if (stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE == EN_FacAdj_AdcMode_Ypbpr_HD)
                ...
                case 2: //from case EN_DNUM_GetADC_RedGainValue:
                {
                    if (stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE == EN_FacAdj_AdcMode_RGB)
                    {
                        return MApp_ZUI_API_GetU16String(stGenSettingExt.g_AdcSetting[ADC_SET_VGA].stAdcGainOffsetSetting.u16RedGain / 4);
                    }
                    else if (stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE == EN_FacAdj_AdcMode_Ypbpr_SD)
                    {
                        return MApp_ZUI_API_GetU16String(stGenSettingExt.g_AdcSetting[ADC_SET_YPBPR_SD].stAdcGainOffsetSetting.u16RedGain / 4);
                    }
                    else if (stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE == EN_FacAdj_AdcMode_Ypbpr_HD)
                    {
                        return MApp_ZUI_API_GetU16String(stGenSettingExt.g_AdcSetting[ADC_SET_YPBPR_HD].stAdcGainOffsetSetting.u16RedGain / 4);
                    }
                ...
                case 3: //from case EN_DNUM_GetADC_GreenGainValue:
                {
                    if (stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE == EN_FacAdj_AdcMode_RGB)
                    {
                        return MApp_ZUI_API_GetU16String(stGenSettingExt.g_AdcSetting[ADC_SET_VGA].stAdcGainOffsetSetting.u16GreenGain / 4);
                    }
                    else if (stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE == EN_FacAdj_AdcMode_Ypbpr_SD)
                    {
                        return MApp_ZUI_API_GetU16String(stGenSettingExt.g_AdcSetting[ADC_SET_YPBPR_SD].stAdcGainOffsetSetting.u16GreenGain / 4);
                    }
                    else if (stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE == EN_FacAdj_AdcMode_Ypbpr_HD)
                    {
                        return MApp_ZUI_API_GetU16String(stGenSettingExt.g_AdcSetting[ADC_SET_YPBPR_HD].stAdcGainOffsetSetting.u16GreenGain / 4);
                    }
                }
                break;
                ...
                case 4: //from case EN_DNUM_GetADC_BlueGainValue:
                {
                    if (stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE == EN_FacAdj_AdcMode_RGB)
                    {
                        return MApp_ZUI_API_GetU16String(stGenSettingExt.g_AdcSetting[ADC_SET_VGA].stAdcGainOffsetSetting.u16BlueGain / 4);
                    }
                    else if (stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE == EN_FacAdj_AdcMode_Ypbpr_SD)
                    {
                        return MApp_ZUI_API_GetU16String(stGenSettingExt.g_AdcSetting[ADC_SET_YPBPR_SD].stAdcGainOffsetSetting.u16BlueGain / 4);
                    }
                    else if (stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE == EN_FacAdj_AdcMode_Ypbpr_HD)
                    {
                        return MApp_ZUI_API_GetU16String(stGenSettingExt.g_AdcSetting[ADC_SET_YPBPR_HD].stAdcGainOffsetSetting.u16BlueGain / 4);
                    }
                } break;
                ...
                case 6: //from case EN_DNUM_GetADC_RedOffsetValue:
                {
                    if (stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE == EN_FacAdj_AdcMode_RGB)
                    {
                        return MApp_ZUI_API_GetU16String(stGenSettingExt.g_AdcSetting[ADC_SET_VGA].stAdcGainOffsetSetting.u16RedOffset / 2);
                    }
                    else if (stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE == EN_FacAdj_AdcMode_Ypbpr_SD)
                    {
                        return MApp_ZUI_API_GetU16String(stGenSettingExt.g_AdcSetting[ADC_SET_YPBPR_SD].stAdcGainOffsetSetting.u16RedOffset / 2);
                    }
                    else if (stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE == EN_FacAdj_AdcMode_Ypbpr_HD)
                    {
                        return MApp_ZUI_API_GetU16String(stGenSettingExt.g_AdcSetting[ADC_SET_YPBPR_HD].stAdcGainOffsetSetting.u16RedOffset / 2);
                    }
                }
                break;
                ...
                case 7: //from case EN_DNUM_GetADC_GreenOffsetValue:
                {
                    if (stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE == EN_FacAdj_AdcMode_RGB)
                    {
                        return MApp_ZUI_API_GetU16String(stGenSettingExt.g_AdcSetting[ADC_SET_VGA].stAdcGainOffsetSetting.u16GreenOffset / 2);
                    }
                    else if (stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE == EN_FacAdj_AdcMode_Ypbpr_SD)
                    {
                        return MApp_ZUI_API_GetU16String(stGenSettingExt.g_AdcSetting[ADC_SET_YPBPR_SD].stAdcGainOffsetSetting.u16GreenOffset / 2);
                    }
                    else if (stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE == EN_FacAdj_AdcMode_Ypbpr_HD)
                    {
                        return MApp_ZUI_API_GetU16String(stGenSettingExt.g_AdcSetting[ADC_SET_YPBPR_HD].stAdcGainOffsetSetting.u16GreenOffset / 2);
                    }
                }
                break;
                ...
                case 8: //from case EN_DNUM_GetADC_BlueOffsetValue:
                {
                    if (stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE == EN_FacAdj_AdcMode_RGB)
                    {
                        return MApp_ZUI_API_GetU16String(stGenSettingExt.g_AdcSetting[ADC_SET_VGA].stAdcGainOffsetSetting.u16BlueOffset / 2);
                    }
                    else if (stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE == EN_FacAdj_AdcMode_Ypbpr_SD)
                    {
                        return MApp_ZUI_API_GetU16String(stGenSettingExt.g_AdcSetting[ADC_SET_YPBPR_SD].stAdcGainOffsetSetting.u16BlueOffset / 2);
                    }
                    else if (stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE == EN_FacAdj_AdcMode_Ypbpr_HD)
                    {
                        return MApp_ZUI_API_GetU16String(stGenSettingExt.g_AdcSetting[ADC_SET_YPBPR_HD].stAdcGainOffsetSetting.u16BlueOffset / 2);
                    }
                }
                break;
                ...
                case 10: //from case SUCCESSORFAIL_TEXT:
                {
                    if(g_ADCCalibrationResult == TRUE)
                    {
                        ...
                        else if (stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE == EN_FacAdj_AdcMode_Ypbpr_SD && !MApi_XC_Sys_IsSrcHD(MAIN_WINDOW))
                        {
                            u16TempID = en_str_Pass;
                        }
                        else if (stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE == EN_FacAdj_AdcMode_Ypbpr_HD && MApi_XC_Sys_IsSrcHD(MAIN_WINDOW))
                        {
                            u16TempID = en_str_Pass;
                        }
                        else
                    ...
                    else
                    {
                        ...
                        else
                        {
                            if (stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE == EN_FacAdj_AdcMode_RGB)
                            {
                                u16TempID = (stGenSettingExt.g_AdcSetting[ADC_SET_VGA].u8AdcCalOK == 0xAA)? en_str_Pass : en_str_Fail;// en_str_Fail;
                            }
                            else if (stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE == EN_FacAdj_AdcMode_Ypbpr_SD)
                            {
                                u16TempID = (stGenSettingExt.g_AdcSetting[ADC_SET_YPBPR_SD].u8AdcCalOK == 0xAA)? en_str_Pass : en_str_Fail;// en_str_Fail;
                            }
                            else if (stLMGenSetting.stMDesign_Adjust.enH1_ADC_ADJUST_MODE == EN_FacAdj_AdcMode_Ypbpr_HD)
                            {
                                u16TempID = (stGenSettingExt.g_AdcSetting[ADC_SET_YPBPR_HD].u8AdcCalOK == 0xAA)? en_str_Pass : en_str_Fail; // en_str_Fail;
                            }
                        }
                    }
                }
...
*/
                ...
                switch(u8Item)
                {
                    case 0:
                        return MApp_ZUI_API_StringBuffU8toU16(CHAR_BUFFER,
                                    (U8*)MApi_PNL_Get_PanelName(PANEL_CURRENT_TYPE_SEL),
                                    sizeof(MApi_PNL_Get_PanelName(PANEL_CURRENT_TYPE_SEL)) + 1 );
                    case 1:
        ...
        case EN_DESIGN_PAGE_PICTURE_MODE:
            switch(u8Item)
            {
                ...
                case 7:
										#ifdef sAddBacklightPara									
                    return MApp_ZUI_API_GetU16String(stGenSetting.u8Backlight);    
										#else	                
        ...
        case EN_DESIGN_PAGE_WHITE_BALANCE:
            switch(u8Item)
            {
                ...
                case 2: //from case WB_TEMPERATURE_TEXT:
                    {
                        if (ST_VIDEO.eColorTemp == MS_COLOR_TEMP_COOL)
                            u16TempID=en_str_Cool;
                        else if (ST_VIDEO.eColorTemp == MS_COLOR_TEMP_MEDIUM)
                            u16TempID=en_str_Medium;
                        else if (ST_VIDEO.eColorTemp == MS_COLOR_TEMP_WARM)
                            u16TempID=en_str_Warm;
                    #if(MS_COLOR_TEMP_COUNT ==4)
                        else if (ST_VIDEO.eColorTemp == MS_COLOR_TEMP_USER)
...
*/
    ...
    case EN_DESIGN_PAGE_VIF1:
        ...
        switch(u8Item)
        {
            ...
            case 5:
                return MApp_ZUI_API_GetU16HexString(G_DESIGN_SETTING.stVDSetting.u8AFEC_A0);
                break;

            case 6: //
                return MApp_ZUI_API_GetU16HexString(G_DESIGN_SETTING.stVDSetting.u8AFEC_A1);
                break;
            ...
            case 10: //
                return MApp_ZUI_API_GetU16HexString(G_DESIGN_SETTING.stVDSetting.u8AFEC_43);
                break;
            ...
            case 14: //
                return MApp_ZUI_API_GetU16HexString(G_DESIGN_SETTING.stVDSetting.Vif_VGA_MAXIMUM);
                break;

            case 15: //
                return MApp_ZUI_API_GetU16HexString(G_DESIGN_SETTING.stVDSetting.Gain_DISTRIBUTION_THR);
                break;
            //case 12: //
            //          return MApp_ZUI_API_GetU16HexString(G_DESIGN_SETTING.stVDSetting.Vif_AGC_VGA_BASE);
            //          break;
            case 16: //
            {
                char ptr[20];
                ...
                ptr[5]+= G_DESIGN_SETTING.stVDSetting.China_DESCRAMBLER_BOX;//VIF_VERSION3;
                if(G_DESIGN_SETTING.stVDSetting.China_DESCRAMBLER_BOX == 0)
                {
                ...
                else if(G_DESIGN_SETTING.stVDSetting.China_DESCRAMBLER_BOX == 7)
                {
                    ptr[0]='M';//VIF_VERSION1;
                    ptr[1]='o';//VIF_VERSION2;
                    ptr[2]='d';//VIF_VERSION3;
            ...
            case 17: //
            {
                if((G_DESIGN_SETTING.stVDSetting.Vif_PROGRAMMABLE_DELAY/2)/10==0)
                {
                    CHAR_BUFFER[0] = '0'+((G_DESIGN_SETTING.stVDSetting.Vif_PROGRAMMABLE_DELAY/2)%10);
                    CHAR_BUFFER[1] = '.';
                    if(G_DESIGN_SETTING.stVDSetting.Vif_PROGRAMMABLE_DELAY%2==0)
                    {
                        CHAR_BUFFER[2] = '0';
                    }
                    else
                ...
                {
                    CHAR_BUFFER[0] = '0'+((G_DESIGN_SETTING.stVDSetting.Vif_PROGRAMMABLE_DELAY/2)/10);
                    CHAR_BUFFER[1] = '0'+((G_DESIGN_SETTING.stVDSetting.Vif_PROGRAMMABLE_DELAY/2)%10);
                    CHAR_BUFFER[2] = '.';
                    if(G_DESIGN_SETTING.stVDSetting.Vif_PROGRAMMABLE_DELAY%2==0)
                    {
                        CHAR_BUFFER[3] = '0';
                ...
                case 8: //
                    ...
                    break;
                case 9: //
                    return MApp_ZUI_API_GetU16HexString(G_DESIGN_SETTING.stVDSetting.VifTop);
                    break;
                case 10: //
                    return MApp_ZUI_API_GetU16HexString(G_DESIGN_SETTING.stVDSetting.Vif_VGA_MAXIMUM);
                    break;
        ...
        //        return MApp_ZUI_API_GetU16HexString(G_DESIGN_SETTING.stVDSetting.Vif_AGC_VGA_BASE);
                ...
                case 13: //
                    ...
                    /*
                    return MApp_ZUI_API_GetU16HexString(G_DESIGN_SETTING.stVDSetting.China_DESCRAMBLER_BOX);
                    */
                    break;
        #endif
        }
        ...
        case EN_DESIGN_PAGE_VIF2:
            ...
            switch(u8Item)
            {
                ...
                case 1: //
                    ...
                    break;
                case 2: //
                    return MApp_ZUI_API_GetU16HexString(G_DESIGN_SETTING.stVDSetting.Vif_CR_KP1);
                    break;
                case 3: //
                    return MApp_ZUI_API_GetU16HexString(G_DESIGN_SETTING.stVDSetting.Vif_CR_KI1);
                    break;
                case 4: //
                    return MApp_ZUI_API_GetU16HexString(G_DESIGN_SETTING.stVDSetting.Vif_CR_KP2);
                    break;
                case 5: //
                    return MApp_ZUI_API_GetU16HexString(G_DESIGN_SETTING.stVDSetting.Vif_CR_KI2);
                    break;
                case 6: //
                    return MApp_ZUI_API_GetU16HexString(G_DESIGN_SETTING.stVDSetting.Vif_CR_LOCK_THR);
                    break;
                case 7: //
                    return MApp_ZUI_API_GetU16HexString(G_DESIGN_SETTING.stVDSetting.Vif_CR_THR);
                    break;
                case 8: //
                    return MApp_ZUI_API_GetU16HexString(G_DESIGN_SETTING.stVDSetting.Vif_CR_KP_KI_ADJUST);
                    break;
                case 9: //
                    return MApp_ZUI_API_GetU16HexString(G_DESIGN_SETTING.stVDSetting.Vif_OVER_MODULATION);
                    break;
                case 10: //
                ...
                case 8: //
                    ...
                    break;
                case 9: //
                    return MApp_ZUI_API_GetU16HexString(G_DESIGN_SETTING.stVDSetting.Vif_DELAY_REDUCE);
                    break;
                case 10: //
                    return MApp_ZUI_API_GetU16HexString(G_DESIGN_SETTING.stVDSetting.Vif_OVER_MODULATION);
                    break;
        ...
        case EN_DESIGN_PAGE_VIF3:
            ...
            switch(u8Item)
            {
                ...
                case 4: //
                    ...
                    break;
               // case 4: //
        //        return MApp_ZUI_API_GetU16HexString(G_DESIGN_SETTING.stVDSetting.u8AFEC_258D);
              //          break;
                case 5: //
                    return MApp_ZUI_API_GetU16HexString(G_DESIGN_SETTING.stVDSetting.Vif_CLAMPGAIN_CLAMP_OV_NEGATIVE);
                    break;
                case 6: //
                    if(G_DESIGN_SETTING.stVDSetting.AUDIO_HIDEV==1)
                    {
    ...
    switch(act)
    {
        ...
        case EN_EXE_DESIGN_MENU_NEXT_PAGE:
            ...
            if(_eDesignMenuPage == EN_DESIGN_PAGE_QMAP_PAGE)
            {
                ...
                MApp_ZUI_API_GetFocus() == HWND_DESIGN_MENU_ITEM11)
            {
                printf("\r\n Begin CI+ Upgrade! \n");

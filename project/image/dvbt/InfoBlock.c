...
//    BinItem(BIN_ID_M4VD_TABLE_263),
...
#if VECTOR_FONT_ENABLE	//MingYuan Font
   ...
   // BinItem(BIN_ID_FONT_ARABIC_26),//ID:0x0112
    ...
    BinItem(BIN_ID_CODE_SECU_R2_64MB),
#else
...
//#ifdef sTriviewOSDStyle //Close CC bin
...
//#else
 ...
 #endif
#endif //KOREAN_CC_ENABLE
#elif (ATSC_CC == ATV_CC)
    BinItem(BIN_ID_FONT_CS0),
#endif // #if (ATSC_CC == ATV_CC)
//#endif //sTriviewOSDStyle
    ...
    BinItem(BIN_ID_CODE_VDEC_FW_VPU),
        ...
        #if(!((CHIP_FAMILY_TYPE == CHIP_FAMILY_EDEN) || (CHIP_FAMILY_TYPE==CHIP_FAMILY_WHISKY)))//// Don't pack BIN_ID_CODE_AEON_H264  // same as BIN_ID_MM_HVD

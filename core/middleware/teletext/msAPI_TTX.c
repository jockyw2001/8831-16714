                                     ...
                                     MS_U32 param2)
{
  switch(command)
  {
    ...
    case TTX_SUBTITLE_TTX_ON:
      TT_EngineObj.Commands.SubtitleOn(param1,
                                       param2);
      break;
    ...
    case TTX_STATUS_DISPLAY:
      if(boolParam == TRUE)
        TT_EngineObj.Commands.StatusOn(param1,
                                       param2);
      else
...
{
  TT_EngineObj.Commands.SetPage(magNum,
                                pageNum);
}

void msAPI_TTX_SetDTVIndexPage(TT_U32 magNum, TT_U32 pageNum)
{
  TT_EngineObj.Commands.SetDTVIndexPage(magNum,
                                        pageNum);
}

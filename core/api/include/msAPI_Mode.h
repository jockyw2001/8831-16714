...
#define MAX_USER_RGB            DEFAULT_USER_RGB
#define MIN_USER_RGB            (DEFAULT_USER_RGB - 100)
#else
#define DEFAULT_USER_RGB        128
#define MAX_USER_RGB            (DEFAULT_USER_RGB + 50)
#define MIN_USER_RGB            (DEFAULT_USER_RGB - 50)
#endif
/*#else
#define DEFAULT_USER_RGB        128

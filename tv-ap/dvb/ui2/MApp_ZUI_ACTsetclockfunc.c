        ...
        case HWND_MENU_COMMON_ADJ_ITEM5_OPTION://HWND_MENU_TIME_ONTIME_CHANNEL_OPTION:
        {
            ...
            switch (stGenSetting.g_Time.cOnTimerSourceFlag)
            {
                ...
                case EN_Time_OnTimer_Source_ISDBT:
                    ...
                    #else
                        __MApp_UlongToString(u16Number, ChannelPtr+u16Len, MApp_GetNoOfDigit(u16Number));
                    #endif
                     }
                     return ChannelPtr;
                     break;
            ...
            #if (!ENABLE_ATSC)
                case EN_Time_OnTimer_Source_ATV:
                	__MApp_UlongToString((stGenSetting.g_Time.cOnTimerChannel/*for OSD show 1~x*/), ChannelPtr+u16Len, 2);
                    return ChannelPtr;
            #endif
                    break;
                default:

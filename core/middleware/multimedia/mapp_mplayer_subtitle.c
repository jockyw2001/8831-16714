            ...
            switch(enSMIParse)
            {
                ...
                case E_PARSE_SUB_LINE2:
                    ...
                    {//only save at firt subtitle
                        ...
                        if(u16NeedFilterLength==0)
                        {
                            pu8TempCache = (U8 *)msAPI_Memory_Allocate(sizeof(U8) * 2,BUF_ID_FILEBROWER);
                        }
                        else
                        {
                            pu8TempCache = (U8 *)msAPI_Memory_Allocate(u16NeedFilterLength*sizeof(U8),BUF_ID_FILEBROWER);
                        }
            ...
            switch(enSMIParse)
            {
                ...
                case E_PARSE_SUB_LINE2:
                    ...
                    {//only save at firt subtitle
                        ...
                        if(u16NeedFilterLength==0)
                        {
                            pu8TempCache = (U8 *)msAPI_Memory_Allocate(1*sizeof(U8),BUF_ID_FILEBROWER);
                        }
                        else
                        {
                            pu8TempCache = (U8 *)msAPI_Memory_Allocate(u16NeedFilterLength*sizeof(U8),BUF_ID_FILEBROWER);

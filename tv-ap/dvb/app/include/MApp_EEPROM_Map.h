...
#elif (RM_EEPROM_TYPE == RM_TYPE_24C128)			//Ray SEE 2017.03.15: 24C128 EEPROM max size is 0x4000 bytes
#define MAX_LIMITED_EEPROM_SIZE     0x4000
#endif
    ...
    #elif (RM_EEPROM_TYPE == RM_TYPE_24C128)
        #define RM_MAX_ADDRESS (0x3fff)				//Ray SEE 2017.03.15: 24C128 EEPROM last address is 0x3FFFF
    #endif
...
#define RM_GEN_BACKLIGHT_ADDRESS    (RM_GENSET_START_ADR + (U32)&(((MS_GENSETTING*)0)->u8Backlight))
#endif

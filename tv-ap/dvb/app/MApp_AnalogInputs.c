            ...
            { // no sync
                if(!su8NoSignalDisplayCNT[eWindow])
                {
                    ...
                    else if (MApp_ZUI_GetActiveOSD() == E_OSD_EMPTY)
                    {
                        ...
                        //printf("MingYuan No Signal Msg issue\n");
                    }
                /*
...
void MApp_AnalogInputs_ProcessUserInput(void)
{
    ...
    switch ( u8KeyCode )
    {
        ...
        case KEY_USB:
            //printf("MingYuan USB Key MApp_AnalogInputs_ProcessUserInput \n");
            u8KeyCode = KEY_NULL;
          	break;
        #endif
        case KEY_MUTE:
...
//            if((!MApp_AnalogInputs_FunctionNotAvailableCheck())&&MApp_AnalogInputs_IsHotkeyWinAvailable())
            {
            		//printf("MingYuan KEY_PICTURE Key MApp_AnalogInputs_ProcessUserInput \n");

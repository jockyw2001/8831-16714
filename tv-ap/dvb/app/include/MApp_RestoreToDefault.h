...
#define DEFAULT_VOLUME_SETTING                  50//20	//MingYuan Volume Default
...
INTERFACE void MApp_DataBase_RestoreDefaultVideoForUserReset(E_DATA_INPUT_SOURCE enDataInputSource);
INTERFACE void MApp_DataBase_RestoreDefaultWhiteBalanceForUserReset(E_DATA_INPUT_SOURCE enDataInputSource);
#endif
INTERFACE void MApp_DataBase_RestoreDefaultBrightness(void);  	//Ray BRI 2017.05.08
INTERFACE void MApp_DataBase_RestoreDefaultContrast(void);	 //Ray CRS 2017.05.09
INTERFACE void MApp_DataBase_RestoreDefaultSaturation(void);	//Ray SAT 2017.05.09
...
INTERFACE void MApp_DataBase_RestoreDefault_FactoryVideoWallSetting(void);
#endif
#if(SENSOR_CHIP!=NOT_SUPPORT_LIGHT_SENSOR)
INTERFACE void MApp_DataBase_RestoreDefault_FactoryLightSensorSetting(void);
#endif
#ifdef sAddFactoryOSDPara
INTERFACE void MApp_DataBase_RestoreDefault_FactoryOtherSetting(void);
#endif

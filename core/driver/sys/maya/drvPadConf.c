...
//Ray EDD 2017.03.28
void GPIO_DDCDA_ENABLE(U8 enable);
void GPIO_DDCDB_ENABLE(U8 enable);
void GPIO_DDCDC_ENABLE(U8 enable);
void GPIO_DDCDD_ENABLE(U8 enable);
...
//---------------------------------------------------------------------
    ...
    //reg_chiptop_i2s_out_mclk_int = 0b
    _RVM1(0x1e1f, 0, BIT4 ),   //reg[101e1f]#4 = 0b
    //reg_chiptop_spdif_mux_int = 0b
    //(reg_chiptop_dummy_3[15])
    _RVM1(0x1e1f, 0, BIT7 ),   //reg[101e1f]#7 = 0b
    //reg_allpad_in = 0b
    _RVM1(0x1ea1, 0, BIT7 ),   //reg[101ea1]#7 = 0b
    #endif
    ...
    //reg_3d_lr_config[2:0] = 000b
    _RVM1(0x1e10, 0, BIT2~BIT0 ),   //reg[101e10]#2~#0 = 000b
    #endif
    ...
    _RVM1(0x12cf6, PAD_LINEIN_L0_OUT, BIT0 ),
    _RVM1(0x12cf6, PAD_LINEIN_L0_OEN, BIT2 ),
    _RVM1(0x12cf6, BIT1 , BIT1 ),   //reg[112cf6]#1 = 1b
    #endif
    ...
    _RVM1(0x12cf6, PAD_LINEIN_R0_OUT, BIT4 ),
    _RVM1(0x12cf6, PAD_LINEIN_R0_OEN, BIT6 ),
    _RVM1(0x12cf6, BIT5 , BIT5 ),   //reg[112cf6]#5 = 1b
    #endif
    ...
    _RVM1(0x12cf7, PAD_LINEIN_L1_OUT, BIT0 ),
    _RVM1(0x12cf7, PAD_LINEIN_L1_OEN, BIT2 ),
    _RVM1(0x12cf7, BIT1 , BIT1 ),   //reg[112cf7]#1 = 1b
    #endif
    ...
    _RVM1(0x12cf7, PAD_LINEIN_R1_OUT, BIT4 ),
    _RVM1(0x12cf7, PAD_LINEIN_R1_OEN, BIT6 ),
    _RVM1(0x12cf7, BIT5 , BIT5 ),   //reg[112cf7]#5 = 1b
    #endif
    ...
    _RVM1(0x12cf8, PAD_LINEIN_L2_OUT, BIT0),
    _RVM1(0x12cf8, PAD_LINEIN_L2_OEN, BIT2),
    _RVM1(0x12cf8, BIT1 , BIT1 ),   //reg[0x112cf8]#1 = 1b
    #endif
    ...
    _RVM1(0x12cf8, PAD_LINEIN_R2_OUT, BIT4),
    _RVM1(0x12cf8, PAD_LINEIN_R2_OEN, BIT6),
    _RVM1(0x12cf8, BIT5 , BIT5 ),   //reg[0x112cf8]#5 = 1b
    #endif
    ...
    _RVM1(0x12cf9, PAD_LINEIN_L3_OUT, BIT0),
    _RVM1(0x12cf9, PAD_LINEIN_L3_OEN, BIT2),
    _RVM1(0x12cf9, BIT1 , BIT1 ),   //reg[0x12cf9]#1 = 1b
    #endif
    ...
    _RVM1(0x12cf9, PAD_LINEIN_R3_OUT, BIT4),
    _RVM1(0x12cf9, PAD_LINEIN_R3_OEN, BIT6),
    _RVM1(0x12cf9, BIT5 , BIT5 ),   //reg[0x12cf9]#5 = 1b
    #endif
    ...
    _RVM1(0x12cfa, PAD_LINEIN_L4_OUT, BIT0),
    _RVM1(0x12cfa, PAD_LINEIN_L4_OEN, BIT2),
    _RVM1(0x12cfa, BIT1 , BIT1 ),   //reg[0x12cfa]#1 = 1b
    #endif
    ...
    _RVM1(0x12cfa, PAD_LINEIN_R4_OUT, BIT4),
    _RVM1(0x12cfa, PAD_LINEIN_R4_OEN, BIT6),
    _RVM1(0x12cfa, BIT5 , BIT5 ),   //reg[0x12cfa]#5 = 1b
    #endif
    ...
    _RVM1(0x12cfb, PAD_LINEIN_L5_OUT, BIT0),
    _RVM1(0x12cfb, PAD_LINEIN_L5_OEN, BIT2),
    _RVM1(0x12cfb, BIT1 , BIT1 ),   //reg[0x12cfb]#1 = 1b
    #endif
    ...
    _RVM1(0x12cfb, PAD_LINEIN_R5_OUT, BIT4),
    _RVM1(0x12cfb, PAD_LINEIN_R5_OEN, BIT6),
    _RVM1(0x12cfb, BIT5 , BIT5 ),   //reg[0x12cfb]#5 = 1b
    #endif
    ...
    _RVM1(0x703a1, PORT_A_PAD_RX0P_OUT, BIT0 ),
    _RVM1(0x703a0, PORT_A_PAD_RX0P_OEN, BIT0),
    _RVM1(0x703a2, PORT_A_PAD_RX0P_IEN, BIT4),
    _MEMMAP_PM_,
    _RVM1(0x2e63, BIT0, BIT0),   //reg[002e63]#0=1
    _RVM1(0x2e63, BIT1, BIT1),   //reg[002e63]#1=1
    _RVM1(0x2e63, BIT2, BIT2),   //reg[002e63]#2=1
    _RVM1(0x2e63, BIT3, BIT3),   //reg[002e63]#3=1
    _MEMMAP_nonPM_,
    _RVM1(0x7033f, 0, BIT3),   //reg[17033f]#3=0
    _RVM1(0x703a3, BIT4, BIT4),   //reg[1703a3]#4=1
    _RVM1(0x703a1, 0, BIT4),   //reg[1703a1]#4=0
    _RVM1(0x703a1, 0, BIT5),   //reg[1703a1]#5=0
    _RVM1(0x703a1, 0, BIT6),   //reg[1703a1]#6=0
    _RVM1(0x703a1, 0, BIT7),   //reg[1703a1]#7=0
    #endif
    ...
    _RVM1(0x703a1, PORT_A_PAD_RX1P_OUT, BIT1),
    _RVM1(0x703a0, PORT_A_PAD_RX1P_OEN, BIT1),
    _RVM1(0x703a2, PORT_A_PAD_RX1P_IEN, BIT5),
    _MEMMAP_PM_,
    _RVM1(0x2e63, BIT0, BIT0),   //reg[002e63]#0=1
    _RVM1(0x2e63, BIT1, BIT1),   //reg[002e63]#1=1
    _RVM1(0x2e63, BIT2, BIT2),   //reg[002e63]#2=1
    ...
    _RVM1(0x703a1, PORT_A_PAD_RX2P_OUT, BIT2),
    _RVM1(0x703a0, PORT_A_PAD_RX2P_OEN, BIT2),
    _RVM1(0x703a2, PORT_A_PAD_RX2P_IEN, BIT6),
    _MEMMAP_PM_,
    _RVM1(0x2e63, BIT0, BIT0),   //reg[002e63]#0=1
    _RVM1(0x2e63, BIT1, BIT1),   //reg[002e63]#1=1
    _RVM1(0x2e63, BIT2, BIT2),   //reg[002e63]#2=1
    ...
    _RVM1(0x703a1, PORT_A_PAD_RXCP_OUT, BIT3),
    _RVM1(0x703a0, PORT_A_PAD_RXCP_OEN, BIT3),
    _RVM1(0x703a2, PORT_A_PAD_RXCP_IEN, BIT7),
    _MEMMAP_PM_,
    _RVM1(0x2e63, BIT0, BIT0),   //reg[002e63]#0=1
    _RVM1(0x2e63, BIT1, BIT1),   //reg[002e63]#1=1
    _RVM1(0x2e63, BIT2, BIT2),   //reg[002e63]#2=1
    ...
    _RVM1(0x703a2, PORT_A_PAD_RX0N_OUT, BIT0 ),
    _RVM1(0x703a0, PORT_A_PAD_RX0N_OEN, BIT4),
    _RVM1(0x703a3, PORT_A_PAD_RX0N_IEN, BIT0),
    _MEMMAP_PM_,
    _RVM1(0x2e63, BIT0, BIT0),   //reg[002e63]#0=1
    _RVM1(0x2e63, BIT1, BIT1),   //reg[002e63]#1=1
    _RVM1(0x2e63, BIT2, BIT2),   //reg[002e63]#2=1
    ...
    _RVM1(0x703a2, PORT_A_PAD_RX1N_OUT, BIT1),
    _RVM1(0x703a0, PORT_A_PAD_RX1N_OEN, BIT5),
    _RVM1(0x703a3, PORT_A_PAD_RX1N_IEN, BIT1),
    _MEMMAP_PM_,
    _RVM1(0x2e63, BIT0, BIT0),   //reg[002e63]#0=1
    _RVM1(0x2e63, BIT1, BIT1),   //reg[002e63]#1=1
    _RVM1(0x2e63, BIT2, BIT2),   //reg[002e63]#2=1
    ...
    _RVM1(0x703a2, PORT_A_PAD_RX2N_OUT, BIT2),
    _RVM1(0x703a0, PORT_A_PAD_RX2N_OEN, BIT6),
    _RVM1(0x703a3, PORT_A_PAD_RX2N_IEN, BIT2),
    _MEMMAP_PM_,
    _RVM1(0x2e63, BIT0, BIT0),   //reg[002e63]#0=1
    _RVM1(0x2e63, BIT1, BIT1),   //reg[002e63]#1=1
    _RVM1(0x2e63, BIT2, BIT2),   //reg[002e63]#2=1
    ...
    _RVM1(0x703a2, PORT_A_PAD_RXCN_OUT, BIT3),
    _RVM1(0x703a0, PORT_A_PAD_RXCN_OEN, BIT7),
    _RVM1(0x703a3, PORT_A_PAD_RXCN_IEN, BIT3),
    _MEMMAP_PM_,
    _RVM1(0x2e63, BIT0, BIT0),   //reg[002e63]#0=1
    _RVM1(0x2e63, BIT1, BIT1),   //reg[002e63]#1=1
    _RVM1(0x2e63, BIT2, BIT2),   //reg[002e63]#2=1
    ...
    _RVM1(0x703a5, PORT_B_PAD_RX0P_OUT, BIT0 ),
    _RVM1(0x703a4, PORT_B_PAD_RX0P_OEN, BIT0),
    _RVM1(0x703a6, PORT_B_PAD_RX0P_IEN, BIT4),
    _MEMMAP_PM_,
    _RVM1(0x2e63, BIT4, BIT4),   //reg[002e63]#4=1
    _RVM1(0x2e63, BIT5, BIT5),   //reg[002e63]#5=1
    _RVM1(0x2e63, BIT6, BIT6),   //reg[002e63]#6=1
    _RVM1(0x2e63, BIT7, BIT7),   //reg[002e63]#7=1
    _MEMMAP_nonPM_,
    _RVM1(0x7033f, 0, BIT4),   //reg[17033f]#4=0
    _RVM1(0x703a7, BIT4, BIT4),   //reg[1703a7]#4=1
    _RVM1(0x703a5, 0, BIT4),   //reg[1703a5]#4=0
    _RVM1(0x703a5, 0, BIT5),   //reg[1703a5]#5=0
    _RVM1(0x703a5, 0, BIT6),   //reg[1703a5]#6=0
    _RVM1(0x703a5, 0, BIT7),   //reg[1703a5]#7=0
    #endif
    ...
    _RVM1(0x703a5, PORT_B_PAD_RX1P_OUT, BIT1),
    _RVM1(0x703a4, PORT_B_PAD_RX1P_OEN, BIT1),
    _RVM1(0x703a6, PORT_B_PAD_RX1P_IEN, BIT5),
    _MEMMAP_PM_,
    _RVM1(0x2e63, BIT4, BIT4),   //reg[002e63]#4=1
    _RVM1(0x2e63, BIT5, BIT5),   //reg[002e63]#5=1
    _RVM1(0x2e63, BIT6, BIT6),   //reg[002e63]#6=1
    ...
    _RVM1(0x703a5, PORT_B_PAD_RX2P_OUT, BIT2),
    _RVM1(0x703a4, PORT_B_PAD_RX2P_OEN, BIT2),
    _RVM1(0x703a6, PORT_B_PAD_RX2P_IEN, BIT6),
    _MEMMAP_PM_,
    _RVM1(0x2e63, BIT4, BIT4),   //reg[002e63]#4=1
    _RVM1(0x2e63, BIT5, BIT5),   //reg[002e63]#5=1
    _RVM1(0x2e63, BIT6, BIT6),   //reg[002e63]#6=1
    ...
    _RVM1(0x703a5, PORT_B_PAD_RXCP_OUT, BIT3),
    _RVM1(0x703a4, PORT_B_PAD_RXCP_OEN, BIT3),
    _RVM1(0x703a6, PORT_B_PAD_RXCP_IEN, BIT7),
    _MEMMAP_PM_,
    _RVM1(0x2e63, BIT4, BIT4),   //reg[002e63]#4=1
    _RVM1(0x2e63, BIT5, BIT5),   //reg[002e63]#5=1
    _RVM1(0x2e63, BIT6, BIT6),   //reg[002e63]#6=1
    ...
    _RVM1(0x703a6, PORT_B_PAD_RX0N_OUT, BIT0 ),
    _RVM1(0x703a4, PORT_B_PAD_RX0N_OEN, BIT4),
    _RVM1(0x703a7, PORT_B_PAD_RX0N_IEN, BIT0),
    _MEMMAP_PM_,
    _RVM1(0x2e63, BIT4, BIT4),   //reg[002e63]#4=1
    _RVM1(0x2e63, BIT5, BIT5),   //reg[002e63]#5=1
    _RVM1(0x2e63, BIT6, BIT6),   //reg[002e63]#6=1
    ...
    _RVM1(0x703a6, PORT_B_PAD_RX1N_OUT, BIT1),
    _RVM1(0x703a4, PORT_B_PAD_RX1N_OEN, BIT5),
    _RVM1(0x703a7, PORT_B_PAD_RX1N_IEN, BIT1),
    _MEMMAP_PM_,
    _RVM1(0x2e63, BIT4, BIT4),   //reg[002e63]#4=1
    _RVM1(0x2e63, BIT5, BIT5),   //reg[002e63]#5=1
    _RVM1(0x2e63, BIT6, BIT6),   //reg[002e63]#6=1
    ...
    _RVM1(0x703a6, PORT_B_PAD_RX2N_OUT, BIT2),
    _RVM1(0x703a4, PORT_B_PAD_RX2N_OEN, BIT6),
    _RVM1(0x703a7, PORT_B_PAD_RX2N_IEN, BIT2),
    _MEMMAP_PM_,
    _RVM1(0x2e63, BIT4, BIT4),   //reg[002e63]#4=1
    _RVM1(0x2e63, BIT5, BIT5),   //reg[002e63]#5=1
    _RVM1(0x2e63, BIT6, BIT6),   //reg[002e63]#6=1
    ...
    _RVM1(0x703a6, PORT_B_PAD_RXCN_OUT, BIT3),
    _RVM1(0x703a4, PORT_B_PAD_RXCN_OEN, BIT7),
    _RVM1(0x703a7, PORT_B_PAD_RXCN_IEN, BIT3),
    _MEMMAP_PM_,
    _RVM1(0x2e63, BIT4, BIT4),   //reg[002e63]#4=1
    _RVM1(0x2e63, BIT5, BIT5),   //reg[002e63]#5=1
    _RVM1(0x2e63, BIT6, BIT6),   //reg[002e63]#6=1
    ...
    _RVM1(0x703a9, PORT_C_PAD_RX0P_OUT, BIT0),
    _RVM1(0x703a8, PORT_C_PAD_RX0P_OEN, BIT0),
    _RVM1(0x703aa, PORT_C_PAD_RX0P_IEN, BIT4),
    _MEMMAP_PM_,
    _RVM1(0x2e64, BIT0, BIT0),   //reg[002e64]#0=1
    _RVM1(0x2e64, BIT1, BIT1),   //reg[002e64]#1=1
    _RVM1(0x2e64, BIT2, BIT2),   //reg[002e64]#2=1
    _RVM1(0x2e64, BIT3, BIT3),   //reg[002e64]#3=1
    _MEMMAP_nonPM_,
    _RVM1(0x7033f, 0, BIT5),   //reg[17033f]#5=0
    _RVM1(0x703ab, BIT4, BIT4),   //reg[1703ab]#4=1
    _RVM1(0x703a9, 0, BIT4),   //reg[1703a9]#4=0
    _RVM1(0x703a9, 0, BIT5),   //reg[1703a9]#5=0
    _RVM1(0x703a9, 0, BIT6),   //reg[1703a9]#6=0
    _RVM1(0x703a9, 0, BIT7),   //reg[1703a9]#7=0
    #endif
    ...
    _RVM1(0x703a9, PORT_C_PAD_RX1P_OUT, BIT1),
    _RVM1(0x703a8, PORT_C_PAD_RX1P_OEN, BIT1),
    _RVM1(0x703aa, PORT_C_PAD_RX1P_IEN, BIT1),
    _MEMMAP_PM_,
    _RVM1(0x2e64, BIT0, BIT0),   //reg[002e64]#0=1
    _RVM1(0x2e64, BIT1, BIT1),   //reg[002e64]#1=1
    _RVM1(0x2e64, BIT2, BIT2),   //reg[002e64]#2=1
    ...
    _RVM1(0x703a9, PORT_C_PAD_RX2P_OUT, BIT2),
    _RVM1(0x703a8, PORT_C_PAD_RX2P_OEN, BIT2),
    _RVM1(0x703aa, PORT_C_PAD_RX2P_IEN, BIT6),
    _MEMMAP_PM_,
    _RVM1(0x2e64, BIT0, BIT0),   //reg[002e64]#0=1
    _RVM1(0x2e64, BIT1, BIT1),   //reg[002e64]#1=1
    _RVM1(0x2e64, BIT2, BIT2),   //reg[002e64]#2=1
    ...
    _RVM1(0x703a9, PORT_C_PAD_RXCP_OUT, BIT3),
    _RVM1(0x703a8, PORT_C_PAD_RXCP_OEN, BIT3),
    _RVM1(0x703aa, PORT_C_PAD_RXCP_IEN, BIT7),
    ...
    _RVM1(0x703aa, PORT_C_PAD_RX0N_OUT, BIT0),
    _RVM1(0x703a8, PORT_C_PAD_RX0N_OEN, BIT4),
    _RVM1(0x703ab, PORT_C_PAD_RX0N_IEN, BIT0),
    //power down MHL3_ATOP
    _RVM1(0x7033f, 0, BIT5),   //reg[17033f]#5=0
    _RVM1(0x703ab, BIT4, BIT4),   //reg[1703ab]#4=1
    _RVM1(0x703a9, 0, BIT4),   //reg[1703a9]#4=0
    ...
    _RVM1(0x703aa, PORT_C_PAD_RX1N_OUT, BIT1),
    _RVM1(0x703a8, PORT_C_PAD_RX1N_OEN, BIT5),
    _RVM1(0x703ab, PORT_C_PAD_RX1N_IEN, BIT1),
    //power down MHL3_ATOP
    _RVM1(0x7033f, 0, BIT5),   //reg[17033f]#5=0
    _RVM1(0x703ab, BIT4, BIT4),   //reg[1703ab]#4=1
    _RVM1(0x703a9, 0, BIT4),   //reg[1703a9]#4=0
    ...
    _RVM1(0x703aa, PORT_C_PAD_RX2N_OUT, BIT2),
    _RVM1(0x703a8, PORT_C_PAD_RX2N_OEN, BIT6),
    _RVM1(0x703ab, PORT_C_PAD_RX2N_IEN, BIT2),
    _MEMMAP_PM_,
    _RVM1(0x2e64, BIT0, BIT0),   //reg[002e64]#0=1
    _RVM1(0x2e64, BIT1, BIT1),   //reg[002e64]#1=1
    _RVM1(0x2e64, BIT2, BIT2),   //reg[002e64]#2=1
    ...
    _RVM1(0x703ad, PORT_D_PAD_RX0P_OUT, BIT0 ),
    _RVM1(0x703ac, PORT_D_PAD_RX0P_OEN, BIT0),
    _RVM1(0x703ae, PORT_D_PAD_RX0P_OEN, BIT4),
    _MEMMAP_PM_,
    _RVM1(0x2e64, BIT4, BIT4),   //reg[002e64]#4=1
    _RVM1(0x2e64, BIT5, BIT5),   //reg[002e64]#5=1
    _RVM1(0x2e64, BIT6, BIT6),   //reg[002e64]#6=1
    _RVM1(0x2e64, BIT7, BIT7),   //reg[002e64]#7=1
    _MEMMAP_nonPM_,
    _RVM1(0x7033f, 0, BIT6),   //reg[17033f]#6=0
    _RVM1(0x703af, BIT4, BIT4),   //reg[1703af]#4=1
    _RVM1(0x703ad, 0, BIT4),   //reg[1703ad]#4=0
    _RVM1(0x703ad, 0, BIT5),   //reg[1703ad]#5=0
    _RVM1(0x703ad, 0, BIT6),   //reg[1703ad]#6=0
    _RVM1(0x703ad, 0, BIT7),   //reg[1703ad]#7=0
    #endif
    ...
    _RVM1(0x703ad, PORT_D_PAD_RX1P_OUT, BIT1),
    _RVM1(0x703ac, PORT_D_PAD_RX1P_OEN, BIT1),
    _RVM1(0x703ae, PORT_D_PAD_RX1P_IEN, BIT5),
    _MEMMAP_PM_,
    _RVM1(0x2e64, BIT4, BIT4),   //reg[002e64]#4=1
    _RVM1(0x2e64, BIT5, BIT5),   //reg[002e64]#5=1
    _RVM1(0x2e64, BIT6, BIT6),   //reg[002e64]#6=1
    ...
    _RVM1(0x703ad, PORT_D_PAD_RX2P_OUT, BIT2),
    _RVM1(0x703ac, PORT_D_PAD_RX2P_OEN, BIT2),
    _RVM1(0x703ae, PORT_D_PAD_RX2P_IEN, BIT6),
    _MEMMAP_PM_,
    _RVM1(0x2e64, BIT4, BIT4),   //reg[002e64]#4=1
    _RVM1(0x2e64, BIT5, BIT5),   //reg[002e64]#5=1
    _RVM1(0x2e64, BIT6, BIT6),   //reg[002e64]#6=1
    ...
    _RVM1(0x703ad, PORT_D_PAD_RXCP_OUT, BIT3),
    _RVM1(0x703ac, PORT_D_PAD_RXCP_OEN, BIT3),
    _RVM1(0x703ae, PORT_D_PAD_RXCP_IEN, BIT7),
    _MEMMAP_PM_,
    _RVM1(0x2e64, BIT4, BIT4),   //reg[002e64]#4=1
    _RVM1(0x2e64, BIT5, BIT5),   //reg[002e64]#5=1
    _RVM1(0x2e64, BIT6, BIT6),   //reg[002e64]#6=1
    ...
    _RVM1(0x703ae, PORT_D_PAD_RX0N_OUT, BIT0),
    _RVM1(0x703ac, PORT_D_PAD_RX0N_OEN, BIT4),
    _RVM1(0x703af, PORT_D_PAD_RX0N_IEN, BIT0),
    _MEMMAP_PM_,
    _RVM1(0x2e64, BIT4, BIT4),   //reg[002e64]#4=1
    _RVM1(0x2e64, BIT5, BIT5),   //reg[002e64]#5=1
    _RVM1(0x2e64, BIT6, BIT6),   //reg[002e64]#6=1
    ...
    _RVM1(0x703ae, PORT_D_PAD_RX1N_OUT, BIT1),
    _RVM1(0x703ac, PORT_D_PAD_RX1N_OEN, BIT5),
    _RVM1(0x703af, PORT_D_PAD_RX1N_IEN, BIT1),
    _MEMMAP_PM_,
    _RVM1(0x2e64, BIT4, BIT4),   //reg[002e64]#4=1
    _RVM1(0x2e64, BIT5, BIT5),   //reg[002e64]#5=1
    _RVM1(0x2e64, BIT6, BIT6),   //reg[002e64]#6=1
    ...
    _RVM1(0x703ae, PORT_D_PAD_RX2N_OUT, BIT2),
    _RVM1(0x703ac, PORT_D_PAD_RX2N_OEN, BIT6),
    _RVM1(0x703af, PORT_D_PAD_RX2N_IEN, BIT3),
    _MEMMAP_PM_,
    _RVM1(0x2e64, BIT4, BIT4),   //reg[002e64]#4=1
    _RVM1(0x2e64, BIT5, BIT5),   //reg[002e64]#5=1
    _RVM1(0x2e64, BIT6, BIT6),   //reg[002e64]#6=1
    ...
    _RVM1(0x703ae, PORT_D_PAD_RXCN_OUT, BIT3),
    _RVM1(0x703ac, PORT_D_PAD_RXCN_OEN, BIT7),
    _RVM1(0x703af, PORT_D_PAD_RXCN_IEN, BIT4),
    _MEMMAP_PM_,
    _RVM1(0x2e64, BIT4, BIT4),   //reg[002e64]#4=1
    _RVM1(0x2e64, BIT5, BIT5),   //reg[002e64]#5=1
    _RVM1(0x2e64, BIT6, BIT6),   //reg[002e64]#6=1
...
#if (PIN_FLASH_WP0)
  #if ((MS_BOARD_TYPE_SEL == BD_MST222B_D01A_S) || (MS_BOARD_TYPE_SEL == BD_MST222A_D01A_S))//PAD_PWM0
    _RVM1(0x1e40,    0,  BIT4), //reg[101e40]#4 = 0b
...
//Ray EDD 2017.03.28: Routine to enable/disable GPIO for DDCDA pin
void GPIO_DDCDA_ENABLE(U8 enable)
{
    int bitEnable=0;
    if(enable==1){
    ...
    u32MapBase = _MapBase_nonPM_MAYA;
    MDrv_PAD_WriteByteMask(0x1EF9, bitEnable, BIT1);
}

//Ray EDD 2017.03.28: Routine to enable/disable GPIO for DDCDB pin
void GPIO_DDCDB_ENABLE(U8 enable)
{
    int bitEnable=0;
    if(enable==1){
    ...
    MDrv_PAD_WriteByteMask(0x1EF9, bitEnable, BIT2);
}

//Ray EDD 2017.03.28: Routine to enable/disable GPIO for DDCDC pin
void GPIO_DDCDC_ENABLE(U8 enable)
{
    int bitEnable=0;
    if(enable==1){
    ...
    MDrv_PAD_WriteByteMask(0x1EF9, bitEnable, BIT3);
}


//Ray EDD 2017.03.28: Routine to enable/disable GPIO for DDCDD pin
void GPIO_DDCDD_ENABLE(U8 enable)
{
    int bitEnable=0;
    if(enable==1){
    ...
    MDrv_PAD_WriteByteMask(0x1EFB, bitEnable, BIT7);
}

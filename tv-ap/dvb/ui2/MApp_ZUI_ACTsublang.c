...
static void _MApp_SubtitleLanguage_MapFullLangName(U8 UI_Lang_IDX,U16* pu16TempID)
{
    //from SubtitleLangMapFull_Lang_Name()
#if 0
    *pu16TempID = ( strcmp(SubtitleMenu[UI_Lang_IDX].StringCodes, "bul") == 0 ) ? en_str_Bulgarian   :
                  ( strcmp(SubtitleMenu[UI_Lang_IDX].StringCodes, "cro") == 0 ) ? en_str_Hrvatski    :
                  ( strcmp(SubtitleMenu[UI_Lang_IDX].StringCodes, "cze") == 0 ) ? en_str_Czech       :
                  ( strcmp(SubtitleMenu[UI_Lang_IDX].StringCodes, "dan") == 0 ) ? en_str_Dansk      :
                  ( strcmp(SubtitleMenu[UI_Lang_IDX].StringCodes, "dut") == 0 ) ? en_str_Nederlands       :
                  ( strcmp(SubtitleMenu[UI_Lang_IDX].StringCodes, "eng") == 0 ) ? en_str_English     :
                  ( strcmp(SubtitleMenu[UI_Lang_IDX].StringCodes, "fin") == 0 ) ? en_str_Suomi     :
                  ( strcmp(SubtitleMenu[UI_Lang_IDX].StringCodes, "fra") == 0 ) ? en_str_France      :
                  ( strcmp(SubtitleMenu[UI_Lang_IDX].StringCodes, "gae") == 0 ) ? en_str_Gaelic      :
                  ( strcmp(SubtitleMenu[UI_Lang_IDX].StringCodes, "ger") == 0 ) ? en_str_Deutsch      :
                  ( strcmp(SubtitleMenu[UI_Lang_IDX].StringCodes, "gre") == 0 ) ? en_str_Greek       :
                  ( strcmp(SubtitleMenu[UI_Lang_IDX].StringCodes, "hun") == 0 ) ? en_str_Magyar   :
                  ( strcmp(SubtitleMenu[UI_Lang_IDX].StringCodes, "ita") == 0 ) ? en_str_Italiano     :
                  ( strcmp(SubtitleMenu[UI_Lang_IDX].StringCodes, "nor") == 0 ) ? en_str_Norsk   :
                  ( strcmp(SubtitleMenu[UI_Lang_IDX].StringCodes, "pol") == 0 ) ? en_str_Polski      :
                  ( strcmp(SubtitleMenu[UI_Lang_IDX].StringCodes, "por") == 0 ) ? en_str_Portuguese  :
                  ( strcmp(SubtitleMenu[UI_Lang_IDX].StringCodes, "rom") == 0 ) ? en_str_Romanian    :
                  ( strcmp(SubtitleMenu[UI_Lang_IDX].StringCodes, "rus") == 0 ) ? en_str_Russian1     :
                  ( strcmp(SubtitleMenu[UI_Lang_IDX].StringCodes, "gla") == 0 ) ? en_str_Gaelic     :
                  ( strcmp(SubtitleMenu[UI_Lang_IDX].StringCodes, "gle") == 0 ) ? en_str_Gaelic     :
//                  ( strcmp(SubtitleMenu[UI_Lang_IDX].StringCodes, "slo") == 0 ) ? en_str_Slovene     :
                  ( strcmp(SubtitleMenu[UI_Lang_IDX].StringCodes, "ser") == 0 ) ? en_str_Srpski     :
                  ( strcmp(SubtitleMenu[UI_Lang_IDX].StringCodes, "spa") == 0 ) ? en_str_Spanish     :
                  ( strcmp(SubtitleMenu[UI_Lang_IDX].StringCodes, "swe") == 0 ) ? en_str_Svenska     :
//                  ( strcmp(SubtitleMenu[UI_Lang_IDX].StringCodes, "chi") == 0 ) ? en_strZ2_SubtitleLangCHI        :
//                  ( strcmp(SubtitleMenu[UI_Lang_IDX].StringCodes, "chs") == 0 ) ? en_strZ2_SubtitleLangCHS        :
                  ( strcmp(SubtitleMenu[UI_Lang_IDX].StringCodes, "wel") == 0 ) ? en_str_Welsh       :  en_str_Undefined ;
	...
	case STRING_TO_U32('s','l','o'):
        ...
        case STRING_TO_U32('h','u','n'):
            *pu16TempID = en_str_Magyar;
            break;

        case STRING_TO_U32('i','t','a'):
            *pu16TempID = en_str_Italiano;
            break;

        case STRING_TO_U32('n','o','r'):
            *pu16TempID = en_str_Norsk;
            break;

        case STRING_TO_U32('p','o','l'):
            *pu16TempID = en_str_Polski;
            break;

        case STRING_TO_U32('p','o','r'):
            *pu16TempID = en_str_Portuguese;
            break;

        case STRING_TO_U32('r','o','m'):
            *pu16TempID = en_str_Romanian;
            break;

        case STRING_TO_U32('r','u','s'):
            *pu16TempID = en_str_Russian1;
            break;

        case STRING_TO_U32('s','l','v'):
            *pu16TempID = en_str_Slovene;
            break;

        case STRING_TO_U32('s','e','r'):
            *pu16TempID = en_str_Srpski;
            break;

        case STRING_TO_U32('s','p','a'):
            *pu16TempID = en_str_Spanish;
            break;

        case STRING_TO_U32('s','w','e'):
            *pu16TempID = en_str_Svenska;
            break;

		case STRING_TO_U32('C','H','I'):
        case STRING_TO_U32('c','h','i'):
            *pu16TempID = en_str_Chinese;
            break;

        case STRING_TO_U32('C','H','S'):
        case STRING_TO_U32('c','h','s'):
            *pu16TempID = en_str_SimpleChinese;
            break;

        case STRING_TO_U32('w','e','l'):
        case STRING_TO_U32('c','y','m'):
            *pu16TempID = en_str_Welsh;
            break;

	case STRING_TO_U32('q','a','a'):
            *pu16TempID = en_str_Qaa;
            break;

        case STRING_TO_U32('l','t','z'):
            *pu16TempID = en_str_Luxembourgish;
            break;

        case STRING_TO_U32('e','u','s'):
        case STRING_TO_U32('b','a','q'):
            *pu16TempID = en_str_Basque;
            break;

        case STRING_TO_U32('i','c','e'):
        case STRING_TO_U32('i','s','l'):
            *pu16TempID = en_str_Icelandic;
            break;

        case STRING_TO_U32('b','e','l'):
            *pu16TempID = en_str_Belarusian;
            break;

        case STRING_TO_U32('l','i','t'):
            *pu16TempID = en_str_Lithuanian;
            break;

        case STRING_TO_U32('u','k','r'):
            *pu16TempID = en_str_Ukranian;
            break;

        case STRING_TO_U32('l','a','v'):
            *pu16TempID = en_str_Latvian;
            break;

        case STRING_TO_U32('e','s','t'):
            *pu16TempID = en_str_Estonian;
            break;

       case STRING_TO_U32('h','e','b'):
            *pu16TempID = en_str_Hebrew;
            break;

       case STRING_TO_U32('t','u','r'):
            *pu16TempID = en_str_Turkish;
            break;

		case STRING_TO_U32('s','g','a'):
			*pu16TempID = en_str_Sga;
			break;

		case STRING_TO_U32('c','m','n'):
			*pu16TempID = en_str_Mandarin;
			break;

		case STRING_TO_U32('y','u','e'):
			*pu16TempID = en_str_Cantonese;
			break;

		case STRING_TO_U32('k','o','r'):
			*pu16TempID = en_str_Korean;
			break;

		case STRING_TO_U32('j','p','n'):
			*pu16TempID = en_str_Japanese;
			break;

		case STRING_TO_U32('h','i','n'):
			*pu16TempID = en_str_Hindi;
			break;

		case STRING_TO_U32('m','a','o'):
			*pu16TempID = en_str_Maori;
			break;

        default:
            *pu16TempID = en_str_Undefined;
            break;
    }

#else
    if ( strcmp(SubtitleServices[UI_Lang_IDX].StringCodes, "ara") == 0 )
        *pu16TempID = en_str_Arabic;
    else if ( strcmp(SubtitleServices[UI_Lang_IDX].StringCodes, "bul") == 0 )
        *pu16TempID = en_str_Bulgarian;
    else if ( strcmp(SubtitleServices[UI_Lang_IDX].StringCodes, "cat") == 0 )
        *pu16TempID = en_str_Catalan;
    else if ( strcmp(SubtitleServices[UI_Lang_IDX].StringCodes, "cro") == 0 )
        *pu16TempID = en_str_Hrvatski;
    else if ( strcmp(SubtitleServices[UI_Lang_IDX].StringCodes, "cze") == 0 )
        *pu16TempID = en_str_Czech;
    else if ( strcmp(SubtitleServices[UI_Lang_IDX].StringCodes, "dan") == 0 )
        *pu16TempID = en_str_Dansk;
    else if ( strcmp(SubtitleServices[UI_Lang_IDX].StringCodes, "dut") == 0 )
        *pu16TempID = en_str_Nederlands;
    else if ( strcmp(SubtitleServices[UI_Lang_IDX].StringCodes, "eng") == 0 )
        *pu16TempID = en_str_English;
    else if ( strcmp(SubtitleServices[UI_Lang_IDX].StringCodes, "fin") == 0 )
        *pu16TempID = en_str_Suomi;
    else if ( strcmp(SubtitleServices[UI_Lang_IDX].StringCodes, "fra") == 0 )
        *pu16TempID = en_str_France;
    else if ( strcmp(SubtitleServices[UI_Lang_IDX].StringCodes, "fre") == 0 )
        *pu16TempID = en_str_France;
    else if ( strcmp(SubtitleServices[UI_Lang_IDX].StringCodes, "gae") == 0 )
        *pu16TempID = en_str_Gaelic;
    else if ( strcmp(SubtitleServices[UI_Lang_IDX].StringCodes, "ger") == 0 )
        *pu16TempID = en_str_Deutsch;
    else if ( strcmp(SubtitleServices[UI_Lang_IDX].StringCodes, "deu") == 0 )
        *pu16TempID = en_str_Deutsch;
    else if ( strcmp(SubtitleServices[UI_Lang_IDX].StringCodes, "ger") == 0 )
        *pu16TempID = en_str_Greek;
    else if ( strcmp(SubtitleServices[UI_Lang_IDX].StringCodes, "gla") == 0 )
        *pu16TempID = en_str_Gaelic;
    else if ( strcmp(SubtitleServices[UI_Lang_IDX].StringCodes, "gle") == 0 )
        *pu16TempID = en_str_Gaelic;
    else if ( strcmp(SubtitleServices[UI_Lang_IDX].StringCodes, "gae") == 0 )
        *pu16TempID = en_str_Gaelic;
    else if ( strcmp(SubtitleServices[UI_Lang_IDX].StringCodes, "gre") == 0 )
        *pu16TempID = en_str_Greek;
    else if ( strcmp(SubtitleServices[UI_Lang_IDX].StringCodes, "hrv") == 0 )
        *pu16TempID = en_str_Hrvatski;
    else if ( strcmp(SubtitleServices[UI_Lang_IDX].StringCodes, "hun") == 0 )
        *pu16TempID = en_str_Magyar;
    else if ( strcmp(SubtitleServices[UI_Lang_IDX].StringCodes, "ita") == 0 )
        *pu16TempID = en_str_Italiano;
    else if ( strcmp(SubtitleServices[UI_Lang_IDX].StringCodes, "nor") == 0 )
        *pu16TempID = en_str_Norsk;
    else if ( strcmp(SubtitleServices[UI_Lang_IDX].StringCodes, "pol") == 0 )
        *pu16TempID = en_str_Polski;
    else if ( strcmp(SubtitleServices[UI_Lang_IDX].StringCodes, "por") == 0 )
        *pu16TempID = en_str_Portuguese;
    else if ( strcmp(SubtitleServices[UI_Lang_IDX].StringCodes, "rom") == 0 )
        *pu16TempID = en_str_Romanian;
    else if ( strcmp(SubtitleServices[UI_Lang_IDX].StringCodes, "rus") == 0 )
        *pu16TempID = en_str_Russian1;
    else if ( strcmp(SubtitleServices[UI_Lang_IDX].StringCodes, "slo") == 0 )
        *pu16TempID = en_str_Slovene;
    else if ( strcmp(SubtitleServices[UI_Lang_IDX].StringCodes, "ser") == 0 )
        *pu16TempID = en_str_Srpski;
    else if ( strcmp(SubtitleServices[UI_Lang_IDX].StringCodes, "spa") == 0 )
        *pu16TempID = en_str_Spanish;
    else if ( strcmp(SubtitleServices[UI_Lang_IDX].StringCodes, "swe") == 0 )
        *pu16TempID = en_str_Svenska;
    else if ( strcmp(SubtitleServices[UI_Lang_IDX].StringCodes, "chi") == 0 )
        *pu16TempID = en_str_Chinese;
    else if ( strcmp(SubtitleServices[UI_Lang_IDX].StringCodes, "chs") == 0 )
        *pu16TempID = en_str_SimpleChinese;
    else if ( strcmp(SubtitleServices[UI_Lang_IDX].StringCodes, "wel") == 0 )
        *pu16TempID = en_str_Welsh;
    else if ( strcmp(SubtitleServices[UI_Lang_IDX].StringCodes, "cym") == 0 )
        *pu16TempID = en_str_Welsh;
    else
        *pu16TempID = en_str_Undefined;


    if ( strcmp(SubtitleServices[UI_Lang_IDX].StringCodes, "bul") == 0 )
        *pu16TempID = en_str_Bulgarian;
    else if ( strcmp(SubtitleServices[UI_Lang_IDX].StringCodes, "cro") == 0 )
        *pu16TempID = en_str_Hrvatski;
    else if ( strcmp(SubtitleServices[UI_Lang_IDX].StringCodes, "cze") == 0 )
    ...
    switch(hwnd)
    {
        ...
        case HWND_SUBLANG_ITEM9_TEXT:
            //from case SUBTITLE_LAG_0_TEXT:
            {
                ...
                {
                    _MApp_SubtitleLanguage_MapFullLangName(idx-1,&u16TempID);
                }
            }
            break;
    }

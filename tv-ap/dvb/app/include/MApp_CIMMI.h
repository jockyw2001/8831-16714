...
/// Define DVB-CI+ OP Tune struct
typedef struct
{
    /// DTV CI+ Tune Resource Owner
    EN_CI_TUNE_APPLICANT eCiTuneApplicant;
    /// DTV CI+ Descriptor Number of Tune
    U8              u8TuneDescriptorNumber;
    /// DTV CI+ Descriptors Length of OP Tune
    U16             u16TuneDescriptorsLen;
    /// DTV CI+ Descriptors of OP Tune
    U8*            pu8TuneDescriptors;
    /// DTV CI+ Tuning Timer for OP Tune
    U32             u32TuningTimer;
    /// DTV CI+ Mux Info of OP Tune
    ST_DVB_MUX_INFO stCiTuneMux;
} ST_DTV_CI_TUNE_INFO;
#endif//ENABLE_CI_PLUS
//------------------------------------------------------------------------------
// Variable
...
#if (ENABLE_CI_PLUS)
INTERFACE ST_DTV_CI_TUNE_INFO g_stCiTuneInfo;

...
BOOLEAN MApp_ZUI_ACT_HandleEpgKey(VIRTUAL_KEY_CODE key)
{
    ...
    //button click animation...
    {
        static  MENU_KEY2BTN_STRUCT _ZUI_TBLSEG _key2btn[] =
        {
          ...
          //  {VK_RED, HWND_EPG_HELP_BTN_RECORD},
#endif
...
LPTSTR MApp_ZUI_ACT_GetEpgDynamicText(HWND hwnd)
{
    ...
    switch(hwnd)
    {
...
#else
                MApp_ZUI_API_GetU16String(u16LCN);
#endif
        ...
        case HWND_EPG_REMINDER_TIMER_SAVE_DLG_MSGBOX_TEXT2:
            ...
            #if ENABLE_SBTVD_BRAZIL_APP
                LOGICAL_CHANNEL_NUMBER LCN;
                LCN.wLCN = (WORD)u16Num;
                MApp_UlongToU16String((U32)LCN.stLCN.bPhysicalChannel, str, (S8)MApp_GetNoOfDigit((U32)LCN.stLCN.bPhysicalChannel));
                str += (MApp_GetNoOfDigit((U32)LCN.stLCN.bPhysicalChannel));
                *str ++ = CHAR_DOT;
                MApp_UlongToU16String((U32)LCN.stLCN.bVirtualChannel, str, (S8)MApp_GetNoOfDigit((U32)LCN.stLCN.bVirtualChannel));
            #else
                MApp_ZUI_API_GetU16String(u16Num);
            #endif
                str += MApp_ZUI_API_Strlen(str);
                *str ++ = CHAR_SPACE;
        ...
        case HWND_EPG_SCHEDULE_LIST_ITEM_3_PROGRAMME:
        {
            ...
            *str=0;
            ...
            __MApp_UlongToString((U32)LCN.stLCN.bPhysicalChannel, str, (S8)MApp_GetNoOfDigit((U32)LCN.stLCN.bPhysicalChannel));
            str += (MApp_GetNoOfDigit((U32)LCN.stLCN.bPhysicalChannel));
            *str ++ = CHAR_DOT;

            __MApp_UlongToString((U32)LCN.stLCN.bVirtualChannel, str, (S8)MApp_GetNoOfDigit((U32)LCN.stLCN.bVirtualChannel));
			str += MApp_ZUI_API_Strlen(str);
            *str++ = CHAR_SPACE;
#else
...
void MApp_BarkerEPG_StartToCheck(void)
{
	...
	if (MApp_SI_GetEPGMUXInfo(&onid,&tsid))
	{
		...
		if (EPG_RFIndex != INVALID_PHYSICAL_CHANNEL_NUMBER)
		{
...
#if 0
#if(DTV_SYSTEM_SEL== DTV_SYSTEM_DVBT_Plus_DVBC)
			...
			else if ( !IsDVBCInUse() && msAPI_DFT_GetTSSetting(EPG_RFIndex, &stTempTP) == TRUE)
#else

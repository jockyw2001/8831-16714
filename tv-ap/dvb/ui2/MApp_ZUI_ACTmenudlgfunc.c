...
{
	#ifdef sUserResetIssue
				MApp_ZUI_ACT_UserReset_VideoReset();
      ...
      UI_INPUT_SOURCE_TYPE = UI_INPUT_SOURCE_RGB;//UI_INPUT_SOURCE_ATV;	//MingYuan
        ...
        case MSG_TIMER:
            {
                ...
                if (_eCommonDlgMode == EN_COMMON_DLG_MODE_FACTORY_RESET)
                {
                    ...
                    #ifdef sUserResetIssue
                    MApp_ZUI_ACT_ExecuteMenuCommonDialogAction(EN_EXE_USER_SETTING_RESET);
                    MApp_ZUI_ACT_ExecuteMenuCommonDialogAction(EN_EXE_CLOSE_FACTORY_RESET_CONFIRM_DLG); //ResetKeyWord
                ...
                {
                		#ifdef sSoftwareUpdateInOptionPage //vxxxxxxxx
                    MApp_ZUI_API_KillTimer(hwnd, 0);
                    //_eCommonDlgMode = EN_COMMON_DLG_MODE_INVALID;
                    MApp_ZUI_API_ShowWindow(HWND_MENU_DLG_COMMON, SW_HIDE);
                    MApp_ZUI_ACT_ShowMainMenuBackground(HWND_MENU_BOTTOM_BALL_FOCUS_OPTION);

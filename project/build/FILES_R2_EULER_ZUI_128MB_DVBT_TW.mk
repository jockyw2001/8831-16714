...
INC_DIR  += \
        ...
        -I$(ROOT)/include/std                                       \
        -I$(ROOT)/core/driver/pq/hal/euler/include
...
DEVICES_FILES += \
        $(ROOT)/device/keypad/euler/msKeypad.c                        \
...
DTV_LIB += \
    $(MIDDLE_LIB_PATH)/cni/libcni_a.a                                   \
    $(API_LIB_PATH)/mvf/libmvf_a.a                                      \
    $(MIDDLE_LIB_PATH)/subtitle/libsub_a.a							    \

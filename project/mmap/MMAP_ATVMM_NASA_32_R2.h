...
#define TTX_POOL_MEMORY_TYPE                                   (MIU0 | SW | WRITE_BACK)
...
#define M4A_STSZ_MEMORY_TYPE                                   (MIU0 | SW | WRITE_BACK)
...
#define VDEC_AEON_MMSD_MEMORY_TYPE                             (MIU0 | SW | WRITE_BACK)
...
#define VDPLAYER_DATA_SD_MEMORY_TYPE                           (MIU0 | SW | WRITE_BACK)
...
#define SCALER_DNR_BUF_SDMM_MEMORY_TYPE                        (MIU0 | SW | WRITE_BACK)
...
#define NONE_FOR_COMB_MEMORY_TYPE                              (MIU0 | SW | WRITE_BACK)

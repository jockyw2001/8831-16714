                ...
                case MPLAYER_OPTION_MUSIC_INFO:
                    {
                        ...
                        switch(eMusicInfoType)
                        {
                            ...
                            case MPLAYER_INFO_MUSIC_LAYER:
                                if(_geMPLAYER_MusicType == MPLAYER_SUBTYPE_MP3)
                                {
                                    pu8String = MApp_Music_GetInfoString(MP3_INFO_LAYER);
                                    u32StrLen = (U32)MApp_Music_GetInfoStringLength(MP3_INFO_LAYER);
                            ...
                            case MPLAYER_INFO_MUSIC_BITRATE:
                                if(_geMPLAYER_MusicType == MPLAYER_SUBTYPE_MP3)
                                {
                                    pu8String = MApp_Music_GetInfoString(MP3_INFO_BITRATE);
                                    u32StrLen = 12;
                                    if (pu8String != NULL)
                                    {
                                ...
                                {
                                    pu8String = MApp_WMA_GetInfoString(WMA_INFO_BITRATE);
                                    u32StrLen = 32;
                                    if (pu8String != NULL)
                                    {
                                        memset((U8*)u16pCharBuf,0,u32StrLen);
                            ...
                            case MPLAYER_INFO_MUSIC_SAMPLINGRATE:
                                if(_geMPLAYER_MusicType == MPLAYER_SUBTYPE_MP3)
                                {
                                    pu8String = MApp_Music_GetInfoString(MP3_INFO_SAMPLINGRATE);
                                    u32StrLen =12;
                                    if (pu8String != NULL)
                                    {
                                        memset((U8*)u16pCharBuf,0,u32StrLen);
                                ...
                                {
                                    pu8String = MApp_WMA_GetInfoString(WMA_INFO_SAMPLINGRATE);
                                    u32StrLen = 32;
                                    if (pu8String != NULL)
                                    {
                                        memset((U8*)u16pCharBuf,0,u32StrLen);
                            ...
                            case MPLAYER_INFO_MUSIC_ALBUM:
                                if(_geMPLAYER_MusicType == MPLAYER_SUBTYPE_MP3)
                                {
                                    pu8String = MApp_Music_GetInfoString(MP3_INFO_ALBUM);
                                    u32StrLen = (U32)MApp_Music_GetInfoStringLength(MP3_INFO_ALBUM);
                                    if (pu8String != NULL)
                                    {
                                ...
                                {
                                    pu8String = MApp_WMA_GetInfoString(WMA_INFO_ALBUM);
                                    u32StrLen = 32;
                                    if (pu8String != NULL)
                                    {
                                        _msAPI_NPlayer_ConvertMusicString2Unicode(pu8String, u16pCharBuf, u32StrLen);
                            ...
                            case MPLAYER_INFO_MUSIC_TITLE:
                                if(_geMPLAYER_MusicType == MPLAYER_SUBTYPE_MP3)
                                {
                                    pu8String = MApp_Music_GetInfoString(MP3_INFO_TITLE);
                                    u32StrLen = (U32)MApp_Music_GetInfoStringLength(MP3_INFO_TITLE);
                                ...
                                {
                                    pu8String = MApp_WMA_GetInfoString(WMA_INFO_TITLE);
                                    u32StrLen = 32;
                                    if (pu8String != NULL)
                                    {
                                        _msAPI_NPlayer_ConvertMusicString2Unicode(pu8String, u16pCharBuf, u32StrLen);
                            ...
                            case MPLAYER_INFO_MUSIC_ARTIST:
                                if(_geMPLAYER_MusicType == MPLAYER_SUBTYPE_MP3)
                                {
                                    pu8String = MApp_Music_GetInfoString(MP3_INFO_ARTIST);
                                    u32StrLen = (U32)MApp_Music_GetInfoStringLength(MP3_INFO_ARTIST);
                                    if (pu8String != NULL)
                                    {
                                        _msAPI_NPlayer_ConvertMusicString2Unicode(pu8String, u16pCharBuf, u32StrLen);
                                ...
                                {
                                    pu8String = MApp_WMA_GetInfoString(WMA_INFO_ARTIST);
                                    u32StrLen = 32;
                                    if (pu8String != NULL)
                                    {
                                        _msAPI_NPlayer_ConvertMusicString2Unicode(pu8String, u16pCharBuf, u32StrLen);
                            ...
                            case MPLAYER_INFO_MUSIC_YEAR:
                                if(_geMPLAYER_MusicType == MPLAYER_SUBTYPE_MP3)
                                {
                                    pu8String = MApp_Music_GetInfoString(MP3_INFO_YEAR);
                                    u32StrLen = (U32)MApp_Music_GetInfoStringLength(MP3_INFO_YEAR);
                                    if (pu8String != NULL)
                                    {
                                        _msAPI_NPlayer_ConvertMusicString2Unicode(pu8String, u16pCharBuf, u32StrLen);
                                ...
                                {
                                    pu8String = MApp_WMA_GetInfoString(WMA_INFO_YEAR);
                                    u32StrLen = 32;
                                    if (pu8String != NULL)
                                    {
                                        _msAPI_NPlayer_ConvertMusicString2Unicode(pu8String, u16pCharBuf, u32StrLen);
                            ...
                            case MPLAYER_INFO_MUSIC_GENRE:
                                if(_geMPLAYER_MusicType == MPLAYER_SUBTYPE_MP3)
                                {
                                    pu8String = MApp_Music_GetInfoString(MP3_INFO_GENRE);
                                    u32StrLen = (U32)MApp_Music_GetInfoStringLength(MP3_INFO_GENRE);
                                    if (pu8String != NULL)
                                    {
                                        _msAPI_NPlayer_SetMusicShareMem(INDEX_MUSIC_SHAR_STRING_INFO_TYPE,(U8*)&eMusicInfoType,sizeof(eMusicInfoType));
                            ...
                            case MPLAYER_INFO_MUSIC_COMMENT:
                                if(_geMPLAYER_MusicType == MPLAYER_SUBTYPE_MP3)
                                {
                                    pu8String = MApp_Music_GetInfoString(MP3_INFO_COMMENT);
                                    u32StrLen = (U32)MApp_Music_GetInfoStringLength(MP3_INFO_COMMENT);
                                    if (pu8String != NULL)
                                    {
                                        _msAPI_NPlayer_SetMusicShareMem(INDEX_MUSIC_SHAR_STRING_INFO_TYPE,(U8*)&eMusicInfoType,sizeof(eMusicInfoType));
                            ...
                            case MPLAYER_INFO_MUSIC_CHECK_FF_FB:
                                if(_geMPLAYER_MusicType == MPLAYER_SUBTYPE_MP3)
                                {
                                    pu8String = MApp_Music_GetInfoString(MP3_INFO_CHECK_FF_FB);
                                    u32StrLen = (U32)MApp_Music_GetInfoStringLength(MP3_INFO_CHECK_FF_FB);
                                    if (pu8String != NULL)
                                    {
                                        _msAPI_NPlayer_SetMusicShareMem(INDEX_MUSIC_SHAR_STRING_INFO_TYPE,(U8*)&eMusicInfoType,sizeof(eMusicInfoType));
                                ...
                                {
                                    pu8String = MApp_WMA_GetInfoString(WMA_INFO_CHECK_FF_FB);
                                    u32StrLen = 32;
                                    if (pu8String != NULL)
                                    {
                                        _msAPI_NPlayer_SetMusicShareMem(INDEX_MUSIC_SHAR_STRING_INFO_TYPE,(U8*)&eMusicInfoType,sizeof(eMusicInfoType));

...
#elif (IR_TYPE_SEL == IR_TYPE_TRIVIEW_STD)
#include "../include/IR_TRIVIEW_STD.h"
#elif(IR_TYPE_SEL == IR_TYPE_DIGITALVIEW_LTD) 	//Ray IRC 2017.01.20: Add DV IR support
#include "../include/IR_DIGITALVIEW.h"

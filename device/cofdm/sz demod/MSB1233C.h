...
typedef struct
{
    ...
    MAPI_U16(*DTV_GetCurrent_Modulation)(void);
    //Public:DTV-DVB-T
...
//extern MS_BOOL DTV_DVB_T_GetSignalTpsInfo(MS_U16 *TPS_Info);
//extern MS_BOOL DTV_SetPlpGroupID(MS_U8 u8PlpID, MS_U8 u8GroupID);
//extern MS_BOOL DTV_GetMSB1233C_Ready(void);
//extern MS_BOOL DTV_Get_Current_Plp_Id(MS_U8 *plp_id);

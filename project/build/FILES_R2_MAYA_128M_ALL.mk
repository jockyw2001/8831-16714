...
DRV_FILES += \
        ...
        $(ROOT)/core/driver/sys/$(chip_name)/drvI2C.c                         \
        $(ROOT)/core/driver/sys/$(chip_name)/SysInit.c                        \
        $(ROOT)/core/driver/sys/$(chip_name)/drvISR.c                         \
        $(ROOT)/core/driver/sys/$(chip_name)/drvInit.c                        \
...
API_FILES += \
        ...
        $(ROOT)/core/api/scaler_front/msAPI_CEC_New.c           \
...
UTIL_FILES += \
        ...
        $(ROOT)/core/util/dvrs232.c                       			\
		$(ROOT)/core/util/dvEDID.c                       			\
...
INC_DIR  += \
        ...
        -I$(ROOT)/device/mhl                                       \
        -I$(ROOT)/device/IE2000                                     \
        -I$(ROOT)/device/ExtAudio                                    \

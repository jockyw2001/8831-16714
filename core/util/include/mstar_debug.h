...
//-----------------------------------------------------------------
#define DEBUG_FUNC_TIME_START()         U32 u32FuncTimeStart = MsOS_GetSystemTime(); printf("\n[TIME] %s() start at %u\n", __FUNCTION__, u32FuncTimeStart)
#define DEBUG_FUNC_TIME_END()           do{ printf("\n[TIME] %s() end at %u use %u\n", __FUNCTION__, MsOS_GetSystemTime(), MsOS_GetSystemTime() - u32FuncTimeStart); }while(0)



//-----------------------------------------------------------------
#if(ENABLE_BOOTTIME)
#define BOOT_TIME_FLAG_WAIT_PQ_END      BIT0
INTERFACE U8 g_BootTime_u8Flag;
#endif
